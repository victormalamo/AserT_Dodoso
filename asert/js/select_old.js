...
angular.module('ui.select').run(['$templateCache', function ($templateCache) {
	...
	$templateCache.put('bootstrap/match.tpl.html', '<button type="button" class="btn  form-control ui-select-match" ng-hide="$select.open" ng-disabled="$select.disabled" ng-click="$select.activate()"> <span ng-hide="$select.selected !==undefined" class="ui-select-placeholder">{{$select.placeholder}}</span> <span ng-show="$select.selected !==undefined" ng-transclude></span> <span class="caret"></span> </button> ');
