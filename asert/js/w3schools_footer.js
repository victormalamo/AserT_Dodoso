...
function fix_sidemenu() {
  ...
  if (w < 993 && w > 600) {
    if (top == 0) {
      document.getElementById("sidenav").style.top = "0px"; <!--144-->
    }
    if (top > 0 && top < 100) {
      document.getElementById("sidenav").style.top = (0 - top) + "px"; <!--144-->    
    }
    if (top > 100) {
    ...
    document.getElementById("leftmenuinner").style.paddingTop = "0"; //SCROLLNYTT 112
  } else {
    if (top == 0) {
      document.getElementById("sidenav").style.top = "0px"; //112   
    }
    if (top > 0 && top < 66) {
      document.getElementById("sidenav").style.top = (0 - top) + "px"; //112   
    }
    if (top > 66) {
      document.getElementById("sidenav").style.top = "0px";//44
      if (w > 992) {document.getElementById("leftmenuinner").style.paddingTop = "0px";} //SCROLLNYTT 44
      document.getElementById("belowtopnav").style.paddingTop = "44px";    
      document.getElementById("topnav").style.position = "fixed";
      document.getElementById("topnav").style.top = "0";
      document.getElementById("googleSearch").style.position = "fixed";
      ...
      if (w > 992) { document.getElementById("leftmenuinner").style.paddingTop = (0 - top) + "px";} //SCROLLNYTT 112-top
      document.getElementById("belowtopnav").style.paddingTop = "0";
      document.getElementById("topnav").style.position = "relative";
      document.getElementById("googleSearch").style.position = "absolute";
      document.getElementById("googleSearch").style.top = "";
