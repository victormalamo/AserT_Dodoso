...
$insert_or_edit = 'insert';
	...
	$insert_query = "INSERT INTO afcg_assessors (assessor_full_name, assessor_qualification, assessor_firm, username, assessor_created_by) VALUES ('$new_assessor_full_name', '$new_assessor_qualification', '$new_assessor_firm', '$new_assessor_mobile_number', '$assessor_created_by')";
...
$reg_assessor_id = $form_data->reg_assessor_id;
	...
	$update_query = "UPDATE afcg_assessors SET assessor_full_name = '$assessor_full_name', assessor_qualification = '$assessor_qualification', assessor_firm = '$assessor_firm', username = '$new_assessor_mobile_number' WHERE reg_assessor_id = '".$reg_assessor_id."'";
