<div class="modal left fade" id="yanafanyiwa_kazi_panel" tabindex="-1" role="dialog" data-keyboard="false" data-backdrop="static" ng-init="fetch_yanafanyiwa_kazi()">
        ...
        <div class="modal-body w3-text-white" style="padding-bottom:0px"> 
          ...
          <div class="container" style="max-width:800px; border-radius:4px; padding:4px 4px 4px 4px; background-color: rgba(61,138,101,1); margin-top:-10px"> 
			...
			<div class="" style="width:100%; padding:0px 0px 6px 0px; margin:0px 0px 15px 0px; background-color: rgba(0,0,0,0)">
				<span class="modal__top__title" style="vertical-align:middle">YANAYOFANYIWA KAZI</span>
				<span class="btn btn-danger pull-right" style="border:1px solid #fff; margin-top:0px" ng-click="closeYanafanyiwa_kazi()"><i class="glyphicon glyphicon-remove"></i></span>
			</div>
			...
			<table id="orodha_ya_watumishi" datatable="ng" dt-options="vm.dtOptions" class="table table-bordered border-lightgreen">
			  ...
			  <tbody style="white-space: nowrap;">
				<tr ng-repeat="mtumiaji in yanafanyiwa_kaziData"> 
