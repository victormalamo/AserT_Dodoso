...
$query = "SELECT * FROM dawati_la_wateja WHERE ((general_status = 'yamefanyiwa_kazi_idarani') AND (hod_hou_status = 'yamefanyiwa_kazi_idarani') AND ((ps_status = '') || (ps_status IS NULL)))";
