app.restaurant_tallying_ctrl = function($timeout, $scope, $http, focus){

		 $scope.fetch_restaurant_items_for_tallying = function(assessment_id, assessor_category){
			$http({
			method:"POST",
			url:"msimamiziApp/sajili_mtumiaji/fetch_restaurant_items_for_tallying.php",
...
<!-----------------------------  GRADING  -------------------------------------------->
		...
		//GRADING SECTIONS
			...
			//OPEN SHEET							
			$scope.open_tallying_sheet_for_restaurant();	
			
			});
	};
	
	
	$scope.open_tallying_sheet_for_restaurant = function(){
		var modal_popup = angular.element('#tallying_sheet_for_restaurant_panel');
		modal_popup.modal('show');
	};
	$scope.close_tallying_sheet_for_restaurant = function(){
		var modal_popup = angular.element('#tallying_sheet_for_restaurant_panel');
