		...
		foreach($result as $row)
		 {
		  ...
		  $output['tarehe_hod_hou_to_ps'] = $row['tarehe_hod_hou_to_ps'];
		  $output['ps_input'] = $row['ps_input'];
		  $output['ps_status_name'] = $row['ps_status_name'];
		  $output['ps_status'] = $row['ps_status'];
		  ...
		  $output['tarehe_mdau_mrejesho'] = $row['tarehe_mdau_mrejesho'];
		 }
	}
	//$output = array(
