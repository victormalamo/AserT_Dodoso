...
$query = "SELECT * FROM dawati_la_wateja WHERE ((general_status = 'yamepokelewa_mapokezi') AND (div_unit_ID = '".$_SESSION['div_unit_ID']."') AND ((hod_hou_status = '') || (hod_hou_status IS NULL)))";
