...
?>
<!DOCTYPE html>
<html class="restade" ng-app="msimamiziApp" ng-controller="watumiajiController" lang="en"><head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
<title><?php echo $_SESSION['div_unit'];?></title>
...
<div class="rstd-home-bg position-absolute position-fixed w3-white"></div>
...
<div class="container-fluid" style="float:left; margin-top:0px">

<!--div class="bg-facebook alert d-block d-text-md-center text-white py-3">
Karibu <strong><php echo $_SESSION['jina_la_cheo'];?></strong>
...
<?php include('msimamiziApp/modal_not_vetted.php');?>
<?php include('msimamiziApp/modal_vetted.php');?>
<?php include('msimamiziApp/modal_yanafanyiwa_kazi.php');?>
