...
<?php 
if(($_GET['c_tupu']=="ipo") || ($_GET['tupu'])=="ipo"){ require('reload_tupu_update_hod_u_yaliyokataliwa.php'); }else{ require('reload_update_hod_u_yaliyokataliwa.php'); };
?>
      ...
      <div class="w3-col l10 m12" id="main"> 
        <div id="mainLeaderboard" style="overflow:hidden;"> 
          ...
          <div class="container_form"> 
            ...
            <div class="w3-small w3-opacity form_link"  style="padding:0px 0px 10px 0px;"><a href="http://localhost/user/hod_hou/yaliyokataliwa_list.php">Yote 
              yaliyokataliwa</a>&nbsp;&nbsp;<span class="w3-tiny">/</span>&nbsp;&nbsp;<a href="http://localhost/user/hod_hou/yaliyokataliwa_tazama.php?id=<?php echo $_GET['id'];?>">Tazama 
            ...
            <?php if($_GET['ruti_ID'] == "ruti_zaidi_ya_moja"){?><form action="yaliyokataliwa_list_updatequery_unganisha.php" method="POST" name="yaliyokataliwa_list_updateForm" id="yaliyokataliwa_list_updateForm"> 
            <?php }else{?>
            <form action="yaliyokataliwa_list_updatequery.php" method="POST" name="yaliyokataliwa_list_updateForm" id="yaliyokataliwa_list_updateForm">
              <?php };?>
             ...
             <!--CHAGUA DEREVA-->
              ...
              <input name="page" type="hidden" id="page" value="<?php echo "yaliyokataliwa_list_update";?>">
              <!-- Kwa ajili ya kukagua field-->
              <!--input name="general_status" type="hidden" id="general_status" value="<php echo "kipya";?>"-->
              <input type="hidden" name="MM_update" value="yaliyokataliwa_list_updateForm">
              <?php }; ?>
              <!-- POPUP MAP -->
