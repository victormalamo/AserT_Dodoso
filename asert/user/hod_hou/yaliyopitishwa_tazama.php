...
//Kupitisha kwenya badili link
	$maamuzi_ID = $row_rsselectedKibali['hodu_status'];
	$sababu = $row_rsselectedKibali['hodu_rsn_chg'];
...
$quermaamuzi=mysqli_query($conntscpME, "SELECT * FROM maamuzi_hod_u ORDER BY id ASC");
//$maamuzi_ID=$_GET['maamuzi_ID'];
?>
...
function nenda() {
window.location.href="yaliyopitishwa_list.php";
}
</script>
</head>
...
<div class="row_form">
    <div class="title_100S mnrt-left-align">
	IDHINI YA MKUU WA IDARA/KITENGO
	<?php 
	if(($row_rsselectedKibali['hodu_status'] !="") && ($_GET['badilisha'] !="ndio")){ echo "&nbsp;&nbsp;[&nbsp;<a href='yaliyopitishwa_tazama.php?id=$id&maamuzi_ID=$maamuzi_ID&sababu=$sababu&badilisha=ndio'>BADILI</a>&nbsp;]";};?>
    </div> 
    <div class="">
    </div>
</div>

<?php if(($row_rsselectedKibali['hodu_status'] !="") && ($_GET['badilisha'] !="ndio")){?>
...
<div class="row_form">
	...
	<span><input  class="btn btn-primary" type="button" value="Sawa" onclick="window.location.href='yaliyopitishwa_list.php'"></span>
    </div> 
</div>
...
<div class="row_form">
    <div class="delete_col mnrt-left">
	<span><input  class="deletesubmit" type="button" value="Rudi Nyuma" onclick="window.location.href='yaliyopitishwa_list.php'";></span>
	<span><input  class="deletesubmit submitallplayerbtn" type="submit" value="Tuma" onclick="return kaguaMaamuzi();"></span>
    </div> 
</div>
<input name="badilisha" id="badilisha" type="hidden" value="<?php echo $badilisha;?>">
<input name="kutoka" id="kutoka" type="hidden" value="<?php echo "yaliyopitishwa";?>">
<input name="id" id="id" type="hidden" value="<?php echo $row_rsselectedKibali['id'];?>">
<input name="hodu_submitDate" type="hidden" id="hodu_submitDate" value="<?php echo date("d-m-Y");?>">
