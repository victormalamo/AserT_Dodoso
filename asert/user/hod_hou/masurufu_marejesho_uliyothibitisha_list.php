...
?>
<?php 
$_SESSION['kutoka_link'] = "masurufu_marejesho_uliyothibitisha_list.php";
include('status.php');
...
$query_rs_yanayoingia_nu = sprintf("SELECT vibali.*, marejesho.* FROM vibali, marejesho WHERE ((vibali.mlipajiID = '%s' ) AND (vibali.levelID = 'nu' ) AND ((vibali.masurufu_id = marejesho.masurufu_id) || (vibali.driver_masurufu_id = marejesho.driver_masurufu_id)) AND (marejesho.kiasi_nilichochukua > 0) AND (marejesho.masurufu_marejesho_general_status = 'ameona_hod_u') AND (marejesho.nathibitisha_sithibitishi_hod_u = 'nathibitisha')) ORDER BY id DESC", $div_unit_ID);
$rs_yanayoingia_nu = mysqli_query($conntscpME, $query_rs_yanayoingia_nu) or die(mysqli_error());
$row_rs_yanayoingia_nu = mysqli_fetch_assoc($rs_yanayoingia_nu);
$totalRows_rs_yanayoingia_nu = mysqli_num_rows($rs_yanayoingia_nu);

//KUTOKA KWA HOS 

$query_rs_yanayoingia_hos = sprintf("SELECT vibali.*, marejesho.* FROM vibali, marejesho WHERE ((vibali.mlipajiID = '%s' ) AND (vibali.levelID = 'hos' ) AND ((vibali.masurufu_id = marejesho.masurufu_id) || (vibali.driver_masurufu_id = marejesho.driver_masurufu_id)) AND (marejesho.kiasi_nilichochukua > 0) AND (marejesho.masurufu_marejesho_general_status = 'ameona_hod_u') AND (marejesho.nathibitisha_sithibitishi_hod_u = 'nathibitisha')) ORDER BY id DESC", $div_unit_ID);
$rs_yanayoingia_hos = mysqli_query($conntscpME, $query_rs_yanayoingia_hos) or die(mysqli_error());
$row_rs_yanayoingia_hos = mysqli_fetch_assoc($rs_yanayoingia_hos);
$totalRows_rs_yanayoingia_hos = mysqli_num_rows($rs_yanayoingia_hos);

//KUTOKA KWA HOD_U 

$query_rs_yanayoingia_hod_u = sprintf("SELECT vibali.*, marejesho.* FROM vibali, marejesho WHERE ((vibali.mlipajiID = '%s' ) AND ((vibali.levelID = 'hod' ) || (vibali.levelID = 'hou' )) AND ((vibali.masurufu_id = marejesho.masurufu_id) || (vibali.driver_masurufu_id = marejesho.driver_masurufu_id)) AND (marejesho.kiasi_nilichochukua > 0) AND (marejesho.masurufu_marejesho_general_status = 'ameona_hod_u') AND (marejesho.nathibitisha_sithibitishi_hod_u = 'nathibitisha')) ORDER BY id DESC", $div_unit_ID);
$rs_yanayoingia_hod_u = mysqli_query($conntscpME, $query_rs_yanayoingia_hod_u) or die(mysqli_error());
$row_rs_yanayoingia_hod_u = mysqli_fetch_assoc($rs_yanayoingia_hod_u);
$totalRows_rs_yanayoingia_hod_u = mysqli_num_rows($rs_yanayoingia_hod_u);

$totalRows_rs_yanayoingia = ($totalRows_rs_yanayoingia_nu + $totalRows_rs_yanayoingia_hos + $totalRows_rs_yanayoingia_hod_u);
    ...
    <div id="leftmenuinner" style="padding-top: 0px;"> 
      <div class="w3-light-greyQ" id="leftmenuinnerinner"> <br class="w3-hide-large">
        ...
        <div class="menu_teuzi" style="display: block;"> <a target="_top" href="http://localhost/user/hod_hou/masurufu_marejesho_yanayoingia_list.php" <?php if($idadi_marejesho_yanayoingia != ""){echo "class='badge1' data-badge='".$idadi_marejesho_yanayoingia."'";};?>>Marejesho 
          Mapya</a> 
          <div id="sidenav-imechaguliwa_2" <?php if($idadi_marejesho_yaliyothibitishwa != ""){echo "class='badge1' data-badge='".$idadi_marejesho_yaliyothibitishwa."'";};?>>Uliyopitisha</div>
      ...
      <div class="w3-col l10 m12" id="main"> 
        <div id="mainLeaderboard" style="overflow:hidden;"> 
          ...
          <div class="container_form"> 
            <?php if($totalRows_rs_yanayoingia == 0){
echo "<div class='rekodi_tupu w3-left'>HAKUNA MAREJESHO ULIYOPITISHA!</div>";
}else{?>
            <!--  *******************  YANAYOTOKA KWA HOD_U /DAHRM**************-->
            <?php if($totalRows_rs_yanayoingia_hod_u != 0){
            ...
            <div class="row_form col-view-btm"> 
              ...
              <div class="row_form col-view w3-indigo" title="Safari ya siku 7 ..."> 
                <div class="col-view-namba" data-tip="Nifanyw ni wrap words"> 
                  <?php if($row_rs_yanayoingia_hod_u['masurufu_id'] == 0) { echo "D."; $sn = $sn - 1;}else{ echo $sn."."; }?>
                </div>
                <div class="col-view-kwenda"><span class="w3-left col-view-555 col-view-dot " style="margin: 8px 8px 0px 8px"></span>	
                  <?php  //Jina la Mkoa
	$regID=$row_rs_yanayoingia_hod_u['regID'];
	...
	//Jina la Halmashauri
	$lgaID=$row_rs_yanayoingia_hod_u['lgaID'];
	...
	//Jina la kuonesha
	if ($row_rs_yanayoingia_hod_u['lgaID']==""){
	...
	?>
                ...
                <div class="col-view-tarehe"> 
                  <?php echo "Tarehe&nbsp;".$row_rs_yanayoingia_hod_u['sDate'];?>
                  <span class="w3-right col-view-555"> 
                  <!--a href="maombi_mapya_list_update.php?id=<php echo $row_rs_yanayoingia['id'];?>&catID=<php echo $row_rs_yanayoingia['catID'];?>&regID=<php echo $row_rs_yanayoingia['regID'];?>&lgaID=<php echo $row_rs_yanayoingia['lgaID'];?>&sDate=<php echo $row_rs_yanayoingia['sDate'];?>&eDate=<php echo $row_rs_yanayoingia['eDate'];?>&duration=<php echo $row_rs_yanayoingia['duration'];?>&usafiriID=<php echo $row_rs_yanayoingia['usafiriID'];?>&madhumuniID=<php echo $row_rs_yanayoingia['madhumuniID'];?>&muhtasari=<php echo $row_rs_yanayoingia['muhtasari'];?>&mlipajiID=<php echo $row_rs_yanayoingia['mlipajiID'];?>&wengine=<php echo $row_rs_yanayoingia['wengine'];?>&jina_kiambata=<php echo $row_rs_yanayoingia['jina_kiambata'];?>&kiambata=<php echo $row_rs_yanayoingia['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>
	&nbsp;<a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_yanayoingia['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;-->
                  <a href="marejesho_yanayoingia_tazama.php?<?php if($row_rs_yanayoingia_hod_u['masurufu_id'] == 0) { echo 'masurufu=ya_dereva&'; } ?>kibali_id=<?php echo $row_rs_yanayoingia_hod_u['id'];?>"> 
                  <?php if($row_rs_yanayoingia_hod_u['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                ...
                <div class="col-view-madhumuni"> 
                  <?php
	//Madhumuni
	$madhumuniID=$row_rs_yanayoingia_hod_u['madhumuniID'];
	...
	<span><a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_yanayoingia['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;&nbsp;</span-->
                  <span><a href="marejesho_yanayoingia_tazama.php?<?php if($row_rs_yanayoingia_hod_u['masurufu_id'] == 0) { echo 'masurufu=ya_dereva&'; } ?>kibali_id=<?php echo $row_rs_yanayoingia_hod_u['id'];?>"> 
                  <?php if($row_rs_yanayoingia_hod_u['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
              ...
              <?php } while ($row_rs_yanayoingia_hod_u = mysqli_fetch_assoc($rs_yanayoingia_hod_u));?>
            </div>
            <?php } ?>
            <!--  *******************  END YANAYOTOKA KWA HODs & HOUs **************-->
            <!--  *******************  YANAYOTOKA KWA HOS **************-->
            <?php if($totalRows_rs_yanayoingia_hos != 0){
		   ...
		   echo "<div class='rekodi_tupu w3-left'></div>";   ?>
            <div class="row_form col-view-btm"> 
              ...
              <div class="row_form col-view w3-indigo" title="Safari ya siku 7 ..."> 
                <div class="col-view-namba" data-tip="Nifanyw ni wrap words"> 
                  <?php if($row_rs_yanayoingia_hos['masurufu_id'] == 0) { echo "D."; $sn = $sn - 1;}else{ echo $sn."."; }?>
                </div>
                <div class="col-view-kwenda"><span class="w3-left col-view-555 col-view-dot " style="margin: 8px 8px 0px 8px"></span>	
                  <?php  //Jina la Mkoa
	$regID=$row_rs_yanayoingia_hos['regID'];
	...
	$totalRows_rsregName = mysqli_num_rows($rsregName);	
	//Jina la Halmashauri
	$lgaID=$row_rs_yanayoingia_hos['lgaID'];
	...
	$totalRows_rslgaName = mysqli_num_rows($rslgaName);
	//Jina la kuonesha
	if ($row_rs_yanayoingia_hos['lgaID']==""){
	echo "Kwenda&nbsp;".$row_rsregName['regNam'];
	}else{
	echo "Kwenda&nbsp;".$row_rslgaName['lgaNam'];
	};
	?>
                ...
                <div class="col-view-tarehe"> 
                  <?php echo "Tarehe&nbsp;".$row_rs_yanayoingia_hos['sDate'];?>
                  <span class="w3-right col-view-555"> 
                  <!--a href="maombi_mapya_list_update.php?id=<php echo $row_rs_yanayoingia['id'];?>&catID=<php echo $row_rs_yanayoingia['catID'];?>&regID=<php echo $row_rs_yanayoingia['regID'];?>&lgaID=<php echo $row_rs_yanayoingia['lgaID'];?>&sDate=<php echo $row_rs_yanayoingia['sDate'];?>&eDate=<php echo $row_rs_yanayoingia['eDate'];?>&duration=<php echo $row_rs_yanayoingia['duration'];?>&usafiriID=<php echo $row_rs_yanayoingia['usafiriID'];?>&madhumuniID=<php echo $row_rs_yanayoingia['madhumuniID'];?>&muhtasari=<php echo $row_rs_yanayoingia['muhtasari'];?>&mlipajiID=<php echo $row_rs_yanayoingia['mlipajiID'];?>&wengine=<php echo $row_rs_yanayoingia['wengine'];?>&jina_kiambata=<php echo $row_rs_yanayoingia['jina_kiambata'];?>&kiambata=<php echo $row_rs_yanayoingia['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>
	&nbsp;<a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_yanayoingia['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;-->
                  <a href="marejesho_yanayoingia_tazama.php?<?php if($row_rs_yanayoingia_hos['masurufu_id'] == 0) { echo 'masurufu=ya_dereva&'; } ?>kibali_id=<?php echo $row_rs_yanayoingia_hos['id'];?>"> 
                  <?php if($row_rs_yanayoingia_hos['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
                  <?php };?>
                ...
                <div class="col-view-madhumuni"> 
                  <?php
	//Madhumuni
	$madhumuniID=$row_rs_yanayoingia_hos['madhumuniID'];
	...
	echo $row_rsmadhumuni['madhumuni'];?>
                ...
                <div class="col-view-icons"> 
                  <!--span><a href="maombi_mapya_list_update.php?id=<php echo $row_rs_yanayoingia['id'];?>&catID=<php echo $row_rs_yanayoingia['catID'];?>&regID=<php echo $row_rs_yanayoingia['regID'];?>&lgaID=<php echo $row_rs_yanayoingia['lgaID'];?>&sDate=<php echo $row_rs_yanayoingia['sDate'];?>&eDate=<php echo $row_rs_yanayoingia['eDate'];?>&duration=<php echo $row_rs_yanayoingia['duration'];?>&usafiriID=<php echo $row_rs_yanayoingia['usafiriID'];?>&madhumuniID=<php echo $row_rs_yanayoingia['madhumuniID'];?>&muhtasari=<php echo $row_rs_yanayoingia['muhtasari'];?>&mlipajiID=<php echo $row_rs_yanayoingia['mlipajiID'];?>&wengine=<php echo $row_rs_yanayoingia['wengine'];?>&jina_kiambata=<php echo $row_rs_yanayoingia['jina_kiambata'];?>&kiambata=<php echo $row_rs_yanayoingia['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>&nbsp;&nbsp;</span>
	<span><a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_yanayoingia['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;&nbsp;</span-->
                  <span><a href="marejesho_yanayoingia_tazama.php?<?php if($row_rs_yanayoingia_hos['masurufu_id'] == 0) { echo 'masurufu=ya_dereva&'; } ?>kibali_id=<?php echo $row_rs_yanayoingia_hos['id'];?>"> 
                  <?php if($row_rs_yanayoingia_hos['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
              ...
              <?php } while ($row_rs_yanayoingia_hos = mysqli_fetch_assoc($rs_yanayoingia_hos));?>
            </div>
            <?php } ?>
            <!--  *******************  END YANAYOTOKA KWA HOS **************-->
            <!--  *******************  YANAYOTOKA KWA NU **************-->
            <?php if($totalRows_rs_yanayoingia_nu != 0){ 
		   echo "<div class='rekodi_tupu w3-left'></div>";
		   ?>
            <div class="row_form col-view-btm"> 
              ...
              <div class="row_form col-view w3-indigo" title="Safari ya siku 7 ..."> 
                <div class="col-view-namba" data-tip="Nifanyw ni wrap words"> 
                  <?php if($row_rs_yanayoingia_nu['masurufu_id'] == 0) { echo "D."; $sn = $sn - 1;}else{ echo $sn."."; }?>
                </div>
                <div class="col-view-kwenda"><span class="w3-left col-view-555 col-view-dot " style="margin: 8px 8px 0px 8px"></span>	
                  <?php  //Jina la Mkoa
	$regID=$row_rs_yanayoingia_nu['regID'];
	...
	$totalRows_rsregName = mysqli_num_rows($rsregName);	
	//Jina la Halmashauri
	$lgaID=$row_rs_yanayoingia_nu['lgaID'];
	...
	$totalRows_rslgaName = mysqli_num_rows($rslgaName);
	//Jina la kuonesha
	if ($row_rs_yanayoingia_nu['lgaID']==""){
	echo "Kwenda&nbsp;".$row_rsregName['regNam'];
	}else{
	echo "Kwenda&nbsp;".$row_rslgaName['lgaNam'];
	};
	?>
                ...
                <div class="col-view-tarehe"> 
                  <?php echo "Tarehe&nbsp;".$row_rs_yanayoingia_nu['sDate'];?>
                  <span class="w3-right col-view-555"> 
                  <!--a href="maombi_mapya_list_update.php?id=<php echo $row_rs_yanayoingia['id'];?>&catID=<php echo $row_rs_yanayoingia['catID'];?>&regID=<php echo $row_rs_yanayoingia['regID'];?>&lgaID=<php echo $row_rs_yanayoingia['lgaID'];?>&sDate=<php echo $row_rs_yanayoingia['sDate'];?>&eDate=<php echo $row_rs_yanayoingia['eDate'];?>&duration=<php echo $row_rs_yanayoingia['duration'];?>&usafiriID=<php echo $row_rs_yanayoingia['usafiriID'];?>&madhumuniID=<php echo $row_rs_yanayoingia['madhumuniID'];?>&muhtasari=<php echo $row_rs_yanayoingia['muhtasari'];?>&mlipajiID=<php echo $row_rs_yanayoingia['mlipajiID'];?>&wengine=<php echo $row_rs_yanayoingia['wengine'];?>&jina_kiambata=<php echo $row_rs_yanayoingia['jina_kiambata'];?>&kiambata=<php echo $row_rs_yanayoingia['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>
	&nbsp;<a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_yanayoingia['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;-->
                  <a href="marejesho_yanayoingia_tazama.php?<?php if($row_rs_yanayoingia_nu['masurufu_id'] == 0) { echo 'masurufu=ya_dereva&'; } ?>kibali_id=<?php echo $row_rs_yanayoingia_nu['id'];?>"> 
                  <?php if($row_rs_yanayoingia_nu['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
                  <?php };?>
                ...
                <div class="col-view-madhumuni"> 
                  <?php
	//Madhumuni
	$madhumuniID=$row_rs_yanayoingia_nu['madhumuniID'];
	...
	echo $row_rsmadhumuni['madhumuni'];?>
                ...
                <div class="col-view-icons"> 
                  <!--span><a href="maombi_mapya_list_update.php?id=<php echo $row_rs_yanayoingia['id'];?>&catID=<php echo $row_rs_yanayoingia['catID'];?>&regID=<php echo $row_rs_yanayoingia['regID'];?>&lgaID=<php echo $row_rs_yanayoingia['lgaID'];?>&sDate=<php echo $row_rs_yanayoingia['sDate'];?>&eDate=<php echo $row_rs_yanayoingia['eDate'];?>&duration=<php echo $row_rs_yanayoingia['duration'];?>&usafiriID=<php echo $row_rs_yanayoingia['usafiriID'];?>&madhumuniID=<php echo $row_rs_yanayoingia['madhumuniID'];?>&muhtasari=<php echo $row_rs_yanayoingia['muhtasari'];?>&mlipajiID=<php echo $row_rs_yanayoingia['mlipajiID'];?>&wengine=<php echo $row_rs_yanayoingia['wengine'];?>&jina_kiambata=<php echo $row_rs_yanayoingia['jina_kiambata'];?>&kiambata=<php echo $row_rs_yanayoingia['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>&nbsp;&nbsp;</span>
	<span><a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_yanayoingia['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;&nbsp;</span-->
                  <span><a href="marejesho_yanayoingia_tazama.php?<?php if($row_rs_yanayoingia_nu['masurufu_id'] == 0) { echo 'masurufu=ya_dereva&'; } ?>kibali_id=<?php echo $row_rs_yanayoingia_nu['id'];?>"> 
                  <?php if($row_rs_yanayoingia_nu['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
              ...
              <?php } while ($row_rs_yanayoingia_nu = mysqli_fetch_assoc($rs_yanayoingia_nu));?>
            </div>
            <?php } ?>
