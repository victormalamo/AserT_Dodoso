...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "yanayoingia_update")) {
  $updateSQL = sprintf("UPDATE vibali SET general_status=%s, hodu_status=%s, hodu_rsn_chg=%s, hodu_submitDate=%s, uthibitisho=%s, sababu_za_uthibitisho=%s, hodu_username=%s, hodu_levelID=%s WHERE id=%s",
                       GetSQLValueString($_POST['maamuzi_ID'], "text"),
                       GetSQLValueString($_POST['maamuzi_ID'], "text"),
                       GetSQLValueString($_POST['sababu'], "text"),
					   GetSQLValueString($_POST['hodu_submitDate'], "text"),
