...
function nenda() {
window.location.href="yaliyokataliwa_list.php";
}
</script>
</head>
...
<div class="row_form">
	...
	<?php 
	if(($row_rsselectedKibali['hodu_status'] !="") && ($_GET['badilisha'] !="ndio")){ echo "&nbsp;&nbsp;[&nbsp;<a href='yaliyokataliwa_tazama.php?id=$id&maamuzi_ID=$maamuzi_ID&sababu=$sababu&badilisha=ndio'>BADILI</a>&nbsp;]";};?>
    </div> 
    <div class="">
    </div>
</div>
...
<div class="row_form">
	...
	<span><input  class="btn btn-primary" type="button" value="Sawa" onclick="window.location.href='yaliyokataliwa_list.php'"></span>
    </div> 
</div>
...
<div class="row_form">
    <div class="delete_col mnrt-left">
	<span><input  class="btn btn-primary" type="button" value="Rudi Nyuma" onclick="window.location.href='yaliyokataliwa_list.php'";></span>
...
<input name="kutoka" id="kutoka" type="hidden" value="<?php echo "yaliyokataliwa";?>">
