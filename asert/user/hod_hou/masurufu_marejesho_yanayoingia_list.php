...
?>
<?php 
$_SESSION['kutoka_link'] = "masurufu_marejesho_yanayoingia_list.php";
include('status.php');
    ...
    <div id="leftmenuinner" style="padding-top: 0px;"> 
      <div class="w3-light-greyQ" id="leftmenuinnerinner"> <br class="w3-hide-large">
        ...
        <div class="menu_teuzi" style="display: block;"> 
          <div id="sidenav-imechaguliwa_2" <?php if($idadi_marejesho_yanayoingia != ""){echo "class='badge1' data-badge='".$idadi_marejesho_yanayoingia."'";};?>>Marejesho 
            Mapya</div>
          <a target="_top" href="http://localhost/user/hod_hou/masurufu_marejesho_uliyothibitisha_list.php" <?php if($idadi_marejesho_yaliyothibitishwa != ""){echo "class='badge1' data-badge='".$idadi_marejesho_yaliyothibitishwa."'";};?>>Uliyopitisha</a> 
      ...
      <div class="w3-col l10 m12" id="main"> 
        <div id="mainLeaderboard" style="overflow:hidden;"> 
          <div class="container_form_kichwa"> 
            <div class="kichwa_ndogo form_link"><a href="http://localhost/user/hod_hou/index.php">Mwanzo</a>&nbsp;<span class="kichwa_ndogo_sana">/</span>&nbsp;Marejesho Mapya</div>
          </div>
          <div class="container_form"> 
		  <?php if($totalRows_rs_yanayoingia == 0){
echo "<div class='rekodi_tupu w3-left'>HAKUNA MAREJESHO YALIYOTUMWA KWAKO!</div>";
}else{?>
