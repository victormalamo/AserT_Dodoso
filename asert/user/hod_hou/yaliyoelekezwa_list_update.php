...
$querdereva=mysqli_query($conntscpME, "SELECT * FROM wafanyakazi WHERE (`levelID` = 'driver')");
$driver_username=$_GET['driver_username'];
...
<?php 
if(($_GET['c_tupu']=="ipo") || ($_GET['tupu'])=="ipo"){ require('reload_tupu_update_hod_u_maelekezo.php'); }else{ require('reload_update_hod_u_maelekezo.php'); };
?>
    ...
    <div id="leftmenuinner" style="padding-top: 0px;"> 
      <div class="w3-light-greyQ" id="leftmenuinnerinner"> <br class="w3-hide-large">
        ...
        <div class="menu-1" style="display: none;"> <a target="_top" href="http://localhost/user/hod_hou/maombi_mapya.php"> 
          ...
          <a target="_top" href="http://localhost">maelekezo</a> </div>
        ...
        <div class="menu_teuzi" style="display: block;"> <a target="_top" href="http://localhost/user/hod_hou/yanayoingia_list.php" <?php if($idadi_yanayoingia_hod_u != ""){echo "class='badge1' data-badge='".$idadi_yanayoingia_hod_u."'";};?>>Yanayoingia</a> 
          ...
          <a target="_top" href="http://localhost/user/hod_hou/yaliyoelekezwa_list.php" <?php if($idadi_yaliyokataliwa_hod_u != ""){echo "class='badge1' data-badge='".$idadi_yaliyokataliwa_hod_u."'";};?>>Uliyokataa</a> 
          <div id="sidenav-imechaguliwa_2"<?php if($idadi_yaliyoelekezwa_hod_u != ""){echo "class='badge1' data-badge='".$idadi_yaliyoelekezwa_hod_u."'";};?>>Uliyoelekeza</div>
        </div>
      ...
      <div class="w3-col l10 m12" id="main"> 
        <div id="mainLeaderboard" style="overflow:hidden;"> 
          <div class="container_form_kichwa"> 
            <div class="kichwa_ndogo form_link"><a href="http://localhost/user/hod_hou/index.php">Mwanzo</a>&nbsp;<span class="kichwa_ndogo_sana">/</span>&nbsp;Tuma 
              Maombi</div>
          </div> 
          <!-- Mwanzo wa fomu-->
          <div class="container_form"> 
            ...
            <div class="w3-small w3-opacity form_link"  style="padding:0px 0px 10px 0px;"><a href="http://localhost/user/hod_hou/yaliyoelekezwa_list.php">Yote 
              Yenye Maelekezo</a>&nbsp;&nbsp;<span class="w3-tiny">/</span>&nbsp;&nbsp;<a href="http://localhost/user/hod_hou/yaliyoelekezwa_tazama.php?id=<?php echo $_GET['id'];?>">Tazama 
            ...
            <?php if($_GET['ruti_ID'] == "ruti_zaidi_ya_moja"){?><form action="yaliyoelekezwa_list_updatequery_unganisha.php" method="POST" name="yaliyoelekezwa_list_updateForm" id="yaliyoelekezwa_list_updateForm"> 
            <?php }else{?>
            <form action="yaliyoelekezwa_list_updatequery.php" method="POST" name="yaliyoelekezwa_list_updateForm" id="yaliyoelekezwa_list_updateForm">
              <?php };?>
              ...
              <!--CHAGUA DEREVA-->
              <div class="row_form"> 
                <div class="col-form-75 dereva"> 
                  <!--input type="text" class="registrationFormtext" id="dereva" name="dereva" value="<php echo $_GET['dereva'];?>"/-->
                  <?php
				echo "<select name='driver_username' id='driver_username' class='wide' width='100%' style='width: 100%' onchange=\'reloadusafiriHOLD(this.form)\'><option value='' selected disabled>Chagua dereva..</option>";
				while($noticiadereva = mysqli_fetch_array($querdereva)) {
				if($noticiadereva['username']==@$driver_username){echo "<option selected value='$noticiadereva[username]'>$noticiadereva[f_name]&nbsp;$noticiadereva[m_name]&nbsp;$noticiadereva[l_name]</option>"."<BR>";}
				else{echo "<option  value='$noticiadereva[username]'>$noticiadereva[f_name]&nbsp;$noticiadereva[m_name]&nbsp;$noticiadereva[l_name]</option>";}
				}
				echo "</select>";
				?>
                </div>
              ...
              <div class="row_form"> 
                ...
                <div class="col-form-75" data-tip="Namba ya uhakiki"> <img src="http://localhost/user/hod_hou/verificationimage.php?<?php echo rand(0,9999);?>" alt="verification image, type it in the box" width="87" height="39" align="absbottom" /> 
                </div>
              </div>
              <div class="row_form"> 
                <div class="col-form-25"> 
              ...
              <input name="last_edited_hod_u" type="hidden" id="last_edited_hod_u" value="<?php echo date("d-m-Y");?>">
              <!--input name="submitDate" type="hidden" id="submitDate" value="<php echo date("d-m-Y");?>"-->
              <input name="page" type="hidden" id="page" value="<?php echo "yaliyoelekezwa_list_update";?>">
              <!-- Kwa ajili ya kukagua field-->
              <!--input name="general_status" type="hidden" id="general_status" value="<php echo "kipya";?>"-->
              <input type="hidden" name="MM_update" value="yaliyoelekezwa_list_updateForm">
              <?php }; ?>
              <!-- POPUP MAP -->
