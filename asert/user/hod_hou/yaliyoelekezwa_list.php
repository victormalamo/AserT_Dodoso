...
<?php 
include('status.php');
include('aina_ya_kibali_hod_u.php');

$div_unit_ID = $_SESSION['div_unit_ID'];
//$section_ID = $_SESSION['section_ID'];
//$levelID = "nu" of "hos"
$general_status = "maelekezo_hod_u";
//$zimebaki_siku >=0;

//Maelekezo Staff wa Kawaida "nu"

$query_rs_maelekezo_nu = sprintf("SELECT * FROM vibali WHERE ((`div_unit_ID` = '%s' ) AND (`levelID`='nu')  AND (`general_status`='%s') AND (`zimebaki_siku` >= 0 )) ORDER BY id DESC", $div_unit_ID,$general_status);
$rs_maelekezo_nu = mysqli_query($conntscpME, $query_rs_maelekezo_nu) or die(mysqli_error());
$row_rs_maelekezo_nu = mysqli_fetch_assoc($rs_maelekezo_nu);
$totalRows_rs_maelekezo_nu = mysqli_num_rows($rs_maelekezo_nu);

//Maelekezo kwa mkuu wa seksheni "hos"

$query_rs_maelekezo_hos = sprintf("SELECT * FROM vibali WHERE ((`div_unit_ID` = '%s' ) AND (`levelID`='hos')  AND (`general_status`='%s') AND (`zimebaki_siku` >= 0 )) ORDER BY id DESC", $div_unit_ID,$general_status);
$rs_maelekezo_hos = mysqli_query($conntscpME, $query_rs_maelekezo_hos) or die(mysqli_error());
$row_rs_maelekezo_hos = mysqli_fetch_assoc($rs_maelekezo_hos);
$totalRows_rs_maelekezo_hos = mysqli_num_rows($rs_maelekezo_hos);

//idadi
$idadi_maelekezo_hod_u = ($totalRows_rs_maelekezo_nu + $totalRows_rs_maelekezo_hos);
    ...
    <div id="leftmenuinner" style="padding-top: 0px;"> 
      <div class="w3-light-greyQ" id="leftmenuinnerinner"> <br class="w3-hide-large">
        ...
        <div class="menu-1" style="display: none;"> <a target="_top" href="http://localhost/user/hod_hou/maombi_mapya.php"> 
          ...
          <a target="_top" href="http://localhost">yaliyopitishwa</a> </div>
        ...
        <div class="menu_teuzi" style="display: block;"> <a target="_top" href="http://localhost/user/hod_hou/yanayoingia_list.php"<?php if($idadi_yanayoingia_hod_u != ""){echo "class='badge1' data-badge='".$idadi_yanayoingia_hod_u."'";};?>>Yanayoingia</a> 
          ...
          <div id="sidenav-imechaguliwa_2" <?php if($idadi_maelekezo_hod_u != ""){echo "class='badge1' data-badge='".$idadi_maelekezo_hod_u."'";};?>>Uliyoelekeza</div>
        </div>
      ...
      <div class="w3-col l10 m12" id="main"> 
        <div id="mainLeaderboard" style="overflow:hidden;"> 
          <div class="container_form_kichwa"> 
            <div class="kichwa_ndogo form_link"><a href="http://localhost/user/hod_hou/index.php">Mwanzo</a>&nbsp;<span class="kichwa_ndogo_sana">/</span>&nbsp;Maombi Yaliyoelekezwa</div>
          </div>
          <div class="container_form">
            <?php if($idadi_maelekezo_hod_u == 0){
echo "<div class='rekodi_tupu w3-left'>HAKUNA MAOMBI ULIYOELEKEZA!</div>";
}else{?>
            <!--  *******************  YENYE MAELEKEZO KWA HOS **************-->
            <?php  if($totalRows_rs_maelekezo_hos != 0){
echo "<div class='rekodi_tupu w3-left'></div>";
?>
            <div class="row_form col-view-btm">
			<div class="row_form col-view-title w3-white">Yenye Maelekezo kwa HOS</div>
              <?php $sn=0; do {  $sn++; ?>
              <div class="row_form col-view w3-blue" title="Safari ya siku 7 ..."> 
                <?php if($row_rs_maelekezo_hos['uthibitisho'] == "Nimetekeleza"){?>
                <div class="col-view-namba-green" data-tip="Nifanyw ni wrap words"> 
                  <?php echo $sn.".";?>
                </div>
                <?php }elseif($row_rs_maelekezo_hos['uthibitisho'] == "Nitatekeleza"){?>
                <div class="col-view-namba-blue" data-tip="Nifanyw ni wrap words"> 
                  <?php echo $sn.".";?>
                </div>
                <?php }elseif($row_rs_maelekezo_hos['uthibitisho'] == "Sintatekeleza"){?>
                ...
                <div class="col-view-kwenda"><span class="w3-left col-view-555 col-view-dot " style="margin: 8px 8px 0px 8px"></span>	
                  <?php  //Jina la Mkoa
	$regID=$row_rs_maelekezo_hos['regID'];
	...
	//Jina la Halmashauri
	$lgaID=$row_rs_maelekezo_hos['lgaID'];
	...
	?>
                ...
                <div class="col-view-tarehe"> 
                  <?php echo "Tarehe&nbsp;".$row_rs_maelekezo_hos['sDate'];?>
                  <span class="w3-right col-view-555"> 
                  <!--a href="maombi_mapya_list_update.php?id=<php echo $row_rs_maelekezo_hos['id'];?>&catID=<php echo $row_rs_maelekezo_hos['catID'];?>&regID=<php echo $row_rs_maelekezo_hos['regID'];?>&lgaID=<php echo $row_rs_maelekezo_hos['lgaID'];?>&sDate=<php echo $row_rs_maelekezo_hos['sDate'];?>&eDate=<php echo $row_rs_maelekezo_hos['eDate'];?>&duration=<php echo $row_rs_maelekezo_hos['duration'];?>&usafiriID=<php echo $row_rs_maelekezo_hos['usafiriID'];?>&madhumuniID=<php echo $row_rs_maelekezo_hos['madhumuniID'];?>&muhtasari=<php echo $row_rs_maelekezo_hos['muhtasari'];?>&mlipajiID=<php echo $row_rs_maelekezo_hos['mlipajiID'];?>&wengine=<php echo $row_rs_maelekezo_hos['wengine'];?>&jina_kiambata=<php echo $row_rs_maelekezo_hos['jina_kiambata'];?>&kiambata=<php echo $row_rs_maelekezo_hos['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>
	&nbsp;<a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_maelekezo_hos['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;-->
                  <a href="yaliyoelekezwa_tazama.php?id=<?php echo $row_rs_maelekezo_hos['id'];?>"> 
                  <?php if($row_rs_maelekezo_hos['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                ...
                <div class="col-view-madhumuni"> 
                  <?php
	//Madhumuni
	$madhumuniID=$row_rs_maelekezo_hos['madhumuniID'];
	...
	echo $row_rsmadhumuni['madhumuni'];?>
                ...
                <div class="col-view-icons"> 
                  <!--span><a href="maombi_mapya_list_update.php?id=<php echo $row_rs_maelekezo['id'];?>&catID=<php echo $row_rs_maelekezo['catID'];?>&regID=<php echo $row_rs_maelekezo['regID'];?>&lgaID=<php echo $row_rs_maelekezo['lgaID'];?>&sDate=<php echo $row_rs_maelekezo['sDate'];?>&eDate=<php echo $row_rs_maelekezo['eDate'];?>&duration=<php echo $row_rs_maelekezo['duration'];?>&usafiriID=<php echo $row_rs_maelekezo['usafiriID'];?>&madhumuniID=<php echo $row_rs_maelekezo['madhumuniID'];?>&muhtasari=<php echo $row_rs_maelekezo['muhtasari'];?>&mlipajiID=<php echo $row_rs_maelekezo['mlipajiID'];?>&wengine=<php echo $row_rs_maelekezo['wengine'];?>&jina_kiambata=<php echo $row_rs_maelekezo['jina_kiambata'];?>&kiambata=<php echo $row_rs_maelekezo['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>&nbsp;&nbsp;</span>
	<span><a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_maelekezo['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;&nbsp;</span-->
                  <span><a href="yaliyoelekezwa_tazama.php?id=<?php echo $row_rs_maelekezo_hos['id'];?>"> 
                  <?php if($row_rs_maelekezo_hos['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
              ...
              <?php } while ($row_rs_maelekezo_hos = mysqli_fetch_assoc($rs_maelekezo_hos));?>
            </div>
            <?php }; ?>
            <!-- End YENYE MAELEKEZO KWA MKUU WA SEKSHENI-->
            <!--  *******************  YENYE MAELEKEZO KWA NU **************-->
            <?php  if($totalRows_rs_maelekezo_nu != 0){
echo "<div class='rekodi_tupu w3-left'></div>";
?>
            <div class="row_form col-view-btm">
			<div class="row_form col-view-title w3-white">Yenye Maelekezo kwa Mtumishi</div>
              <?php $sn=0; do {  $sn++; ?>
              <div class="row_form col-view w3-blue" title="Safari ya siku 7 ..."> 
                <?php if($row_rs_maelekezo_nu['uthibitisho'] == "Nimetekeleza"){?>
                <div class="col-view-namba-green" data-tip="Nifanyw ni wrap words"> 
                  <?php echo $sn.".";?>
                </div>
                <?php }elseif($row_rs_maelekezo_nu['uthibitisho'] == "Nitatekeleza"){?>
                <div class="col-view-namba-blue" data-tip="Nifanyw ni wrap words"> 
                  <?php echo $sn.".";?>
                </div>
                <?php }elseif($row_rs_maelekezo_nu['uthibitisho'] == "Sintatekeleza"){?>
                <div class="col-view-namba-red" data-tip="Nifanyw ni wrap words"> 
                  <?php echo $sn.".";?>
                </div>
                <?php }else{?>
                ...
                <div class="col-view-kwenda"><span class="w3-left col-view-555 col-view-dot " style="margin: 8px 8px 0px 8px"></span>	
                  <?php  //Jina la Mkoa
	$regID=$row_rs_maelekezo_nu['regID'];
	...
	$totalRows_rsregName = mysqli_num_rows($rsregName);	
	//Jina la Halmashauri
	$lgaID=$row_rs_maelekezo_nu['lgaID'];
	...
	?>
                ...
                <div class="col-view-tarehe"> 
                  <?php echo "Tarehe&nbsp;".$row_rs_maelekezo_nu['sDate'];?>
                  <span class="w3-right col-view-555"> 
                  <!--a href="maombi_mapya_list_update.php?id=<php echo $row_rs_maelekezo_nu['id'];?>&catID=<php echo $row_rs_maelekezo_nu['catID'];?>&regID=<php echo $row_rs_maelekezo_nu['regID'];?>&lgaID=<php echo $row_rs_maelekezo_nu['lgaID'];?>&sDate=<php echo $row_rs_maelekezo_nu['sDate'];?>&eDate=<php echo $row_rs_maelekezo_nu['eDate'];?>&duration=<php echo $row_rs_maelekezo_nu['duration'];?>&usafiriID=<php echo $row_rs_maelekezo_nu['usafiriID'];?>&madhumuniID=<php echo $row_rs_maelekezo_nu['madhumuniID'];?>&muhtasari=<php echo $row_rs_maelekezo_nu['muhtasari'];?>&mlipajiID=<php echo $row_rs_maelekezo_nu['mlipajiID'];?>&wengine=<php echo $row_rs_maelekezo_nu['wengine'];?>&jina_kiambata=<php echo $row_rs_maelekezo_nu['jina_kiambata'];?>&kiambata=<php echo $row_rs_maelekezo_nu['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>
	&nbsp;<a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_maelekezo_nu['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;-->
                  <a href="yaliyoelekezwa_tazama.php?id=<?php echo $row_rs_maelekezo_nu['id'];?>"> 
                  <?php if($row_rs_maelekezo_nu['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
                  <?php };?>
                ...
                <div class="col-view-madhumuni"> 
                  <?php
	//Madhumuni
	$madhumuniID=$row_rs_maelekezo_nu['madhumuniID'];
	...
	echo $row_rsmadhumuni['madhumuni'];?>
                ...
                <div class="col-view-icons"> 
                  <!--span><a href="maombi_mapya_list_update.php?id=<php echo $row_rs_maelekezo['id'];?>&catID=<php echo $row_rs_maelekezo['catID'];?>&regID=<php echo $row_rs_maelekezo['regID'];?>&lgaID=<php echo $row_rs_maelekezo['lgaID'];?>&sDate=<php echo $row_rs_maelekezo['sDate'];?>&eDate=<php echo $row_rs_maelekezo['eDate'];?>&duration=<php echo $row_rs_maelekezo['duration'];?>&usafiriID=<php echo $row_rs_maelekezo['usafiriID'];?>&madhumuniID=<php echo $row_rs_maelekezo['madhumuniID'];?>&muhtasari=<php echo $row_rs_maelekezo['muhtasari'];?>&mlipajiID=<php echo $row_rs_maelekezo['mlipajiID'];?>&wengine=<php echo $row_rs_maelekezo['wengine'];?>&jina_kiambata=<php echo $row_rs_maelekezo['jina_kiambata'];?>&kiambata=<php echo $row_rs_maelekezo['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>&nbsp;&nbsp;</span>
	<span><a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_maelekezo['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;&nbsp;</span-->
                  <span><a href="yaliyoelekezwa_tazama.php?id=<?php echo $row_rs_maelekezo_nu['id'];?>"> 
                  <?php if($row_rs_maelekezo_nu['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
              ...
              <?php } while ($row_rs_maelekezo_nu = mysqli_fetch_assoc($rs_maelekezo_nu));?>
            </div>
            <?php }; ?>
            <!-- End YENYE MAELEKEZO KWA NU-->
            <?php };?>
          </div>
          <!-- footer-->
        </div>
