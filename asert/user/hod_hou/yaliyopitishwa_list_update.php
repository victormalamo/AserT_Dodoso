...
<?php 
if(($_GET['c_tupu']=="ipo") || ($_GET['tupu'])=="ipo"){ require('reload_tupu_update_hod_u_yaliyopitishwa.php'); }else{ require('reload_update_hod_u_yaliyopitishwa.php'); };
?>
      ...
      <div class="w3-col l10 m12" id="main"> 
        <div id="mainLeaderboard" style="overflow:hidden;"> 
          ...
          <div class="container_form"> 
            ...
            <div class="w3-small w3-opacity form_link"  style="padding:0px 0px 10px 0px;"><a href="http://localhost/user/hod_hou/yaliyopitishwa_list.php">Yote 
              yaliyopitishwa</a>&nbsp;&nbsp;<span class="w3-tiny">/</span>&nbsp;&nbsp;<a href="http://localhost/user/hod_hou/yaliyopitishwa_tazama.php?id=<?php echo $_GET['id'];?>">Tazama 
            ...
            <?php if($_GET['ruti_ID'] == "ruti_zaidi_ya_moja"){?><form action="yaliyopitishwa_list_updatequery_unganisha.php" method="POST" name="yaliyopitishwa_list_updateForm" id="yaliyopitishwa_list_updateForm"> 
            <?php }else{?>
            <form action="yaliyopitishwa_list_updatequery.php" method="POST" name="yaliyopitishwa_list_updateForm" id="yaliyopitishwa_list_updateForm">
              <?php };?>
              ...
              <input name="page" type="hidden" id="page" value="<?php echo "yaliyopitishwa_list_update";?>">
              <!-- Kwa ajili ya kukagua field-->
              <!--input name="general_status" type="hidden" id="general_status" value="<php echo "kipya";?>"-->
              <input type="hidden" name="MM_update" value="yaliyopitishwa_list_updateForm">
              <?php }; ?>
              <!-- POPUP MAP -->
