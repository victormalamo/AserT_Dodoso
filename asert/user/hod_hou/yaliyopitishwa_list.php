...
//$levelID = "nu";
$general_status_hod_u = "kimepitishwa_hod_u";
$general_status_dahrm = "kimepitishwa_dahrm";
//$zimebaki_siku >=0;

//Maombi ya HOS yaliyopitishwa

$query_rs_yaliyopitishwa_ya_hos = sprintf("SELECT * FROM vibali WHERE ((`div_unit_ID` = '%s' ) AND (`levelID`='hos')  AND ((`general_status`='%s') || (`general_status`='%s')) AND (`zimebaki_siku` >= 0 )) ORDER BY id DESC", $div_unit_ID,$general_status_hod_u,$general_status_dahrm);
...
$query_rs_yaliyopitishwa_ya_nu = sprintf("SELECT * FROM vibali WHERE ((`div_unit_ID` = '%s' ) AND (`levelID`='nu')  AND ((`general_status`='%s') || (`general_status`='%s')) AND (`zimebaki_siku` >= 0 )) ORDER BY id DESC", $div_unit_ID,$general_status_hod_u,$general_status_dahrm);
...
$totalRows_rs_yaliyopitishwa = ($totalRows_rs_yaliyopitishwa_ya_hos + $totalRows_rs_yaliyopitishwa_ya_nu);
    ...
    <div id="leftmenuinner" style="padding-top: 0px;"> 
      <div class="w3-light-greyQ" id="leftmenuinnerinner"> <br class="w3-hide-large">
        ...
        <div class="menu_teuzi" style="display: block;"> <a target="_top" href="http://localhost/user/hod_hou/yanayoingia_list.php" <?php if($idadi_yanayoingia_hod_u != ""){echo "class='badge1' data-badge='".$idadi_yanayoingia_hod_u."'";};?>>Yanayoingia</a> 
          <div id="sidenav-imechaguliwa_2" <?php if($idadi_yaliyopitishwa_hod_u != ""){echo "class='badge1' data-badge='".$idadi_yaliyopitishwa_hod_u."'";};?>>Uliyokubali</div>
      ...
      <div class="w3-col l10 m12" id="main"> 
        <div id="mainLeaderboard" style="overflow:hidden;"> 
          <div class="container_form_kichwa"> 
            <div class="kichwa_ndogo form_link"><a href="http://localhost/user/hod_hou/index.php">Mwanzo</a>&nbsp;<span class="kichwa_ndogo_sana">/</span>&nbsp;Maombi Yaliyopitishwa</div>
          </div>
...
echo "<div class='rekodi_tupu w3-left'>HAKUNA MAOMBI YALIYOPITISHWA!</div>";
		   ...
		   echo "<div class='rekodi_tupu w3-left'></div>";
			...
			<div class="row_form col-view-title w3-white">Maombi Yaliyopitishwa - HOS</div>
              <?php $sn=0; do {  $sn++; ?>
	...
	<span><a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_yaliyopitishwa['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;&nbsp;</span-->
		   ...
		   echo "<div class='rekodi_tupu w3-left'></div>";
		    ?>
           <div class="row_form col-view-btm"> 
			<div class="row_form col-view-title w3-white">Maombi Yaliyopitishwa - Watumishi</div>
              <?php $sn=0; do {  $sn++; ?>
              <div class="row_form col-view w3-blue" title="Safari ya siku 7 ..."> 
                <div class="col-view-namba" data-tip="Nifanyw ni wrap words"> 
                  <?php echo $sn.".";?>
