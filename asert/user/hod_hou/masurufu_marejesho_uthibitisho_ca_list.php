...
?>
<?php 
$_SESSION['kutoka_link'] = "masurufu_marejesho_uthibitisho_ca_list.php";
include('status.php');
...
$query_rs_marejesho_ca_nu = sprintf("SELECT vibali.*, marejesho.* FROM vibali, marejesho WHERE ((vibali.mlipajiID = '%s' ) AND (vibali.levelID = 'nu' ) AND ((vibali.masurufu_id = marejesho.masurufu_id) || (vibali.driver_masurufu_id = marejesho.driver_masurufu_id)) AND (marejesho.kiasi_nilichochukua > 0) AND ((marejesho.masurufu_marejesho_general_status = 'ameona_ca') || (marejesho.masurufu_marejesho_general_status = 'mapya')) AND ((marejesho.nathibitisha_sithibitishi_ca = 'nathibitisha') || (marejesho.nathibitisha_sithibitishi_ca = 'sithibitishi'))) ORDER BY id DESC", $div_unit_ID);
$rs_marejesho_ca_nu = mysqli_query($conntscpME, $query_rs_marejesho_ca_nu) or die(mysqli_error());
$row_rs_marejesho_ca_nu = mysqli_fetch_assoc($rs_marejesho_ca_nu);
$totalRows_rs_marejesho_ca_nu = mysqli_num_rows($rs_marejesho_ca_nu);

//KUTOKA KWA HOS 

$query_rs_marejesho_ca_hos = sprintf("SELECT vibali.*, marejesho.* FROM vibali, marejesho WHERE ((vibali.mlipajiID = '%s' ) AND (vibali.levelID = 'hos' ) AND ((vibali.masurufu_id = marejesho.masurufu_id) || (vibali.driver_masurufu_id = marejesho.driver_masurufu_id)) AND (marejesho.kiasi_nilichochukua > 0) AND ((marejesho.masurufu_marejesho_general_status = 'ameona_ca') || (marejesho.masurufu_marejesho_general_status = 'mapya')) AND ((marejesho.nathibitisha_sithibitishi_ca = 'nathibitisha') || (marejesho.nathibitisha_sithibitishi_ca = 'sithibitishi'))) ORDER BY id DESC", $div_unit_ID);
$rs_marejesho_ca_hos = mysqli_query($conntscpME, $query_rs_marejesho_ca_hos) or die(mysqli_error());
$row_rs_marejesho_ca_hos = mysqli_fetch_assoc($rs_marejesho_ca_hos);
$totalRows_rs_marejesho_ca_hos = mysqli_num_rows($rs_marejesho_ca_hos);

//KUTOKA KWA HOD_U 

$query_rs_marejesho_ca_hod_u = sprintf("SELECT vibali.*, marejesho.* FROM vibali, marejesho WHERE ((vibali.mlipajiID = '%s' ) AND ((vibali.levelID = 'hod' ) || (vibali.levelID = 'hou' )) AND ((vibali.masurufu_id = marejesho.masurufu_id) || (vibali.driver_masurufu_id = marejesho.driver_masurufu_id)) AND (marejesho.kiasi_nilichochukua > 0) AND ((marejesho.masurufu_marejesho_general_status = 'ameona_ca') || (marejesho.masurufu_marejesho_general_status = 'mapya')) AND ((marejesho.nathibitisha_sithibitishi_ca = 'nathibitisha') || (marejesho.nathibitisha_sithibitishi_ca = 'sithibitishi'))) ORDER BY id DESC", $div_unit_ID);
$rs_marejesho_ca_hod_u = mysqli_query($conntscpME, $query_rs_marejesho_ca_hod_u) or die(mysqli_error());
$row_rs_marejesho_ca_hod_u = mysqli_fetch_assoc($rs_marejesho_ca_hod_u);
$totalRows_rs_marejesho_ca_hod_u = mysqli_num_rows($rs_marejesho_ca_hod_u);

$totalRows_rs_marejesho_ca = ($totalRows_rs_marejesho_ca_nu + $totalRows_rs_marejesho_ca_hos + $totalRows_rs_marejesho_ca_hod_u);
    ...
    <div id="leftmenuinner" style="padding-top: 0px;"> 
      <div class="w3-light-greyQ" id="leftmenuinnerinner"> <br class="w3-hide-large">
        ...
        <div id="sidenav-title" class="show_teuzi content_teuzi mkono">Shughulikia 
          Marejesho</div>
        <div class="menu_teuzi" style="display: block;"> <a target="_top" href="http://localhost/user/hod_hou/masurufu_marejesho_yanayoingia_list.php" <?php if($idadi_marejesho_yanayoingia != ""){echo "class='badge1' data-badge='".$idadi_marejesho_yanayoingia."'";};?>>Marejesho 
          ...
          <div id="sidenav-imechaguliwa_2"  <?php if($idadi_marejesho_yamekubaliwa_ca != ""){echo "class='badge1' data-badge='".$idadi_marejesho_yamekubaliwa_ca."'";};?>>Uthibitisho 
            - CA</div>
        </div>
      ...
      <div class="w3-col l10 m12" id="main"> 
        <div id="mainLeaderboard" style="overflow:hidden;"> 
          <div class="container_form_kichwa"> 
            <div class="kichwa_ndogo form_link"><a href="http://localhost/user/hod_hou/index.php">Mwanzo</a>&nbsp;<span class="kichwa_ndogo_sana">/</span>&nbsp;Marejesho 
              Yaliyothibitishwa</div>
          </div>
          <div class="container_form"> 
            <?php if($totalRows_rs_marejesho_ca == 0){
echo "<div class='rekodi_tupu w3-left'>HAKUNA MAREJESHO YALIYOTHIBITISHWA NA CA!</div>";
}else{?>
            <!--  *******************  YANAYOTOKA KWA HOD_U /DAHRM**************-->
            <?php if($totalRows_rs_marejesho_ca_hod_u != 0){
		   ...
		   echo "<div class='rekodi_tupu w3-left'></div>";
            ...
            <div class="row_form col-view-btm"> 
              ...
              <?php $sn=0; do {  $sn++; ?>
              <div class="row_form col-view w3-indigo" title="Safari ya siku 7 ..."> 
                <div class="col-view-namba" data-tip="Nifanyw ni wrap words"> 
                  <?php if($row_rs_marejesho_ca_hod_u['masurufu_id'] == 0) { echo "D."; $sn = $sn - 1;}else{ echo $sn."."; }?>
                </div>
                <div class="col-view-kwenda"><span class="w3-left col-view-555 col-view-dot " style="margin: 8px 8px 0px 8px"></span>	
                  <?php  //Jina la Mkoa
	$regID=$row_rs_marejesho_ca_hod_u['regID'];
	...
	//Jina la Halmashauri
	$lgaID=$row_rs_marejesho_ca_hod_u['lgaID'];
	...
	//Jina la kuonesha
	if ($row_rs_marejesho_ca_hod_u['lgaID']==""){
	...
	?>
                ...
                <div class="col-view-tarehe"> 
                  <?php echo "Tarehe&nbsp;".$row_rs_marejesho_ca_hod_u['sDate'];?>
                  <span class="w3-right col-view-555"> 
                  <!--a href="maombi_mapya_list_update.php?id=<php echo $row_rs_marejesho_ca['id'];?>&catID=<php echo $row_rs_marejesho_ca['catID'];?>&regID=<php echo $row_rs_marejesho_ca['regID'];?>&lgaID=<php echo $row_rs_marejesho_ca['lgaID'];?>&sDate=<php echo $row_rs_marejesho_ca['sDate'];?>&eDate=<php echo $row_rs_marejesho_ca['eDate'];?>&duration=<php echo $row_rs_marejesho_ca['duration'];?>&usafiriID=<php echo $row_rs_marejesho_ca['usafiriID'];?>&madhumuniID=<php echo $row_rs_marejesho_ca['madhumuniID'];?>&muhtasari=<php echo $row_rs_marejesho_ca['muhtasari'];?>&mlipajiID=<php echo $row_rs_marejesho_ca['mlipajiID'];?>&wengine=<php echo $row_rs_marejesho_ca['wengine'];?>&jina_kiambata=<php echo $row_rs_marejesho_ca['jina_kiambata'];?>&kiambata=<php echo $row_rs_marejesho_ca['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>
	&nbsp;<a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_marejesho_ca['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;-->
                  <a href="marejesho_yanayoingia_tazama.php?<?php if($row_rs_marejesho_ca_hod_u['masurufu_id'] == 0) { echo 'masurufu=ya_dereva&'; } ?>kibali_id=<?php echo $row_rs_marejesho_ca_hod_u['id'];?>"> 
                  <?php if($row_rs_marejesho_ca_hod_u['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                ...
                <div class="col-view-madhumuni"> 
                  <?php
	//Madhumuni
	$madhumuniID=$row_rs_marejesho_ca_hod_u['madhumuniID'];
	...
	echo $row_rsmadhumuni['madhumuni'];?>
                ...
                <div class="col-view-icons"> 
                  <!--span><a href="maombi_mapya_list_update.php?id=<php echo $row_rs_marejesho_ca['id'];?>&catID=<php echo $row_rs_marejesho_ca['catID'];?>&regID=<php echo $row_rs_marejesho_ca['regID'];?>&lgaID=<php echo $row_rs_marejesho_ca['lgaID'];?>&sDate=<php echo $row_rs_marejesho_ca['sDate'];?>&eDate=<php echo $row_rs_marejesho_ca['eDate'];?>&duration=<php echo $row_rs_marejesho_ca['duration'];?>&usafiriID=<php echo $row_rs_marejesho_ca['usafiriID'];?>&madhumuniID=<php echo $row_rs_marejesho_ca['madhumuniID'];?>&muhtasari=<php echo $row_rs_marejesho_ca['muhtasari'];?>&mlipajiID=<php echo $row_rs_marejesho_ca['mlipajiID'];?>&wengine=<php echo $row_rs_marejesho_ca['wengine'];?>&jina_kiambata=<php echo $row_rs_marejesho_ca['jina_kiambata'];?>&kiambata=<php echo $row_rs_marejesho_ca['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>&nbsp;&nbsp;</span>
	<span><a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_marejesho_ca['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;&nbsp;</span-->
                  <span><a href="marejesho_yanayoingia_tazama.php?<?php if($row_rs_marejesho_ca_hod_u['masurufu_id'] == 0) { echo 'masurufu=ya_dereva&'; } ?>kibali_id=<?php echo $row_rs_marejesho_ca_hod_u['id'];?>"> 
                  <?php if($row_rs_marejesho_ca_hod_u['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
              ...
              <?php } while ($row_rs_marejesho_ca_hod_u = mysqli_fetch_assoc($rs_marejesho_ca_hod_u));?>
            </div>
            <?php } ?>
            <!--  *******************  END YANAYOTOKA KWA HODs & HOUs **************-->
            <!--  *******************  YANAYOTOKA KWA HOS **************-->
            <?php if($totalRows_rs_marejesho_ca_hos != 0){
		   ...
		   echo "<div class='rekodi_tupu w3-left'></div>";   ?>
            <div class="row_form col-view-btm"> 
              ...
              <div class="row_form col-view w3-indigo" title="Safari ya siku 7 ..."> 
                <div class="col-view-namba" data-tip="Nifanyw ni wrap words"> 
                  <?php if($row_rs_marejesho_ca_hos['masurufu_id'] == 0) { echo "D."; $sn = $sn - 1;}else{ echo $sn."."; }?>
                </div>
                <div class="col-view-kwenda"><span class="w3-left col-view-555 col-view-dot " style="margin: 8px 8px 0px 8px"></span>	
                  <?php  //Jina la Mkoa
	$regID=$row_rs_marejesho_ca_hos['regID'];
	...
	$totalRows_rsregName = mysqli_num_rows($rsregName);	
	//Jina la Halmashauri
	$lgaID=$row_rs_marejesho_ca_hos['lgaID'];
	...
	$totalRows_rslgaName = mysqli_num_rows($rslgaName);
	//Jina la kuonesha
	if ($row_rs_marejesho_ca_hos['lgaID']==""){
	echo "Kwenda&nbsp;".$row_rsregName['regNam'];
	}else{
	echo "Kwenda&nbsp;".$row_rslgaName['lgaNam'];
	};
	?>
                ...
                <div class="col-view-tarehe"> 
                  <?php echo "Tarehe&nbsp;".$row_rs_marejesho_ca_hos['sDate'];?>
                  <span class="w3-right col-view-555"> 
                  <!--a href="maombi_mapya_list_update.php?id=<php echo $row_rs_marejesho_ca['id'];?>&catID=<php echo $row_rs_marejesho_ca['catID'];?>&regID=<php echo $row_rs_marejesho_ca['regID'];?>&lgaID=<php echo $row_rs_marejesho_ca['lgaID'];?>&sDate=<php echo $row_rs_marejesho_ca['sDate'];?>&eDate=<php echo $row_rs_marejesho_ca['eDate'];?>&duration=<php echo $row_rs_marejesho_ca['duration'];?>&usafiriID=<php echo $row_rs_marejesho_ca['usafiriID'];?>&madhumuniID=<php echo $row_rs_marejesho_ca['madhumuniID'];?>&muhtasari=<php echo $row_rs_marejesho_ca['muhtasari'];?>&mlipajiID=<php echo $row_rs_marejesho_ca['mlipajiID'];?>&wengine=<php echo $row_rs_marejesho_ca['wengine'];?>&jina_kiambata=<php echo $row_rs_marejesho_ca['jina_kiambata'];?>&kiambata=<php echo $row_rs_marejesho_ca['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>
	&nbsp;<a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_marejesho_ca['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;-->
                  <a href="marejesho_yanayoingia_tazama.php?<?php if($row_rs_marejesho_ca_hos['masurufu_id'] == 0) { echo 'masurufu=ya_dereva&'; } ?>kibali_id=<?php echo $row_rs_marejesho_ca_hos['id'];?>"> 
                  <?php if($row_rs_marejesho_ca_hos['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
                  <?php };?>
                ...
                <div class="col-view-madhumuni"> 
                  <?php
	//Madhumuni
	$madhumuniID=$row_rs_marejesho_ca_hos['madhumuniID'];
	...
	echo $row_rsmadhumuni['madhumuni'];?>
                ...
                <div class="col-view-icons"> 
                  <!--span><a href="maombi_mapya_list_update.php?id=<php echo $row_rs_marejesho_ca['id'];?>&catID=<php echo $row_rs_marejesho_ca['catID'];?>&regID=<php echo $row_rs_marejesho_ca['regID'];?>&lgaID=<php echo $row_rs_marejesho_ca['lgaID'];?>&sDate=<php echo $row_rs_marejesho_ca['sDate'];?>&eDate=<php echo $row_rs_marejesho_ca['eDate'];?>&duration=<php echo $row_rs_marejesho_ca['duration'];?>&usafiriID=<php echo $row_rs_marejesho_ca['usafiriID'];?>&madhumuniID=<php echo $row_rs_marejesho_ca['madhumuniID'];?>&muhtasari=<php echo $row_rs_marejesho_ca['muhtasari'];?>&mlipajiID=<php echo $row_rs_marejesho_ca['mlipajiID'];?>&wengine=<php echo $row_rs_marejesho_ca['wengine'];?>&jina_kiambata=<php echo $row_rs_marejesho_ca['jina_kiambata'];?>&kiambata=<php echo $row_rs_marejesho_ca['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>&nbsp;&nbsp;</span>
	<span><a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_marejesho_ca['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;&nbsp;</span-->
                  <span><a href="marejesho_yanayoingia_tazama.php?<?php if($row_rs_marejesho_ca_hos['masurufu_id'] == 0) { echo 'masurufu=ya_dereva&'; } ?>kibali_id=<?php echo $row_rs_marejesho_ca_hos['id'];?>"> 
                  <?php if($row_rs_marejesho_ca_hos['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
              ...
              <?php } while ($row_rs_marejesho_ca_hos = mysqli_fetch_assoc($rs_marejesho_ca_hos));?>
            </div>
            <?php } ?>
            <!--  *******************  END YANAYOTOKA KWA HOS **************-->
            <!--  *******************  YANAYOTOKA KWA NU **************-->
            <?php if($totalRows_rs_marejesho_ca_nu != 0){ 
		   echo "<div class='rekodi_tupu w3-left'></div>";
		   ?>
            <div class="row_form col-view-btm"> 
              ...
              <div class="row_form col-view w3-indigo" title="Safari ya siku 7 ..."> 
                <div class="col-view-namba" data-tip="Nifanyw ni wrap words"> 
                  <?php if($row_rs_marejesho_ca_nu['masurufu_id'] == 0) { echo "D."; $sn = $sn - 1;}else{ echo $sn."."; }?>
                </div>
                <div class="col-view-kwenda"><span class="w3-left col-view-555 col-view-dot " style="margin: 8px 8px 0px 8px"></span>	
                  <?php  //Jina la Mkoa
	$regID=$row_rs_marejesho_ca_nu['regID'];
	...
	$totalRows_rsregName = mysqli_num_rows($rsregName);	
	//Jina la Halmashauri
	$lgaID=$row_rs_marejesho_ca_nu['lgaID'];
	...
	$totalRows_rslgaName = mysqli_num_rows($rslgaName);
	//Jina la kuonesha
	if ($row_rs_marejesho_ca_nu['lgaID']==""){
	echo "Kwenda&nbsp;".$row_rsregName['regNam'];
	}else{
	echo "Kwenda&nbsp;".$row_rslgaName['lgaNam'];
	};
	?>
                ...
                <div class="col-view-tarehe"> 
                  <?php echo "Tarehe&nbsp;".$row_rs_marejesho_ca_nu['sDate'];?>
                  <span class="w3-right col-view-555"> 
                  <!--a href="maombi_mapya_list_update.php?id=<php echo $row_rs_marejesho_ca['id'];?>&catID=<php echo $row_rs_marejesho_ca['catID'];?>&regID=<php echo $row_rs_marejesho_ca['regID'];?>&lgaID=<php echo $row_rs_marejesho_ca['lgaID'];?>&sDate=<php echo $row_rs_marejesho_ca['sDate'];?>&eDate=<php echo $row_rs_marejesho_ca['eDate'];?>&duration=<php echo $row_rs_marejesho_ca['duration'];?>&usafiriID=<php echo $row_rs_marejesho_ca['usafiriID'];?>&madhumuniID=<php echo $row_rs_marejesho_ca['madhumuniID'];?>&muhtasari=<php echo $row_rs_marejesho_ca['muhtasari'];?>&mlipajiID=<php echo $row_rs_marejesho_ca['mlipajiID'];?>&wengine=<php echo $row_rs_marejesho_ca['wengine'];?>&jina_kiambata=<php echo $row_rs_marejesho_ca['jina_kiambata'];?>&kiambata=<php echo $row_rs_marejesho_ca['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>
	&nbsp;<a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_marejesho_ca['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;-->
                  <a href="marejesho_yanayoingia_tazama.php?<?php if($row_rs_marejesho_ca_nu['masurufu_id'] == 0) { echo 'masurufu=ya_dereva&'; } ?>kibali_id=<?php echo $row_rs_marejesho_ca_nu['id'];?>"> 
                  <?php if($row_rs_marejesho_ca_nu['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
                  <?php };?>
                ...
                <div class="col-view-madhumuni"> 
                  <?php
	//Madhumuni
	$madhumuniID=$row_rs_marejesho_ca_nu['madhumuniID'];
	...
	echo $row_rsmadhumuni['madhumuni'];?>
                ...
                <div class="col-view-icons"> 
                  <!--span><a href="maombi_mapya_list_update.php?id=<php echo $row_rs_marejesho_ca['id'];?>&catID=<php echo $row_rs_marejesho_ca['catID'];?>&regID=<php echo $row_rs_marejesho_ca['regID'];?>&lgaID=<php echo $row_rs_marejesho_ca['lgaID'];?>&sDate=<php echo $row_rs_marejesho_ca['sDate'];?>&eDate=<php echo $row_rs_marejesho_ca['eDate'];?>&duration=<php echo $row_rs_marejesho_ca['duration'];?>&usafiriID=<php echo $row_rs_marejesho_ca['usafiriID'];?>&madhumuniID=<php echo $row_rs_marejesho_ca['madhumuniID'];?>&muhtasari=<php echo $row_rs_marejesho_ca['muhtasari'];?>&mlipajiID=<php echo $row_rs_marejesho_ca['mlipajiID'];?>&wengine=<php echo $row_rs_marejesho_ca['wengine'];?>&jina_kiambata=<php echo $row_rs_marejesho_ca['jina_kiambata'];?>&kiambata=<php echo $row_rs_marejesho_ca['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>&nbsp;&nbsp;</span>
	<span><a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_marejesho_ca['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;&nbsp;</span-->
                  <span><a href="marejesho_yanayoingia_tazama.php?<?php if($row_rs_marejesho_ca_nu['masurufu_id'] == 0) { echo 'masurufu=ya_dereva&'; } ?>kibali_id=<?php echo $row_rs_marejesho_ca_nu['id'];?>"> 
                  <?php if($row_rs_marejesho_ca_nu['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
              ...
              <?php } while ($row_rs_marejesho_ca_nu = mysqli_fetch_assoc($rs_marejesho_ca_nu));?>
            </div>
            <?php } ?>
