...
function nenda() {
window.location.href="yaliyoelekezwa_list.php";
}
</script>
</head>
...
<div class="row_form">
	...
	<?php 
	if(($row_rsselectedKibali['hodu_status'] !="") && ($_GET['badilisha'] !="ndio")){ echo "&nbsp;&nbsp;[&nbsp;<a href='yaliyoelekezwa_tazama.php?id=$id&maamuzi_ID=$maamuzi_ID&sababu=$sababu&badilisha=ndio'>BADILI</a>&nbsp;]";};?>
    </div> 
    <div class="">
    </div>
</div>
...
<!-- Uthibitisho NU-->
 ...
 <?php if($row_rsselectedKibali['uthibitisho'] != "") {?>
...
<div class="row_form">
    <div class="hos_title mnrt-left-align">
	<?php
	echo $row_rsselectedKibali['uthibitisho'];
	 ?> 
    </div> 
	<?php if($row_rsselectedKibali['sababu_za_uthibitisho'] != "") {?>
    <div class="hos mnrt-left-align">
	<?php echo $row_rsselectedKibali['sababu_za_uthibitisho'];?>
    </div>
	<?php } ?>
</div>
...
<div class="row_form">
	...
	<?php if($row_rsselectedKibali['uthibitisho'] !="") { ?>
	<input name="uthibitisho" id="uthibitisho" type="hidden" value="">
	<input name="sababu_za_uthibitisho" id="sababu_za_uthibitisho" type="hidden" value="">
	<?php };?>
	...
	<input name="hod_u_submitDate" type="hidden" id="hod_u_submitDate" value="<?php echo date("d-m-Y");?>">
