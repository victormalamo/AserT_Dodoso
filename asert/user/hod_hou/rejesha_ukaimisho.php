...
$querwakaimishwaji_hold = sprintf("SELECT wafanyakazi.*, vyeo.* FROM wafanyakazi, vyeo WHERE ((wafanyakazi.levelID != 'hos') AND (wafanyakazi.section_ID = '%s') AND (wafanyakazi.deligatable = 'yes') AND (wafanyakazi.cheo_ID = vyeo.cheo_ID))",$section_ID);
$querwakaimishwaji = mysqli_query($conntscpME, $querwakaimishwaji_hold) or die(mysqli_error());
*/
///////////////////// Taarifa za Mtumishi aliyekaimisha

$colname_rstersuser = $row_rsselectedUkaimisho['aliyekaimisha_username'];
...
//Uthibitisho Baada ya kukabidhi
...
<form action="rejesha_ukaimisho_insert_updatequery.php" method="POST" name="yanayoingia_update" id="yanayoingia_update" enctype="multipart/form-data">

<div class="row_form">
    <div class="title_100S mnrt-left-align">
	KABIDHI UKAIMU HOD/HOU
	<?php 
	if(($row_rsselectedUkaimisho['ukaimisho_id'] !="") && ($row_rsselectedUkaimisho['ripoti_ya_ukaimisho'] !="") && ($_GET['badilisha'] !="ndio") && ($row_rsselectedUkaimisho['imekamilika'] !="ndio")){ echo "&nbsp;&nbsp;[&nbsp;<a href='rejesha_ukaimisho.php?ukaimisho_id=$ukaimisho_id&kibali_id=$kibali_id&ripoti_ya_ukaimisho=$ripoti_ya_ukaimisho&badilisha=ndio'>BADILI</a>&nbsp;]";};?>
    </div> 
    <div class="">
    </div>
</div>

<?php if(($row_rsselectedUkaimisho['ukaimisho_id'] !="") && ($row_rsselectedUkaimisho['ripoti_ya_ukaimisho'] !="") && ($_GET['badilisha'] !="ndio")){?>
...
<table class="table table-fixed table-bordered">
  <tbody>		
	...
	<tr>      
      <td>Mawasiliano</td>
	  <td><?php echo "Simu: ".$row_rstersuser['mob']."&nbsp;Barua pepe: ".$row_rstersuser['e_add']; ?></td>	  
    </tr>
	<tr>      
...
<div class="row_form">
<div class="col-form-75" style="font-weight: bold; padding: 0px 0px 16px 0px; border-bottom:1px solid #cccccc">
Ripoti ya Kukabidhi
</div>
</div>
...
<div class="row_form">
	...
	<a href="ukaimisho/<?php echo $row_rsselectedUkaimisho['aliyekaimisha_username']."/".$row_rsselectedUkaimisho['final_kiambata_2'] ?>" target="_blank"><?php echo "&nbsp;&nbsp;".$row_rsselectedUkaimisho['jina_kiambata_2'];?></a>
    </div>
</div>
<?php };?>
...
<textarea id="ripoti_ya_ukaimisho" class="jqte-test mandatory form-control registrationFormtextarea" name="ripoti_ya_ukaimisho" style="height:100px"><?php echo $row_rsselectedUkaimisho['ripoti_ya_ukaimisho'];?></textarea>
</div>
</div>
...
<div class="row_form"> 
                ...
                <div class="col-form-75" data-tip="Jina la kiambatanishi"> 
                  <input type="text" class="form-control registrationFormtext" id="jina_kiambata" name="jina_kiambata" placeholder="Jina la kiambata.." value="<?php echo $row_rsselectedUkaimisho['jina_kiambata_2'];?>">
                </div>
              </div>
              <div class="row_form"> 
                <div class="col-form-25"> 
                ...
                <div class="col-form-75" data-tip="Kiambatanishi"> 
                  ...
                  <input type="file" class="registrationFormtext inputfile inputfile-6" id="kiambata" name="kiambata" value="<?php echo $row_rsselectedUkaimisho['final_kiambata_2'];?>">
...
<input name="kutoka" id="kutoka" type="hidden" value="<?php echo "rejesha_ukaimisho";?>">
<input name="ukaimisho_id" id="ukaimisho_id" type="hidden" value="<?php echo $row_rsselectedUkaimisho['ukaimisho_id'];?>">
<input name="old_kiambata" type="hidden" id="old_kiambata" value="<?php echo $row_rsselectedUkaimisho['final_kiambata_2'];?>">
<input name="submitDate_ripoti" type="hidden" id="submitDate_ripoti" value="<?php echo date("d-m-Y");?>">
<input name="aliyekaimisha_username" type="hidden" id="aliyekaimisha_username" value="<?php echo $row_rsselectedUkaimisho['aliyekaimisha_username'];?>">
