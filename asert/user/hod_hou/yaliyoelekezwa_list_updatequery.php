...
include('kagua_fields_tupu_update_hod_u_maelekezo.php');
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "yaliyoelekezwa_list_updateForm")) {
