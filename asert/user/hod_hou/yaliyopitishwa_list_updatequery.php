...
include('kagua_fields_tupu_update_hod_u_yaliyopitishwa.php');
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "yaliyopitishwa_list_updateForm")) {
