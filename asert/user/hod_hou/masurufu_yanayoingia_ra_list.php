...
?>
<?php 
$_SESSION['kutoka_link'] = "masurufu_yanayoingia_ra_list.php";
include('status.php');
...
$query_rs_yanayoingia_ra_min = sprintf("SELECT vibali.* FROM vibali, masurufu WHERE ((vibali.levelID = 'min' ) AND (vibali.masurufu_id = masurufu.masurufu_id) AND (masurufu.masurufu_ya_sh > 0) AND (masurufu.anadaiwa_hadaiwi_ra = 'Hadaiwi')) ORDER BY id DESC");
$rs_yanayoingia_ra_min = mysqli_query($conntscpME, $query_rs_yanayoingia_ra_min) or die(mysqli_error());
$row_rs_yanayoingia_ra_min = mysqli_fetch_assoc($rs_yanayoingia_ra_min);
$totalRows_rs_yanayoingia_ra_min = mysqli_num_rows($rs_yanayoingia_ra_min);

//KUTOKA KWA PS

$query_rs_yanayoingia_ra_ps = sprintf("SELECT vibali.* FROM vibali, masurufu WHERE ((vibali.levelID = 'ps' ) AND (vibali.masurufu_id = masurufu.masurufu_id) AND (masurufu.masurufu_ya_sh > 0) AND (masurufu.anadaiwa_hadaiwi_ra = 'Hadaiwi')) ORDER BY id DESC");
$rs_yanayoingia_ra_ps = mysqli_query($conntscpME, $query_rs_yanayoingia_ra_ps) or die(mysqli_error());
$row_rs_yanayoingia_ra_ps = mysqli_fetch_assoc($rs_yanayoingia_ra_ps);
$totalRows_rs_yanayoingia_ra_ps = mysqli_num_rows($rs_yanayoingia_ra_ps);

//KUTOKA KWA HOD_U

$query_rs_yanayoingia_ra_hod_u = sprintf("SELECT vibali.* FROM vibali, masurufu WHERE (((vibali.levelID = 'hod' ) || (vibali.levelID = 'hou' ) || (vibali.levelID = 'dahrm')) AND (vibali.masurufu_id = masurufu.masurufu_id) AND (masurufu.masurufu_ya_sh > 0) AND (masurufu.anadaiwa_hadaiwi_ra = 'Hadaiwi')) ORDER BY id DESC");
$rs_yanayoingia_ra_hod_u = mysqli_query($conntscpME, $query_rs_yanayoingia_ra_hod_u) or die(mysqli_error());
$row_rs_yanayoingia_ra_hod_u = mysqli_fetch_assoc($rs_yanayoingia_ra_hod_u);
$totalRows_rs_yanayoingia_ra_hod_u = mysqli_num_rows($rs_yanayoingia_ra_hod_u);

//KUTOKA KWA HOS

$query_rs_yanayoingia_ra_hos = sprintf("SELECT vibali.* FROM vibali, masurufu WHERE ((vibali.levelID = 'hos' ) AND (vibali.masurufu_id = masurufu.masurufu_id) AND (masurufu.masurufu_ya_sh > 0) AND (masurufu.anadaiwa_hadaiwi_ra = 'Hadaiwi')) ORDER BY id DESC");
$rs_yanayoingia_ra_hos = mysqli_query($conntscpME, $query_rs_yanayoingia_ra_hos) or die(mysqli_error());
$row_rs_yanayoingia_ra_hos = mysqli_fetch_assoc($rs_yanayoingia_ra_hos);
$totalRows_rs_yanayoingia_ra_hos = mysqli_num_rows($rs_yanayoingia_ra_hos);
*/


//KUTOKA KWA NU

$query_rs_yanayoingia_ra_nu = sprintf("SELECT vibali.*, masurufu.* FROM vibali, masurufu WHERE ((vibali.mlipajiID = '%s' ) AND (vibali.levelID = 'nu' ) AND ((vibali.masurufu_id = masurufu.masurufu_id) || (vibali.driver_masurufu_id = masurufu.driver_masurufu_id)) AND (masurufu.masurufu_ya_sh > 0) AND (masurufu.masurufu_general_status = 'mapya')) ORDER BY vibali.id DESC, masurufu.masurufu_id DESC", $div_unit_ID);
$rs_yanayoingia_ra_nu = mysqli_query($conntscpME, $query_rs_yanayoingia_ra_nu) or die(mysqli_error());
$row_rs_yanayoingia_ra_nu = mysqli_fetch_assoc($rs_yanayoingia_ra_nu);
$totalRows_rs_yanayoingia_ra_nu = mysqli_num_rows($rs_yanayoingia_ra_nu);

//KUTOKA KWA HOS

$query_rs_yanayoingia_ra_hos = sprintf("SELECT vibali.*, masurufu.* FROM vibali, masurufu WHERE ((vibali.mlipajiID = '%s' ) AND (vibali.levelID = 'hos' ) AND ((vibali.masurufu_id = masurufu.masurufu_id) || (vibali.driver_masurufu_id = masurufu.driver_masurufu_id)) AND (masurufu.masurufu_ya_sh > 0) AND (masurufu.masurufu_general_status = 'mapya')) ORDER BY vibali.id DESC, masurufu.masurufu_id DESC", $div_unit_ID);
$rs_yanayoingia_ra_hos = mysqli_query($conntscpME, $query_rs_yanayoingia_ra_hos) or die(mysqli_error());
$row_rs_yanayoingia_ra_hos = mysqli_fetch_assoc($rs_yanayoingia_ra_hos);
$totalRows_rs_yanayoingia_ra_hos = mysqli_num_rows($rs_yanayoingia_ra_hos);
...
$query_rs_yanayoingia_ra_hod_u = sprintf("SELECT vibali.*, masurufu.* FROM vibali, masurufu WHERE ((vibali.mlipajiID = '%s' ) AND ((vibali.levelID = 'hod' ) || (vibali.levelID = 'hou' )) AND ((vibali.masurufu_id = masurufu.masurufu_id) || (vibali.driver_masurufu_id = masurufu.driver_masurufu_id)) AND (masurufu.masurufu_ya_sh > 0) AND (masurufu.masurufu_general_status = 'mapya')) ORDER BY vibali.id DESC, masurufu.masurufu_id DESC", $div_unit_ID);
$rs_yanayoingia_ra_hod_u = mysqli_query($conntscpME, $query_rs_yanayoingia_ra_hod_u) or die(mysqli_error());
$row_rs_yanayoingia_ra_hod_u = mysqli_fetch_assoc($rs_yanayoingia_ra_hod_u);
$totalRows_rs_yanayoingia_ra_hod_u = mysqli_num_rows($rs_yanayoingia_ra_hod_u);

$totalRows_rs_yanayoingia_ra = ($totalRows_rs_yanayoingia_ra_nu + $totalRows_rs_yanayoingia_ra_hos + $totalRows_rs_yanayoingia_ra_hod_u);
    ...
    <div id="leftmenuinner" style="padding-top: 0px;"> 
      <div class="w3-light-greyQ" id="leftmenuinnerinner"> <br class="w3-hide-large">
        ...
        <div class="menu_teuzi" style="display: block;"> 
          <div id="sidenav-imechaguliwa_2" <?php if($idadi_masurufu_yanayoingia_ra != ""){echo "class='badge1' data-badge='".$idadi_masurufu_yanayoingia_ra."'";};?>>Maombi 
            Mapya</div>
          <a target="_top" href="http://localhost/user/hod_hou/masurufu_napendekeza_ra_list.php" <?php if($idadi_masurufu_napendekeza_ra != ""){echo "class='badge1' data-badge='".$idadi_masurufu_napendekeza_ra."'";};?>>Uliyopitisha</a> 
...
echo "<div class='rekodi_tupu w3-left'>HAKUNA MAOMBI YALIYOTUMWA KWAKO!</div>";
		   ...
		   echo "<div class='rekodi_tupu w3-left'></div>";
            ...
            <div class="row_form col-view-btm"> 
			  ...
			  <?php if( ($row_rs_yanayoingia_ra_hod_u['usafiriID'] == "gls") && ($row_rs_yanayoingia_ra_hod_u['driver_masurufu_id'] == "") ){?>
			  <div class="row_form col-view w3-blue" title="">
			   <div class="col-view-namba" data-tip="Nifanyw ni wrap words"> 
               <?php  echo $sn."."; ?>
               </div>
			   <div class="col-view-kwenda-exextended">
			  <?php echo "Dereva wa safari namba ".$row_rs_yanayoingia_ra_hod_u['id']." hajaomba masurufu";?>
			  </div>
			  </div>
			  <?php } ?>
			  
              <?php if( ($row_rs_yanayoingia_ra_hod_u['usafiriID'] != "gls") || ($row_rs_yanayoingia_ra_hod_u['masurufu_id'] == 0) || ($row_rs_yanayoingia_ra_hod_u['driver_masurufu_id'] == "amejaza_dereva") ){ ?>
              <div class="row_form col-view w3-blue" title="Safari ya siku 7 ..."> 
                <div class="col-view-namba" data-tip="Nifanyw ni wrap words"> 
                  <?php if($row_rs_yanayoingia_ra_hod_u['masurufu_id'] == 0) { echo "D."; $sn = $sn - 1;}else{ echo $sn."."; }?>
                </div>
                <div class="col-view-kwenda"><span class="w3-left col-view-555 col-view-dot " style="margin: 8px 8px 0px 8px"></span>	
    <?php  //Jina la Mkoa
	$regID=$row_rs_yanayoingia_ra_hod_u['regID'];
	...
	//Jina la Halmashauri
	$lgaID=$row_rs_yanayoingia_ra_hod_u['lgaID'];
	...
	//Jina la kuonesha
	if ($row_rs_yanayoingia_ra_hod_u['lgaID']==""){
	...
	?>
                ...
                <div class="col-view-tarehe"> 
                  <?php echo "Tarehe&nbsp;".$row_rs_yanayoingia_ra_hod_u['sDate'];?>
                  <span class="w3-right col-view-555"> 
                  <!--a href="maombi_mapya_list_update.php?id=<php echo $row_rs_yanayoingia_ra['id'];?>&catID=<php echo $row_rs_yanayoingia_ra['catID'];?>&regID=<php echo $row_rs_yanayoingia_ra['regID'];?>&lgaID=<php echo $row_rs_yanayoingia_ra['lgaID'];?>&sDate=<php echo $row_rs_yanayoingia_ra['sDate'];?>&eDate=<php echo $row_rs_yanayoingia_ra['eDate'];?>&duration=<php echo $row_rs_yanayoingia_ra['duration'];?>&usafiriID=<php echo $row_rs_yanayoingia_ra['usafiriID'];?>&madhumuniID=<php echo $row_rs_yanayoingia_ra['madhumuniID'];?>&muhtasari=<php echo $row_rs_yanayoingia_ra['muhtasari'];?>&mlipajiID=<php echo $row_rs_yanayoingia_ra['mlipajiID'];?>&wengine=<php echo $row_rs_yanayoingia_ra['wengine'];?>&jina_kiambata=<php echo $row_rs_yanayoingia_ra['jina_kiambata'];?>&kiambata=<php echo $row_rs_yanayoingia_ra['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>
	&nbsp;<a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_yanayoingia_ra['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;-->
                  <a href="masurufu_yanayoingia_tazama.php?<?php if($row_rs_yanayoingia_ra_hod_u['masurufu_id'] == 0) { echo 'masurufu=ya_dereva&'; } ?>kibali_id=<?php echo $row_rs_yanayoingia_ra_hod_u['id'];?>"> 
                  <?php if($row_rs_yanayoingia_ra_hod_u['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                ...
                <div class="col-view-madhumuni"> 
                  <?php
	//Madhumuni
	$madhumuniID=$row_rs_yanayoingia_ra_hod_u['madhumuniID'];
	...
	<span><a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_yanayoingia_ra['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;&nbsp;</span-->
                  <span><a href="masurufu_yanayoingia_tazama.php?<?php if($row_rs_yanayoingia_ra_hod_u['masurufu_id'] == 0) { echo 'masurufu=ya_dereva&'; } ?>kibali_id=<?php echo $row_rs_yanayoingia_ra_hod_u['id'];?>"> 
                  <?php if($row_rs_yanayoingia_ra_hod_u['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
              ...
              <?php } ?>
              <?php } while ($row_rs_yanayoingia_ra_hod_u = mysqli_fetch_assoc($rs_yanayoingia_ra_hod_u));?>
            </div>
            ...
            <?php if($totalRows_rs_yanayoingia_ra_hos != 0){
		   
		   echo "<div class='rekodi_tupu w3-left'></div>";   ?>
            <div class="row_form col-view-btm"> 
              <div class="row_form col-view-title w3-white">Wakuu wa Seksheni</div>
              <?php $sn=0; do {  $sn++; ?>
              <?php if( ($row_rs_yanayoingia_ra_hos['usafiriID'] != "gls") || ($row_rs_yanayoingia_ra_hos['masurufu_id'] == 0) || ($row_rs_yanayoingia_ra_hos['driver_masurufu_id'] == "amejaza_dereva") ){ ?>
              <div class="row_form col-view w3-blue" title="Safari ya siku 7 ..."> 
                <div class="col-view-namba" data-tip="Nifanyw ni wrap words"> 
                  <?php if($row_rs_yanayoingia_ra_hos['masurufu_id'] == 0) { echo "D."; $sn = $sn - 1;}else{ echo $sn."."; }?>
                </div>
                <div class="col-view-kwenda"><span class="w3-left col-view-555 col-view-dot " style="margin: 8px 8px 0px 8px"></span>	
                  <?php  //Jina la Mkoa
	$regID=$row_rs_yanayoingia_ra_hos['regID'];
	...
	$totalRows_rsregName = mysqli_num_rows($rsregName);	
	//Jina la Halmashauri
	$lgaID=$row_rs_yanayoingia_ra_hos['lgaID'];
	...
	$totalRows_rslgaName = mysqli_num_rows($rslgaName);
	//Jina la kuonesha
	if ($row_rs_yanayoingia_ra_hos['lgaID']==""){
	echo "Kwenda&nbsp;".$row_rsregName['regNam'];
	}else{
	echo "Kwenda&nbsp;".$row_rslgaName['lgaNam'];
	};
	?>
                ...
                <div class="col-view-tarehe"> 
                  <?php echo "Tarehe&nbsp;".$row_rs_yanayoingia_ra_hos['sDate'];?>
                  <span class="w3-right col-view-555"> 
                  <!--a href="maombi_mapya_list_update.php?id=<php echo $row_rs_yanayoingia_ra['id'];?>&catID=<php echo $row_rs_yanayoingia_ra['catID'];?>&regID=<php echo $row_rs_yanayoingia_ra['regID'];?>&lgaID=<php echo $row_rs_yanayoingia_ra['lgaID'];?>&sDate=<php echo $row_rs_yanayoingia_ra['sDate'];?>&eDate=<php echo $row_rs_yanayoingia_ra['eDate'];?>&duration=<php echo $row_rs_yanayoingia_ra['duration'];?>&usafiriID=<php echo $row_rs_yanayoingia_ra['usafiriID'];?>&madhumuniID=<php echo $row_rs_yanayoingia_ra['madhumuniID'];?>&muhtasari=<php echo $row_rs_yanayoingia_ra['muhtasari'];?>&mlipajiID=<php echo $row_rs_yanayoingia_ra['mlipajiID'];?>&wengine=<php echo $row_rs_yanayoingia_ra['wengine'];?>&jina_kiambata=<php echo $row_rs_yanayoingia_ra['jina_kiambata'];?>&kiambata=<php echo $row_rs_yanayoingia_ra['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>
	&nbsp;<a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_yanayoingia_ra['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;-->
                  <a href="masurufu_yanayoingia_tazama.php?<?php if($row_rs_yanayoingia_ra_hos['masurufu_id'] == 0) { echo 'masurufu=ya_dereva&'; } ?>kibali_id=<?php echo $row_rs_yanayoingia_ra_hos['id'];?>"> 
                  <?php if($row_rs_yanayoingia_ra_hos['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
                  <?php };?>
                ...
                <div class="col-view-madhumuni"> 
                  <?php
	//Madhumuni
	$madhumuniID=$row_rs_yanayoingia_ra_hos['madhumuniID'];
	...
	echo $row_rsmadhumuni['madhumuni'];?>
                ...
                <div class="col-view-icons"> 
                  <!--span><a href="maombi_mapya_list_update.php?id=<php echo $row_rs_yanayoingia_ra['id'];?>&catID=<php echo $row_rs_yanayoingia_ra['catID'];?>&regID=<php echo $row_rs_yanayoingia_ra['regID'];?>&lgaID=<php echo $row_rs_yanayoingia_ra['lgaID'];?>&sDate=<php echo $row_rs_yanayoingia_ra['sDate'];?>&eDate=<php echo $row_rs_yanayoingia_ra['eDate'];?>&duration=<php echo $row_rs_yanayoingia_ra['duration'];?>&usafiriID=<php echo $row_rs_yanayoingia_ra['usafiriID'];?>&madhumuniID=<php echo $row_rs_yanayoingia_ra['madhumuniID'];?>&muhtasari=<php echo $row_rs_yanayoingia_ra['muhtasari'];?>&mlipajiID=<php echo $row_rs_yanayoingia_ra['mlipajiID'];?>&wengine=<php echo $row_rs_yanayoingia_ra['wengine'];?>&jina_kiambata=<php echo $row_rs_yanayoingia_ra['jina_kiambata'];?>&kiambata=<php echo $row_rs_yanayoingia_ra['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>&nbsp;&nbsp;</span>
	<span><a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_yanayoingia_ra['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;&nbsp;</span-->
                  <span><a href="masurufu_yanayoingia_tazama.php?<?php if($row_rs_yanayoingia_ra_hos['masurufu_id'] == 0) { echo 'masurufu=ya_dereva&'; } ?>kibali_id=<?php echo $row_rs_yanayoingia_ra_hos['id'];?>"> 
                  <?php if($row_rs_yanayoingia_ra_hos['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
              ...
              <?php } ?>
              <?php } while ($row_rs_yanayoingia_ra_hos = mysqli_fetch_assoc($rs_yanayoingia_ra_hos));?>
            </div>
            <?php } ?>
            <!--  *******************  END YANAYOTOKA KWA HOS **************-->
            <!--  *******************  YANAYOTOKA KWA NU **************-->
            <?php if($totalRows_rs_yanayoingia_ra_nu != 0){ 
		   echo "<div class='rekodi_tupu w3-left'></div>";
		   ?>
            <div class="row_form col-view-btm"> 
              <div class="row_form col-view-title w3-white">Watumishi</div>
              <?php $sn=0; do {  $sn++; ?>
              <?php if( ($row_rs_yanayoingia_ra_nu['usafiriID'] != "gls") || ($row_rs_yanayoingia_ra_nu['masurufu_id'] == 0) || ($row_rs_yanayoingia_ra_nu['driver_masurufu_id'] == "amejaza_dereva") ){ ?>
              <div class="row_form col-view w3-blue" title="Safari ya siku 7 ..."> 
                <div class="col-view-namba" data-tip="Nifanyw ni wrap words"> 
                  <?php if($row_rs_yanayoingia_ra_nu['masurufu_id'] == 0) { echo "D."; $sn = $sn - 1;}else{ echo $sn."."; }?>
                </div>
                <div class="col-view-kwenda"><span class="w3-left col-view-555 col-view-dot " style="margin: 8px 8px 0px 8px"></span>	
                  <?php  //Jina la Mkoa
	$regID=$row_rs_yanayoingia_ra_nu['regID'];
	...
	$totalRows_rsregName = mysqli_num_rows($rsregName);	
	//Jina la Halmashauri
	$lgaID=$row_rs_yanayoingia_ra_nu['lgaID'];
	...
	$totalRows_rslgaName = mysqli_num_rows($rslgaName);
	//Jina la kuonesha
	if ($row_rs_yanayoingia_ra_nu['lgaID']==""){
	echo "Kwenda&nbsp;".$row_rsregName['regNam'];
	}else{
	echo "Kwenda&nbsp;".$row_rslgaName['lgaNam'];
	};
	?>
                ...
                <div class="col-view-tarehe"> 
                  <?php echo "Tarehe&nbsp;".$row_rs_yanayoingia_ra_nu['sDate'];?>
                  <span class="w3-right col-view-555"> 
                  <!--a href="maombi_mapya_list_update.php?id=<php echo $row_rs_yanayoingia_ra['id'];?>&catID=<php echo $row_rs_yanayoingia_ra['catID'];?>&regID=<php echo $row_rs_yanayoingia_ra['regID'];?>&lgaID=<php echo $row_rs_yanayoingia_ra['lgaID'];?>&sDate=<php echo $row_rs_yanayoingia_ra['sDate'];?>&eDate=<php echo $row_rs_yanayoingia_ra['eDate'];?>&duration=<php echo $row_rs_yanayoingia_ra['duration'];?>&usafiriID=<php echo $row_rs_yanayoingia_ra['usafiriID'];?>&madhumuniID=<php echo $row_rs_yanayoingia_ra['madhumuniID'];?>&muhtasari=<php echo $row_rs_yanayoingia_ra['muhtasari'];?>&mlipajiID=<php echo $row_rs_yanayoingia_ra['mlipajiID'];?>&wengine=<php echo $row_rs_yanayoingia_ra['wengine'];?>&jina_kiambata=<php echo $row_rs_yanayoingia_ra['jina_kiambata'];?>&kiambata=<php echo $row_rs_yanayoingia_ra['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>
	&nbsp;<a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_yanayoingia_ra['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;-->
                  <a href="masurufu_yanayoingia_tazama.php?<?php if($row_rs_yanayoingia_ra_nu['masurufu_id'] == 0) { echo 'masurufu=ya_dereva&'; } ?>kibali_id=<?php echo $row_rs_yanayoingia_ra_nu['id'];?>"> 
                  <?php if($row_rs_yanayoingia_ra_nu['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
                  <?php };?>
                ...
                <div class="col-view-madhumuni"> 
                  <?php
	//Madhumuni
	$madhumuniID=$row_rs_yanayoingia_ra_nu['madhumuniID'];
	...
	echo $row_rsmadhumuni['madhumuni'];?>
                ...
                <div class="col-view-icons"> 
                  <!--span><a href="maombi_mapya_list_update.php?id=<php echo $row_rs_yanayoingia_ra['id'];?>&catID=<php echo $row_rs_yanayoingia_ra['catID'];?>&regID=<php echo $row_rs_yanayoingia_ra['regID'];?>&lgaID=<php echo $row_rs_yanayoingia_ra['lgaID'];?>&sDate=<php echo $row_rs_yanayoingia_ra['sDate'];?>&eDate=<php echo $row_rs_yanayoingia_ra['eDate'];?>&duration=<php echo $row_rs_yanayoingia_ra['duration'];?>&usafiriID=<php echo $row_rs_yanayoingia_ra['usafiriID'];?>&madhumuniID=<php echo $row_rs_yanayoingia_ra['madhumuniID'];?>&muhtasari=<php echo $row_rs_yanayoingia_ra['muhtasari'];?>&mlipajiID=<php echo $row_rs_yanayoingia_ra['mlipajiID'];?>&wengine=<php echo $row_rs_yanayoingia_ra['wengine'];?>&jina_kiambata=<php echo $row_rs_yanayoingia_ra['jina_kiambata'];?>&kiambata=<php echo $row_rs_yanayoingia_ra['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>&nbsp;&nbsp;</span>
	<span><a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_yanayoingia_ra['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;&nbsp;</span-->
                  <span> <a href="masurufu_yanayoingia_tazama.php?<?php if($row_rs_yanayoingia_ra_nu['masurufu_id'] == 0) { echo 'masurufu=ya_dereva&'; } ?>kibali_id=<?php echo $row_rs_yanayoingia_ra_nu['id'];?>"> 
                  <?php if($row_rs_yanayoingia_ra_nu['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
              ...
              <?php } ?>
              <?php } while ($row_rs_yanayoingia_ra_nu = mysqli_fetch_assoc($rs_yanayoingia_ra_nu));?>
            </div>
            <?php } ?>
