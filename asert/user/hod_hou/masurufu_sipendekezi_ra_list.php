...
?>
<?php 
$_SESSION['kutoka_link'] = "masurufu_sipendekezi_ra_list.php";
include('status.php');
...
$query_rs_sipendekezi_ra_min = sprintf("SELECT vibali.* FROM vibali, masurufu WHERE ((vibali.levelID = 'min' ) AND (vibali.masurufu_id = masurufu.masurufu_id) AND (masurufu.masurufu_ya_sh > 0) AND (masurufu.anadaiwa_hadaiwi_ra = 'Hadaiwi')) ORDER BY id DESC");
$rs_sipendekezi_ra_min = mysqli_query($conntscpME, $query_rs_sipendekezi_ra_min) or die(mysqli_error());
$row_rs_sipendekezi_ra_min = mysqli_fetch_assoc($rs_sipendekezi_ra_min);
$totalRows_rs_sipendekezi_ra_min = mysqli_num_rows($rs_sipendekezi_ra_min);

//KUTOKA KWA PS

$query_rs_sipendekezi_ra_ps = sprintf("SELECT vibali.* FROM vibali, masurufu WHERE ((vibali.levelID = 'ps' ) AND (vibali.masurufu_id = masurufu.masurufu_id) AND (masurufu.masurufu_ya_sh > 0) AND (masurufu.anadaiwa_hadaiwi_ra = 'Hadaiwi')) ORDER BY id DESC");
$rs_sipendekezi_ra_ps = mysqli_query($conntscpME, $query_rs_sipendekezi_ra_ps) or die(mysqli_error());
$row_rs_sipendekezi_ra_ps = mysqli_fetch_assoc($rs_sipendekezi_ra_ps);
$totalRows_rs_sipendekezi_ra_ps = mysqli_num_rows($rs_sipendekezi_ra_ps);

//KUTOKA KWA HOD_U

$query_rs_sipendekezi_ra_hod_u = sprintf("SELECT vibali.* FROM vibali, masurufu WHERE (((vibali.levelID = 'hod' ) || (vibali.levelID = 'hou' ) || (vibali.levelID = 'dahrm')) AND (vibali.masurufu_id = masurufu.masurufu_id) AND (masurufu.masurufu_ya_sh > 0) AND (masurufu.anadaiwa_hadaiwi_ra = 'Hadaiwi')) ORDER BY id DESC");
$rs_sipendekezi_ra_hod_u = mysqli_query($conntscpME, $query_rs_sipendekezi_ra_hod_u) or die(mysqli_error());
$row_rs_sipendekezi_ra_hod_u = mysqli_fetch_assoc($rs_sipendekezi_ra_hod_u);
$totalRows_rs_sipendekezi_ra_hod_u = mysqli_num_rows($rs_sipendekezi_ra_hod_u);

//KUTOKA KWA HOS

$query_rs_sipendekezi_ra_hos = sprintf("SELECT vibali.* FROM vibali, masurufu WHERE ((vibali.levelID = 'hos' ) AND (vibali.masurufu_id = masurufu.masurufu_id) AND (masurufu.masurufu_ya_sh > 0) AND (masurufu.anadaiwa_hadaiwi_ra = 'Hadaiwi')) ORDER BY id DESC");
$rs_sipendekezi_ra_hos = mysqli_query($conntscpME, $query_rs_sipendekezi_ra_hos) or die(mysqli_error());
$row_rs_sipendekezi_ra_hos = mysqli_fetch_assoc($rs_sipendekezi_ra_hos);
$totalRows_rs_sipendekezi_ra_hos = mysqli_num_rows($rs_sipendekezi_ra_hos);
*/


//KUTOKA KWA NU KUPITIA KWA RA

$query_rs_sipendekezi_ra_nu = sprintf("SELECT vibali.*, masurufu.* FROM vibali, masurufu WHERE ((vibali.mlipajiID = '%s' ) AND (vibali.levelID = 'nu' ) AND ((vibali.masurufu_id = masurufu.masurufu_id) || (vibali.driver_masurufu_id = masurufu.driver_masurufu_id)) AND (masurufu.masurufu_ya_sh > 0) AND (masurufu.masurufu_general_status = 'ameona_hod_u') AND (masurufu.napendekeza_sipendekezi_hod_u = 'sipendekezi')) ORDER BY vibali.id DESC, masurufu.masurufu_id DESC", $div_unit_ID);
$rs_sipendekezi_ra_nu = mysqli_query($conntscpME, $query_rs_sipendekezi_ra_nu) or die(mysqli_error());
$row_rs_sipendekezi_ra_nu = mysqli_fetch_assoc($rs_sipendekezi_ra_nu);
$totalRows_rs_sipendekezi_ra_nu = mysqli_num_rows($rs_sipendekezi_ra_nu);

//KUTOKA KWA HOS KUPITIA KWA RA

$query_rs_sipendekezi_ra_hos = sprintf("SELECT vibali.*, masurufu.* FROM vibali, masurufu WHERE ((vibali.mlipajiID = '%s' ) AND (vibali.levelID = 'hos' ) AND ((vibali.masurufu_id = masurufu.masurufu_id) || (vibali.driver_masurufu_id = masurufu.driver_masurufu_id)) AND (masurufu.masurufu_ya_sh > 0) AND (masurufu.masurufu_general_status = 'ameona_hod_u') AND (masurufu.napendekeza_sipendekezi_hod_u = 'sipendekezi')) ORDER BY vibali.id DESC, masurufu.masurufu_id DESC", $div_unit_ID);
$rs_sipendekezi_ra_hos = mysqli_query($conntscpME, $query_rs_sipendekezi_ra_hos) or die(mysqli_error());
$row_rs_sipendekezi_ra_hos = mysqli_fetch_assoc($rs_sipendekezi_ra_hos);
$totalRows_rs_sipendekezi_ra_hos = mysqli_num_rows($rs_sipendekezi_ra_hos);
...
$query_rs_sipendekezi_ra_hod_u = sprintf("SELECT vibali.*, masurufu.* FROM vibali, masurufu WHERE ((vibali.mlipajiID = '%s' ) AND ((vibali.levelID = 'hod' ) || (vibali.levelID = 'hou' )) AND ((vibali.masurufu_id = masurufu.masurufu_id) || (vibali.driver_masurufu_id = masurufu.driver_masurufu_id)) AND (masurufu.masurufu_ya_sh > 0) AND (masurufu.masurufu_general_status = 'ameona_hod_u') AND (masurufu.napendekeza_sipendekezi_hod_u = 'sipendekezi')) ORDER BY vibali.id DESC, masurufu.masurufu_id DESC", $div_unit_ID);
$rs_sipendekezi_ra_hod_u = mysqli_query($conntscpME, $query_rs_sipendekezi_ra_hod_u) or die(mysqli_error());
$row_rs_sipendekezi_ra_hod_u = mysqli_fetch_assoc($rs_sipendekezi_ra_hod_u);
$totalRows_rs_sipendekezi_ra_hod_u = mysqli_num_rows($rs_sipendekezi_ra_hod_u);

$totalRows_rs_sipendekezi_ra = ($totalRows_rs_sipendekezi_ra_nu + $totalRows_rs_sipendekezi_ra_hos + $totalRows_rs_sipendekezi_ra_hod_u);
    ...
    <div id="leftmenuinner" style="padding-top: 0px;"> 
      <div class="w3-light-greyQ" id="leftmenuinnerinner"> <br class="w3-hide-large">
        ...
        <div class="menu_teuzi" style="display: block;"> <a target="_top" href="http://localhost/user/hod_hou/masurufu_yanayoingia_ra_list.php" <?php if($idadi_masurufu_yanayoingia_ra != ""){echo "class='badge1' data-badge='".$idadi_masurufu_yanayoingia_ra."'";};?>>Maombi 
          ...
          <div id="sidenav-imechaguliwa_2" <?php if($idadi_masurufu_sipendekezi_ra != ""){echo "class='badge1' data-badge='".$idadi_masurufu_sipendekezi_ra."'";};?>>Uliyokataa</div>
      ...
      <div class="w3-col l10 m12" id="main"> 
        <div id="mainLeaderboard" style="overflow:hidden;"> 
          ...
          <div class="container_form"> 
            <?php if($totalRows_rs_sipendekezi_ra == 0){
echo "<div class='rekodi_tupu w3-left'>HAKUNA MAOMBI ULIYOSITISHA!</div>";
}else{?>
            <!--  *******************  YANAYOTOKA KWA HOD_U /DAHRM**************-->
            <?php if($totalRows_rs_sipendekezi_ra_hod_u != 0){
            ...
            <div class="row_form col-view-btm"> 
              ...
              <div class="row_form col-view w3-blue" title="Safari ya siku 7 ..."> 
                <div class="col-view-namba" data-tip="Nifanyw ni wrap words"> 
                  <?php if($row_rs_yanayodaiwa_hod_u['masurufu_id'] == 0) { echo "D."; $sn = $sn - 1;}else{ echo $sn."."; }?>
                </div>
                <div class="col-view-kwenda"><span class="w3-left col-view-555 col-view-dot " style="margin: 8px 8px 0px 8px"></span>	
                  <?php  //Jina la Mkoa
	$regID=$row_rs_sipendekezi_ra_hod_u['regID'];
	...
	//Jina la Halmashauri
	$lgaID=$row_rs_sipendekezi_ra_hod_u['lgaID'];
	...
	//Jina la kuonesha
	if ($row_rs_sipendekezi_ra_hod_u['lgaID']==""){
	...
	?>
                ...
                <div class="col-view-tarehe"> 
                  <?php echo "Tarehe&nbsp;".$row_rs_sipendekezi_ra_hod_u['sDate'];?>
                  <span class="w3-right col-view-555"> 
                  <!--a href="maombi_mapya_list_update.php?id=<php echo $row_rs_sipendekezi_ra['id'];?>&catID=<php echo $row_rs_sipendekezi_ra['catID'];?>&regID=<php echo $row_rs_sipendekezi_ra['regID'];?>&lgaID=<php echo $row_rs_sipendekezi_ra['lgaID'];?>&sDate=<php echo $row_rs_sipendekezi_ra['sDate'];?>&eDate=<php echo $row_rs_sipendekezi_ra['eDate'];?>&duration=<php echo $row_rs_sipendekezi_ra['duration'];?>&usafiriID=<php echo $row_rs_sipendekezi_ra['usafiriID'];?>&madhumuniID=<php echo $row_rs_sipendekezi_ra['madhumuniID'];?>&muhtasari=<php echo $row_rs_sipendekezi_ra['muhtasari'];?>&mlipajiID=<php echo $row_rs_sipendekezi_ra['mlipajiID'];?>&wengine=<php echo $row_rs_sipendekezi_ra['wengine'];?>&jina_kiambata=<php echo $row_rs_sipendekezi_ra['jina_kiambata'];?>&kiambata=<php echo $row_rs_sipendekezi_ra['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>
	&nbsp;<a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_sipendekezi_ra['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;-->
                  <a href="masurufu_yanayoingia_tazama.php?<?php if($row_rs_sipendekezi_ra_hod_u['masurufu_id'] == 0) { echo 'masurufu=ya_dereva&'; } ?>kibali_id=<?php echo $row_rs_sipendekezi_ra_hod_u['id'];?>"> 
                  <?php if($row_rs_sipendekezi_ra_hod_u['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                ...
                <div class="col-view-madhumuni"> 
                  <?php
	//Madhumuni
	$madhumuniID=$row_rs_sipendekezi_ra_hod_u['madhumuniID'];
	...
	<span><a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_sipendekezi_ra['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;&nbsp;</span-->
                  <span><a href="masurufu_yanayoingia_tazama.php?<?php if($row_rs_sipendekezi_ra_hod_u['masurufu_id'] == 0) { echo 'masurufu=ya_dereva&'; } ?>kibali_id=<?php echo $row_rs_sipendekezi_ra_hod_u['id'];?>"> 
                  <?php if($row_rs_sipendekezi_ra_hod_u['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
              ...
              <?php } while ($row_rs_sipendekezi_ra_hod_u = mysqli_fetch_assoc($rs_sipendekezi_ra_hod_u));?>
            </div>
            <?php } ?>
            <!--  *******************  END YANAYOTOKA KWA HODs & HOUs **************-->
            <!--  *******************  YANAYOTOKA KWA HOS **************-->
            <?php if($totalRows_rs_sipendekezi_ra_hos != 0){
		   ...
		   echo "<div class='rekodi_tupu w3-left'></div>";   ?>
            <div class="row_form col-view-btm"> 
              ...
              <div class="row_form col-view w3-blue" title="Safari ya siku 7 ..."> 
                <div class="col-view-namba" data-tip="Nifanyw ni wrap words"> 
                  <?php if($row_rs_sipendekezi_ra_hos['masurufu_id'] == 0) { echo "D."; $sn = $sn - 1;}else{ echo $sn."."; }?>
                </div>
                <div class="col-view-kwenda"><span class="w3-left col-view-555 col-view-dot " style="margin: 8px 8px 0px 8px"></span>	
                  <?php  //Jina la Mkoa
	$regID=$row_rs_sipendekezi_ra_hos['regID'];
	...
	$totalRows_rsregName = mysqli_num_rows($rsregName);	
	//Jina la Halmashauri
	$lgaID=$row_rs_sipendekezi_ra_hos['lgaID'];
	...
	$totalRows_rslgaName = mysqli_num_rows($rslgaName);
	//Jina la kuonesha
	if ($row_rs_sipendekezi_ra_hos['lgaID']==""){
	echo "Kwenda&nbsp;".$row_rsregName['regNam'];
	}else{
	echo "Kwenda&nbsp;".$row_rslgaName['lgaNam'];
	};
	?>
                ...
                <div class="col-view-tarehe"> 
                  <?php echo "Tarehe&nbsp;".$row_rs_sipendekezi_ra_hos['sDate'];?>
                  <span class="w3-right col-view-555"> 
                  <!--a href="maombi_mapya_list_update.php?id=<php echo $row_rs_sipendekezi_ra['id'];?>&catID=<php echo $row_rs_sipendekezi_ra['catID'];?>&regID=<php echo $row_rs_sipendekezi_ra['regID'];?>&lgaID=<php echo $row_rs_sipendekezi_ra['lgaID'];?>&sDate=<php echo $row_rs_sipendekezi_ra['sDate'];?>&eDate=<php echo $row_rs_sipendekezi_ra['eDate'];?>&duration=<php echo $row_rs_sipendekezi_ra['duration'];?>&usafiriID=<php echo $row_rs_sipendekezi_ra['usafiriID'];?>&madhumuniID=<php echo $row_rs_sipendekezi_ra['madhumuniID'];?>&muhtasari=<php echo $row_rs_sipendekezi_ra['muhtasari'];?>&mlipajiID=<php echo $row_rs_sipendekezi_ra['mlipajiID'];?>&wengine=<php echo $row_rs_sipendekezi_ra['wengine'];?>&jina_kiambata=<php echo $row_rs_sipendekezi_ra['jina_kiambata'];?>&kiambata=<php echo $row_rs_sipendekezi_ra['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>
	&nbsp;<a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_sipendekezi_ra['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;-->
                  <a href="masurufu_yanayoingia_tazama.php?<?php if($row_rs_sipendekezi_ra_hos['masurufu_id'] == 0) { echo 'masurufu=ya_dereva&'; } ?>kibali_id=<?php echo $row_rs_sipendekezi_ra_hos['id'];?>"> 
                  <?php if($row_rs_sipendekezi_ra_hos['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
                  <?php };?>
                ...
                <div class="col-view-madhumuni"> 
                  <?php
	//Madhumuni
	$madhumuniID=$row_rs_sipendekezi_ra_hos['madhumuniID'];
	...
	echo $row_rsmadhumuni['madhumuni'];?>
                ...
                <div class="col-view-icons"> 
                  <!--span><a href="maombi_mapya_list_update.php?id=<php echo $row_rs_sipendekezi_ra['id'];?>&catID=<php echo $row_rs_sipendekezi_ra['catID'];?>&regID=<php echo $row_rs_sipendekezi_ra['regID'];?>&lgaID=<php echo $row_rs_sipendekezi_ra['lgaID'];?>&sDate=<php echo $row_rs_sipendekezi_ra['sDate'];?>&eDate=<php echo $row_rs_sipendekezi_ra['eDate'];?>&duration=<php echo $row_rs_sipendekezi_ra['duration'];?>&usafiriID=<php echo $row_rs_sipendekezi_ra['usafiriID'];?>&madhumuniID=<php echo $row_rs_sipendekezi_ra['madhumuniID'];?>&muhtasari=<php echo $row_rs_sipendekezi_ra['muhtasari'];?>&mlipajiID=<php echo $row_rs_sipendekezi_ra['mlipajiID'];?>&wengine=<php echo $row_rs_sipendekezi_ra['wengine'];?>&jina_kiambata=<php echo $row_rs_sipendekezi_ra['jina_kiambata'];?>&kiambata=<php echo $row_rs_sipendekezi_ra['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>&nbsp;&nbsp;</span>
	<span><a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_sipendekezi_ra['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;&nbsp;</span-->
                  <span><a href="masurufu_yanayoingia_tazama.php?<?php if($row_rs_sipendekezi_ra_hos['masurufu_id'] == 0) { echo 'masurufu=ya_dereva&'; } ?>kibali_id=<?php echo $row_rs_sipendekezi_ra_hos['id'];?>"> 
                  <?php if($row_rs_sipendekezi_ra_hos['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
              ...
              <?php } while ($row_rs_sipendekezi_ra_hos = mysqli_fetch_assoc($rs_sipendekezi_ra_hos));?>
            </div>
            <?php } ?>
            <!--  *******************  END YANAYOTOKA KWA HOS **************-->
            <!--  *******************  YANAYOTOKA KWA NU **************-->
            <?php if($totalRows_rs_sipendekezi_ra_nu != 0){ 
		   echo "<div class='rekodi_tupu w3-left'></div>";
		   ?>
            <div class="row_form col-view-btm"> 
              ...
              <div class="row_form col-view w3-blue" title="Safari ya siku 7 ..."> 
                <div class="col-view-namba" data-tip="Nifanyw ni wrap words"> 
                  <?php if($row_rs_sipendekezi_ra_nu['masurufu_id'] == 0) { echo "D."; $sn = $sn - 1;}else{ echo $sn."."; }?>
                </div>
                <div class="col-view-kwenda"><span class="w3-left col-view-555 col-view-dot " style="margin: 8px 8px 0px 8px"></span>	
                  <?php  //Jina la Mkoa
	$regID=$row_rs_sipendekezi_ra_nu['regID'];
	...
	$totalRows_rsregName = mysqli_num_rows($rsregName);	
	//Jina la Halmashauri
	$lgaID=$row_rs_sipendekezi_ra_nu['lgaID'];
	...
	$totalRows_rslgaName = mysqli_num_rows($rslgaName);
	//Jina la kuonesha
	if ($row_rs_sipendekezi_ra_nu['lgaID']==""){
	echo "Kwenda&nbsp;".$row_rsregName['regNam'];
	}else{
	echo "Kwenda&nbsp;".$row_rslgaName['lgaNam'];
	};
	?>
                ...
                <div class="col-view-tarehe"> 
                  <?php echo "Tarehe&nbsp;".$row_rs_sipendekezi_ra_nu['sDate'];?>
                  <span class="w3-right col-view-555"> 
                  <!--a href="maombi_mapya_list_update.php?id=<php echo $row_rs_sipendekezi_ra['id'];?>&catID=<php echo $row_rs_sipendekezi_ra['catID'];?>&regID=<php echo $row_rs_sipendekezi_ra['regID'];?>&lgaID=<php echo $row_rs_sipendekezi_ra['lgaID'];?>&sDate=<php echo $row_rs_sipendekezi_ra['sDate'];?>&eDate=<php echo $row_rs_sipendekezi_ra['eDate'];?>&duration=<php echo $row_rs_sipendekezi_ra['duration'];?>&usafiriID=<php echo $row_rs_sipendekezi_ra['usafiriID'];?>&madhumuniID=<php echo $row_rs_sipendekezi_ra['madhumuniID'];?>&muhtasari=<php echo $row_rs_sipendekezi_ra['muhtasari'];?>&mlipajiID=<php echo $row_rs_sipendekezi_ra['mlipajiID'];?>&wengine=<php echo $row_rs_sipendekezi_ra['wengine'];?>&jina_kiambata=<php echo $row_rs_sipendekezi_ra['jina_kiambata'];?>&kiambata=<php echo $row_rs_sipendekezi_ra['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>
	&nbsp;<a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_sipendekezi_ra['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;-->
                  <a href="masurufu_yanayoingia_tazama.php?<?php if($row_rs_sipendekezi_ra_nu['masurufu_id'] == 0) { echo 'masurufu=ya_dereva&'; } ?>kibali_id=<?php echo $row_rs_sipendekezi_ra_nu['id'];?>"> 
                  <?php if($row_rs_sipendekezi_ra_nu['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
                  <?php };?>
                ...
                <div class="col-view-madhumuni"> 
                  <?php
	//Madhumuni
	$madhumuniID=$row_rs_sipendekezi_ra_nu['madhumuniID'];
	...
	echo $row_rsmadhumuni['madhumuni'];?>
                ...
                <div class="col-view-icons"> 
                  <!--span><a href="maombi_mapya_list_update.php?id=<php echo $row_rs_sipendekezi_ra['id'];?>&catID=<php echo $row_rs_sipendekezi_ra['catID'];?>&regID=<php echo $row_rs_sipendekezi_ra['regID'];?>&lgaID=<php echo $row_rs_sipendekezi_ra['lgaID'];?>&sDate=<php echo $row_rs_sipendekezi_ra['sDate'];?>&eDate=<php echo $row_rs_sipendekezi_ra['eDate'];?>&duration=<php echo $row_rs_sipendekezi_ra['duration'];?>&usafiriID=<php echo $row_rs_sipendekezi_ra['usafiriID'];?>&madhumuniID=<php echo $row_rs_sipendekezi_ra['madhumuniID'];?>&muhtasari=<php echo $row_rs_sipendekezi_ra['muhtasari'];?>&mlipajiID=<php echo $row_rs_sipendekezi_ra['mlipajiID'];?>&wengine=<php echo $row_rs_sipendekezi_ra['wengine'];?>&jina_kiambata=<php echo $row_rs_sipendekezi_ra['jina_kiambata'];?>&kiambata=<php echo $row_rs_sipendekezi_ra['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>&nbsp;&nbsp;</span>
	<span><a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_sipendekezi_ra['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;&nbsp;</span-->
                  <span><a href="masurufu_yanayoingia_tazama.php?<?php if($row_rs_sipendekezi_ra_nu['masurufu_id'] == 0) { echo 'masurufu=ya_dereva&'; } ?>kibali_id=<?php echo $row_rs_sipendekezi_ra_nu['id'];?>"> 
                  <?php if($row_rs_sipendekezi_ra_nu['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
              ...
              <?php } while ($row_rs_sipendekezi_ra_nu = mysqli_fetch_assoc($rs_sipendekezi_ra_nu));?>
            </div>
            <?php } ?>
