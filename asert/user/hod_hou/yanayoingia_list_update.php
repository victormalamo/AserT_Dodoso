...
<?php 
if(($_GET['c_tupu']=="ipo") || ($_GET['tupu'])=="ipo"){ require('reload_tupu_update_hod_u.php'); }else{ require('reload_update_hod_u.php'); };
?>
      ...
      <div class="w3-col l10 m12" id="main"> 
        <div id="mainLeaderboard" style="overflow:hidden;"> 
          ...
          <div class="container_form"> 
            ...
            <div class="w3-small w3-opacity form_link"  style="padding:0px 0px 10px 0px;"><a href="http://localhost/user/hod_hou/yanayoingia_list.php">Yote 
              Yanayoingia</a>&nbsp;&nbsp;<span class="w3-tiny">/</span>&nbsp;&nbsp;<a href="http://localhost/user/hod_hou/yanayoingia_tazama.php?id=<?php echo $_GET['id'];?>">Tazama 
