...
$totalRows_rs_ulizokataa_safari_ripoti = ($totalRows_rs_ulizokataa_safari_ripoti_hos + $totalRows_rs_ulizokataa_safari_ripoti_nu);
    ...
    <div id="leftmenuinner" style="padding-top: 0px;"> 
      <div class="w3-light-greyQ" id="leftmenuinnerinner"> <br class="w3-hide-large">
        ...
        <div class="menu_teuzi" style="display: block;"> <a target="_top" href="http://localhost/user/hod_hou/safari_ripoti_zinazoingia_list.php" <?php if($idadi_safari_ripoti_zinazoingia_hod_u != ""){echo "class='badge1' data-badge='".$idadi_safari_ripoti_zinazoingia_hod_u."'";};?>>Zinazoingia</a> 
          <div id="sidenav-imechaguliwa_2" <?php if($idadi_safari_ripoti_ulizokataa_hod_u != ""){echo "class='badge1' data-badge='".$idadi_safari_ripoti_ulizokataa_hod_u."'";};?>>Ulizokataa</div>
      ...
      <div class="w3-col l10 m12" id="main"> 
        <div id="mainLeaderboard" style="overflow:hidden;"> 
          <div class="container_form_kichwa"> 
            <div class="kichwa_ndogo form_link"><a href="http://localhost/user/hod_hou/index.php">Mwanzo</a>&nbsp;<span class="kichwa_ndogo_sana">/</span>&nbsp;Ripoti Ulizokataa</div>
          </div>
          <div class="container_form">
            <?php if($totalRows_rs_ulizokataa_safari_ripoti == 0){
echo "<div class='rekodi_tupu w3-left'>HAKUNA RIPOTI ULIZOKATAA!</div>";
}else{?>
            <!--  *******************  YANAYOTOKA KWA NU **************-->
            <?php  if($totalRows_rs_ulizokataa_safari_ripoti_nu != 0){
		...
		?>
			...
			<div class="row_form col-view-title w3-white">Kutoka kwa Watumishi</div>
              <?php $sn=$totalRows_rs_ulizokataa_safari_ripoti_nu; do {  ?>
              <div class="row_form col-view w3-teal" title="Safari ya siku 7 ..."> 
                ...
                <div class="col-view-kwenda"><span class="w3-left col-view-555 col-view-dot " style="margin: 8px 8px 0px 8px"></span>	
                  <?php  //Jina la Mkoa
	$regID=$row_rs_ulizokataa_safari_ripoti_nu['regID'];
	...
	//Jina la Halmashauri
	$lgaID=$row_rs_ulizokataa_safari_ripoti_nu['lgaID'];
	...
	//Jina la kuonesha
	if ($row_rs_ulizokataa_safari_ripoti_nu['lgaID']==""){
	...
	?>
                ...
                <div class="col-view-tarehe"> 
                  <?php echo "Tarehe&nbsp;".$row_rs_ulizokataa_safari_ripoti_nu['sDate'];?>
                  <span class="w3-right col-view-555"> <a href="safari_ripoti_tazama.php?kibali_id=<?php echo $row_rs_ulizokataa_safari_ripoti_nu['id'];?>"><img src="/images/view.png" width="30" height="13" title="tazama"></a></span></div>
                <div class="col-view-madhumuni"> 
                  <?php
	//Madhumuni
	$madhumuniID=$row_rs_ulizokataa_safari_ripoti_nu['madhumuniID'];
	...
	echo $row_rsmadhumuni['madhumuni'];?>
                ...
                <div class="col-view-icons"> <span><a href="safari_ripoti_tazama.php?kibali_id=<?php echo $row_rs_ulizokataa_safari_ripoti_nu['id'];?>"> 
                  <?php if($row_rs_ulizokataa_safari_ripoti_nu['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
              ...
              <?php $sn--; } while ($row_rs_ulizokataa_safari_ripoti_nu = mysqli_fetch_assoc($rs_ulizokataa_safari_ripoti_nu));?>
            </div>
            <?php } ?>
