...
<div class="row_form">
<div class="col-form-75" style="font-weight: bold; padding:10px 0px 0px 0px">
Madhumuni ya Safari
</div>
</div>
<div class="row_form">
<div class="col-form-75 wrap_maandishi" style="padding: 0px 0px 16px 0px">
...
<div class="row_form">
    <div style="padding: 16px 0px 16px 0px; border-bottom: 1px solid #cccccc">
...
<?php if($row_safari_ripoti['nathibitisha_sithibitishi_hos'] != ""){?>

<div class="row_form" style="padding: 16px 0px 0px 0px;">
...
<div class="row_form">
	...
	<?php if($row_safari_ripoti['nathibitisha_sithibitishi_hos'] == "nathibitisha") {?>
	Nathibitisha kuwa ripoti ya safari aliyotoa Afisa huyu ni sahihi. 
	<?php }else{
	echo $row_safari_ripoti['sithibitishi_hos'];
	}
	?>
    </div> 
</div>
<div class="row_form">
    <div>
	Tarehe <?php echo $row_safari_ripoti['submitDate_hos'];?>
    </div> 
</div>
...
<div class="row_form">
	...
	<?php 
	if(($row_safari_ripoti['nathibitisha_sithibitishi_hod_u'] !="") && ($_GET['badilisha'] !="ndio")){ echo "&nbsp;&nbsp;[&nbsp;<a href='safari_ripoti_tazama.php?kibali_id=$kibali_id&badilisha=ndio'>BADILI</a>&nbsp;]";};?>
    </div> 
    <div class="">
    </div>
</div>

<?php if(($row_safari_ripoti['nathibitisha_sithibitishi_hod_u'] !="") && ($_GET['badilisha'] !="ndio")){?>
...
<?php if($row_safari_ripoti['nathibitisha_sithibitishi_ps'] !="") {?>

<div class="row_form">
    <div class="title_100stb mnrt-left-align">
	Maoni ya Karibu Mkuu
    </div> 
    <div class="col-form-75">
    </div>
</div>
...
<label class="radio-inline">
  <?php 
  if($row_safari_ripoti['nathibitisha_sithibitishi_hod_u'] == "nathibitisha") { $nathibitisha = "checked"; }
  if($row_safari_ripoti['nathibitisha_sithibitishi_hod_u'] == "sithibitishi") { $sithibitishi = "checked"; };?>
   ...
   <label class="radio-inline">
    ...
    <input type="text" class="form-control" id="sithibitishi_sababu" name="sithibitishi_sababu" placeholder="Sababu.." value="<?php echo $row_safari_ripoti['sithibitishi_hod_u'];?>">
    </div>
	</div>
	<div class="row_form">
    <div class="title_100stb mnrt-left-align">	
...
<input name="safari_ripoti_general_status" id="safari_ripoti_general_status" type="hidden" value="<?php echo "ameona_hod_u";?>">
