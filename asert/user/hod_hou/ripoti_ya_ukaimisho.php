...
<div class="row_form">
<div class="col-form-75" style="font-weight: bold; padding: 0px 0px 16px 0px">
Taarifa Fupi
</div>
</div>
...
<div class="row_form">
	...
	<a href="ukaimisho/<?php echo $row_rsselectedUkaimisho['aliyekaimisha_username']."/".$row_rsselectedUkaimisho['final_kiambata'] ?>" target="_blank"><?php echo "&nbsp;".$row_rsselectedUkaimisho['jina_kiambata'];?></a>
    </div>
</div>
<?php };?>
...
<!-- END VIAMBATANISHI -->
  ...
  <div class="row_form">
    ...
    <img src="http://localhost/user/hos/verificationimage.php?<?php echo rand(0,9999);?>" alt="verification image, type it in the box" width="87" height="39" align="absbottom" />    
 	</div>
 	</div>
  <div class="row_form">
    <div class="col-form-25">
