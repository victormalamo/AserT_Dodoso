...
?>
<?php 
$_SESSION['kutoka_link'] = "masurufu_uthibitisho_ca_list.php";
include('status.php');
...
$query_rs_uthibitisho_ca_min = sprintf("SELECT vibali.* FROM vibali, masurufu WHERE ((vibali.levelID = 'min' ) AND (vibali.masurufu_id = masurufu.masurufu_id) AND (masurufu.masurufu_ya_sh > 0) AND (masurufu.anadaiwa_hadaiwi_ra = 'Hadaiwi')) ORDER BY id DESC");
$rs_uthibitisho_ca_min = mysqli_query($conntscpME, $query_rs_uthibitisho_ca_min) or die(mysqli_error());
$row_rs_uthibitisho_ca_min = mysqli_fetch_assoc($rs_uthibitisho_ca_min);
$totalRows_rs_uthibitisho_ca_min = mysqli_num_rows($rs_uthibitisho_ca_min);

//KUTOKA KWA PS

$query_rs_uthibitisho_ca_ps = sprintf("SELECT vibali.* FROM vibali, masurufu WHERE ((vibali.levelID = 'ps' ) AND (vibali.masurufu_id = masurufu.masurufu_id) AND (masurufu.masurufu_ya_sh > 0) AND (masurufu.anadaiwa_hadaiwi_ra = 'Hadaiwi')) ORDER BY id DESC");
$rs_uthibitisho_ca_ps = mysqli_query($conntscpME, $query_rs_uthibitisho_ca_ps) or die(mysqli_error());
$row_rs_uthibitisho_ca_ps = mysqli_fetch_assoc($rs_uthibitisho_ca_ps);
$totalRows_rs_uthibitisho_ca_ps = mysqli_num_rows($rs_uthibitisho_ca_ps);

//KUTOKA KWA HOD_U

$query_rs_uthibitisho_ca_hod_u = sprintf("SELECT vibali.* FROM vibali, masurufu WHERE (((vibali.levelID = 'hod' ) || (vibali.levelID = 'hou' ) || (vibali.levelID = 'dahrm')) AND (vibali.masurufu_id = masurufu.masurufu_id) AND (masurufu.masurufu_ya_sh > 0) AND (masurufu.anadaiwa_hadaiwi_ra = 'Hadaiwi')) ORDER BY id DESC");
$rs_uthibitisho_ca_hod_u = mysqli_query($conntscpME, $query_rs_uthibitisho_ca_hod_u) or die(mysqli_error());
$row_rs_uthibitisho_ca_hod_u = mysqli_fetch_assoc($rs_uthibitisho_ca_hod_u);
$totalRows_rs_uthibitisho_ca_hod_u = mysqli_num_rows($rs_uthibitisho_ca_hod_u);

//KUTOKA KWA HOS

$query_rs_uthibitisho_ca_hos = sprintf("SELECT vibali.* FROM vibali, masurufu WHERE ((vibali.levelID = 'hos' ) AND (vibali.masurufu_id = masurufu.masurufu_id) AND (masurufu.masurufu_ya_sh > 0) AND (masurufu.anadaiwa_hadaiwi_ra = 'Hadaiwi')) ORDER BY id DESC");
$rs_uthibitisho_ca_hos = mysqli_query($conntscpME, $query_rs_uthibitisho_ca_hos) or die(mysqli_error());
$row_rs_uthibitisho_ca_hos = mysqli_fetch_assoc($rs_uthibitisho_ca_hos);
$totalRows_rs_uthibitisho_ca_hos = mysqli_num_rows($rs_uthibitisho_ca_hos);
*/


//YA NU KUTOKA KWA CA

$query_rs_uthibitisho_ca_nu = sprintf("SELECT vibali.*, masurufu.* FROM vibali, masurufu WHERE ((vibali.mlipajiID = '%s' ) AND (vibali.levelID = 'nu' ) AND ((vibali.masurufu_id = masurufu.masurufu_id) || (vibali.driver_masurufu_id = masurufu.driver_masurufu_id)) AND (masurufu.masurufu_ya_sh > 0) AND (masurufu.masurufu_general_status = 'ameona_tae')) ORDER BY vibali.id DESC, masurufu.masurufu_id DESC", $div_unit_ID);
$rs_uthibitisho_ca_nu = mysqli_query($conntscpME, $query_rs_uthibitisho_ca_nu) or die(mysqli_error());
$row_rs_uthibitisho_ca_nu = mysqli_fetch_assoc($rs_uthibitisho_ca_nu);
$totalRows_rs_uthibitisho_ca_nu = mysqli_num_rows($rs_uthibitisho_ca_nu);

//YA HOS KUTOKA KWA CA

$query_rs_uthibitisho_ca_hos = sprintf("SELECT vibali.*, masurufu.* FROM vibali, masurufu WHERE ((vibali.mlipajiID = '%s' ) AND (vibali.levelID = 'hos' ) AND ((vibali.masurufu_id = masurufu.masurufu_id) || (vibali.driver_masurufu_id = masurufu.driver_masurufu_id)) AND (masurufu.masurufu_ya_sh > 0) AND (masurufu.masurufu_general_status = 'ameona_tae')) ORDER BY vibali.id DESC, masurufu.masurufu_id DESC", $div_unit_ID);
$rs_uthibitisho_ca_hos = mysqli_query($conntscpME, $query_rs_uthibitisho_ca_hos) or die(mysqli_error());
$row_rs_uthibitisho_ca_hos = mysqli_fetch_assoc($rs_uthibitisho_ca_hos);
$totalRows_rs_uthibitisho_ca_hos = mysqli_num_rows($rs_uthibitisho_ca_hos);

//YA HOD_U KUTOKA KWA CA

$query_rs_uthibitisho_ca_hod_u = sprintf("SELECT vibali.*, masurufu.* FROM vibali, masurufu WHERE ((vibali.mlipajiID = '%s' ) AND ((vibali.levelID = 'hod' ) || (vibali.levelID = 'hou' )) AND ((vibali.masurufu_id = masurufu.masurufu_id) || (vibali.driver_masurufu_id = masurufu.driver_masurufu_id)) AND (masurufu.masurufu_ya_sh > 0) AND (masurufu.masurufu_general_status = 'ameona_tae')) ORDER BY vibali.id DESC, masurufu.masurufu_id DESC", $div_unit_ID);
$rs_uthibitisho_ca_hod_u = mysqli_query($conntscpME, $query_rs_uthibitisho_ca_hod_u) or die(mysqli_error());
$row_rs_uthibitisho_ca_hod_u = mysqli_fetch_assoc($rs_uthibitisho_ca_hod_u);
$totalRows_rs_uthibitisho_ca_hod_u = mysqli_num_rows($rs_uthibitisho_ca_hod_u);

$totalRows_rs_uthibitisho_ca = ($totalRows_rs_uthibitisho_ca_nu + $totalRows_rs_uthibitisho_ca_hos + $totalRows_rs_uthibitisho_ca_hod_u);
    ...
    <div id="leftmenuinner" style="padding-top: 0px;"> 
      <div class="w3-light-greyQ" id="leftmenuinnerinner"> <br class="w3-hide-large">
        ...
        <div class="menu_teuzi" style="display: block;"> <a target="_top" href="http://localhost/user/hod_hou/masurufu_yanayoingia_ra_list.php" <?php if($idadi_masurufu_yanayoingia_ra != ""){echo "class='badge1' data-badge='".$idadi_masurufu_yanayoingia_ra."'";};?>>Maombi 
          ...
          <div id="sidenav-imechaguliwa_2" <?php if($idadi_masurufu_uthibitisho_ca != ""){echo "class='badge1' data-badge='".$idadi_masurufu_uthibitisho_ca."'";};?>>Uthibitisho 
            - CA</div>
          <a target="_top" href="http://localhost/user/hod_hou/masurufu_uthibitisho_5m_list.php" <?php if($idadi_masurufu_uthibitisho_5m != ""){echo "class='badge1' data-badge='".$idadi_masurufu_uthibitisho_5m."'";};?>>Kibali 
          cha KM</a> </div>
        ...
        <div id="mainLeaderboard" style="overflow:hidden;"> 
          <div class="container_form_kichwa"> 
            <div class="kichwa_ndogo form_link"><a href="http://localhost/user/hod_hou/index.php">Mwanzo</a>&nbsp;<span class="kichwa_ndogo_sana">/</span>&nbsp;Masurufu 
              Yaliyothibitishwa</div>
          </div>
          <div class="container_form"> 
            <?php if($totalRows_rs_uthibitisho_ca == 0){
echo "<div class='rekodi_tupu w3-left'>HAKUNA MAOMBI YALIYOTHIBITISHWA NA CA!</div>";
}else{?>
            <!--  *******************  YANAYOTOKA KWA HOD_U /DAHRM**************-->
            <?php if($totalRows_rs_uthibitisho_ca_hod_u != 0){
            ...
            <div class="row_form col-view-btm"> 
              ...
              <div class="row_form col-view w3-blue" title="Safari ya siku 7 ..."> 
                <div class="col-view-namba" data-tip="Nifanyw ni wrap words"> 
                  <?php if($row_rs_uthibitisho_ca_hod_u['masurufu_id'] == 0) { echo "D."; $sn = $sn - 1;}else{ echo $sn."."; }?>
                </div>
                <div class="col-view-kwenda"><span class="w3-left col-view-555 col-view-dot " style="margin: 8px 8px 0px 8px"></span>	
                  <?php  //Jina la Mkoa
	$regID=$row_rs_uthibitisho_ca_hod_u['regID'];
	...
	//Jina la Halmashauri
	$lgaID=$row_rs_uthibitisho_ca_hod_u['lgaID'];
	...
	//Jina la kuonesha
	if ($row_rs_uthibitisho_ca_hod_u['lgaID']==""){
	...
	?>
                ...
                <div class="col-view-tarehe"> 
                  <?php echo "Tarehe&nbsp;".$row_rs_uthibitisho_ca_hod_u['sDate'];?>
                  <span class="w3-right col-view-555"> 
                  <!--a href="maombi_mapya_list_update.php?id=<php echo $row_rs_uthibitisho_ca['id'];?>&catID=<php echo $row_rs_uthibitisho_ca['catID'];?>&regID=<php echo $row_rs_uthibitisho_ca['regID'];?>&lgaID=<php echo $row_rs_uthibitisho_ca['lgaID'];?>&sDate=<php echo $row_rs_uthibitisho_ca['sDate'];?>&eDate=<php echo $row_rs_uthibitisho_ca['eDate'];?>&duration=<php echo $row_rs_uthibitisho_ca['duration'];?>&usafiriID=<php echo $row_rs_uthibitisho_ca['usafiriID'];?>&madhumuniID=<php echo $row_rs_uthibitisho_ca['madhumuniID'];?>&muhtasari=<php echo $row_rs_uthibitisho_ca['muhtasari'];?>&mlipajiID=<php echo $row_rs_uthibitisho_ca['mlipajiID'];?>&wengine=<php echo $row_rs_uthibitisho_ca['wengine'];?>&jina_kiambata=<php echo $row_rs_uthibitisho_ca['jina_kiambata'];?>&kiambata=<php echo $row_rs_uthibitisho_ca['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>
	&nbsp;<a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_uthibitisho_ca['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;-->
                  <a href="masurufu_yanayoingia_tazama.php?<?php if($row_rs_uthibitisho_ca_hod_u['masurufu_id'] == 0) { echo 'masurufu=ya_dereva&'; } ?>kibali_id=<?php echo $row_rs_uthibitisho_ca_hod_u['id'];?>"> 
                  <?php if($row_rs_uthibitisho_ca_hod_u['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                ...
                <div class="col-view-madhumuni"> 
                  <?php
	//Madhumuni
	$madhumuniID=$row_rs_uthibitisho_ca_hod_u['madhumuniID'];
	...
	echo $row_rsmadhumuni['madhumuni'];?>
                ...
                <div class="col-view-icons"> 
                  <!--span><a href="maombi_mapya_list_update.php?id=<php echo $row_rs_uthibitisho_ca['id'];?>&catID=<php echo $row_rs_uthibitisho_ca['catID'];?>&regID=<php echo $row_rs_uthibitisho_ca['regID'];?>&lgaID=<php echo $row_rs_uthibitisho_ca['lgaID'];?>&sDate=<php echo $row_rs_uthibitisho_ca['sDate'];?>&eDate=<php echo $row_rs_uthibitisho_ca['eDate'];?>&duration=<php echo $row_rs_uthibitisho_ca['duration'];?>&usafiriID=<php echo $row_rs_uthibitisho_ca['usafiriID'];?>&madhumuniID=<php echo $row_rs_uthibitisho_ca['madhumuniID'];?>&muhtasari=<php echo $row_rs_uthibitisho_ca['muhtasari'];?>&mlipajiID=<php echo $row_rs_uthibitisho_ca['mlipajiID'];?>&wengine=<php echo $row_rs_uthibitisho_ca['wengine'];?>&jina_kiambata=<php echo $row_rs_uthibitisho_ca['jina_kiambata'];?>&kiambata=<php echo $row_rs_uthibitisho_ca['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>&nbsp;&nbsp;</span>
	<span><a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_uthibitisho_ca['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;&nbsp;</span-->
                  <span><a href="masurufu_yanayoingia_tazama.php?<?php if($row_rs_uthibitisho_ca_hod_u['masurufu_id'] == 0) { echo 'masurufu=ya_dereva&'; } ?>kibali_id=<?php echo $row_rs_uthibitisho_ca_hod_u['id'];?>"> 
                  <?php if($row_rs_uthibitisho_ca_hod_u['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
              ...
              <?php } while ($row_rs_uthibitisho_ca_hod_u = mysqli_fetch_assoc($rs_uthibitisho_ca_hod_u));?>
            </div>
            <?php } ?>
            <!--  *******************  END YANAYOTOKA KWA HODs & HOUs **************-->
            <!--  *******************  YANAYOTOKA KWA HOS **************-->
            <?php if($totalRows_rs_uthibitisho_ca_hos != 0){
		   ...
		   echo "<div class='rekodi_tupu w3-left'></div>";   ?>
            <div class="row_form col-view-btm"> 
              ...
              <div class="row_form col-view w3-blue" title="Safari ya siku 7 ..."> 
                <div class="col-view-namba" data-tip="Nifanyw ni wrap words"> 
                  <?php if($row_rs_uthibitisho_ca_hos['masurufu_id'] == 0) { echo "D."; $sn = $sn - 1;}else{ echo $sn."."; }?>
                </div>
                <div class="col-view-kwenda"><span class="w3-left col-view-555 col-view-dot " style="margin: 8px 8px 0px 8px"></span>	
                  <?php  //Jina la Mkoa
	$regID=$row_rs_uthibitisho_ca_hos['regID'];
	...
	$totalRows_rsregName = mysqli_num_rows($rsregName);	
	//Jina la Halmashauri
	$lgaID=$row_rs_uthibitisho_ca_hos['lgaID'];
	...
	$totalRows_rslgaName = mysqli_num_rows($rslgaName);
	//Jina la kuonesha
	if ($row_rs_uthibitisho_ca_hos['lgaID']==""){
	echo "Kwenda&nbsp;".$row_rsregName['regNam'];
	}else{
	echo "Kwenda&nbsp;".$row_rslgaName['lgaNam'];
	};
	?>
                ...
                <div class="col-view-tarehe"> 
                  <?php echo "Tarehe&nbsp;".$row_rs_uthibitisho_ca_hos['sDate'];?>
                  <span class="w3-right col-view-555"> 
                  <!--a href="maombi_mapya_list_update.php?id=<php echo $row_rs_uthibitisho_ca['id'];?>&catID=<php echo $row_rs_uthibitisho_ca['catID'];?>&regID=<php echo $row_rs_uthibitisho_ca['regID'];?>&lgaID=<php echo $row_rs_uthibitisho_ca['lgaID'];?>&sDate=<php echo $row_rs_uthibitisho_ca['sDate'];?>&eDate=<php echo $row_rs_uthibitisho_ca['eDate'];?>&duration=<php echo $row_rs_uthibitisho_ca['duration'];?>&usafiriID=<php echo $row_rs_uthibitisho_ca['usafiriID'];?>&madhumuniID=<php echo $row_rs_uthibitisho_ca['madhumuniID'];?>&muhtasari=<php echo $row_rs_uthibitisho_ca['muhtasari'];?>&mlipajiID=<php echo $row_rs_uthibitisho_ca['mlipajiID'];?>&wengine=<php echo $row_rs_uthibitisho_ca['wengine'];?>&jina_kiambata=<php echo $row_rs_uthibitisho_ca['jina_kiambata'];?>&kiambata=<php echo $row_rs_uthibitisho_ca['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>
	&nbsp;<a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_uthibitisho_ca['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;-->
                  <a href="masurufu_yanayoingia_tazama.php?<?php if($row_rs_uthibitisho_ca_hos['masurufu_id'] == 0) { echo 'masurufu=ya_dereva&'; } ?>kibali_id=<?php echo $row_rs_uthibitisho_ca_hos['id'];?>"> 
                  <?php if($row_rs_uthibitisho_ca_hos['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
                  <?php };?>
                ...
                <div class="col-view-madhumuni"> 
                  <?php
	//Madhumuni
	$madhumuniID=$row_rs_uthibitisho_ca_hos['madhumuniID'];
	...
	echo $row_rsmadhumuni['madhumuni'];?>
                ...
                <div class="col-view-icons"> 
                  <!--span><a href="maombi_mapya_list_update.php?id=<php echo $row_rs_uthibitisho_ca['id'];?>&catID=<php echo $row_rs_uthibitisho_ca['catID'];?>&regID=<php echo $row_rs_uthibitisho_ca['regID'];?>&lgaID=<php echo $row_rs_uthibitisho_ca['lgaID'];?>&sDate=<php echo $row_rs_uthibitisho_ca['sDate'];?>&eDate=<php echo $row_rs_uthibitisho_ca['eDate'];?>&duration=<php echo $row_rs_uthibitisho_ca['duration'];?>&usafiriID=<php echo $row_rs_uthibitisho_ca['usafiriID'];?>&madhumuniID=<php echo $row_rs_uthibitisho_ca['madhumuniID'];?>&muhtasari=<php echo $row_rs_uthibitisho_ca['muhtasari'];?>&mlipajiID=<php echo $row_rs_uthibitisho_ca['mlipajiID'];?>&wengine=<php echo $row_rs_uthibitisho_ca['wengine'];?>&jina_kiambata=<php echo $row_rs_uthibitisho_ca['jina_kiambata'];?>&kiambata=<php echo $row_rs_uthibitisho_ca['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>&nbsp;&nbsp;</span>
	<span><a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_uthibitisho_ca['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;&nbsp;</span-->
                  <span><a href="masurufu_yanayoingia_tazama.php?<?php if($row_rs_uthibitisho_ca_hos['masurufu_id'] == 0) { echo 'masurufu=ya_dereva&'; } ?>kibali_id=<?php echo $row_rs_uthibitisho_ca_hos['id'];?>"> 
                  <?php if($row_rs_uthibitisho_ca_hos['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
              ...
              <?php } while ($row_rs_uthibitisho_ca_hos = mysqli_fetch_assoc($rs_uthibitisho_ca_hos));?>
            </div>
            <?php } ?>
            <!--  *******************  END YANAYOTOKA KWA HOS **************-->
            <!--  *******************  YANAYOTOKA KWA NU **************-->
            <?php if($totalRows_rs_uthibitisho_ca_nu != 0){ 
		   echo "<div class='rekodi_tupu w3-left'></div>";
		   ?>
            <div class="row_form col-view-btm"> 
              ...
              <div class="row_form col-view w3-blue" title="Safari ya siku 7 ..."> 
                <div class="col-view-namba" data-tip="Nifanyw ni wrap words"> 
                  <?php if($row_rs_uthibitisho_ca_nu['masurufu_id'] == 0) { echo "D."; $sn = $sn - 1;}else{ echo $sn."."; }?>
                </div>
                <div class="col-view-kwenda"><span class="w3-left col-view-555 col-view-dot " style="margin: 8px 8px 0px 8px"></span>	
                  <?php  //Jina la Mkoa
	$regID=$row_rs_uthibitisho_ca_nu['regID'];
	...
	$totalRows_rsregName = mysqli_num_rows($rsregName);	
	//Jina la Halmashauri
	$lgaID=$row_rs_uthibitisho_ca_nu['lgaID'];
	...
	$totalRows_rslgaName = mysqli_num_rows($rslgaName);
	//Jina la kuonesha
	if ($row_rs_uthibitisho_ca_nu['lgaID']==""){
	echo "Kwenda&nbsp;".$row_rsregName['regNam'];
	}else{
	echo "Kwenda&nbsp;".$row_rslgaName['lgaNam'];
	};
	?>
                ...
                <div class="col-view-tarehe"> 
                  <?php echo "Tarehe&nbsp;".$row_rs_uthibitisho_ca_nu['sDate'];?>
                  <span class="w3-right col-view-555"> 
                  <!--a href="maombi_mapya_list_update.php?id=<php echo $row_rs_uthibitisho_ca['id'];?>&catID=<php echo $row_rs_uthibitisho_ca['catID'];?>&regID=<php echo $row_rs_uthibitisho_ca['regID'];?>&lgaID=<php echo $row_rs_uthibitisho_ca['lgaID'];?>&sDate=<php echo $row_rs_uthibitisho_ca['sDate'];?>&eDate=<php echo $row_rs_uthibitisho_ca['eDate'];?>&duration=<php echo $row_rs_uthibitisho_ca['duration'];?>&usafiriID=<php echo $row_rs_uthibitisho_ca['usafiriID'];?>&madhumuniID=<php echo $row_rs_uthibitisho_ca['madhumuniID'];?>&muhtasari=<php echo $row_rs_uthibitisho_ca['muhtasari'];?>&mlipajiID=<php echo $row_rs_uthibitisho_ca['mlipajiID'];?>&wengine=<php echo $row_rs_uthibitisho_ca['wengine'];?>&jina_kiambata=<php echo $row_rs_uthibitisho_ca['jina_kiambata'];?>&kiambata=<php echo $row_rs_uthibitisho_ca['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>
	&nbsp;<a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_uthibitisho_ca['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;-->
                  <a href="masurufu_yanayoingia_tazama.php?<?php if($row_rs_uthibitisho_ca_nu['masurufu_id'] == 0) { echo 'masurufu=ya_dereva&'; } ?>kibali_id=<?php echo $row_rs_uthibitisho_ca_nu['id'];?>"> 
                  <?php if($row_rs_uthibitisho_ca_nu['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
                  <?php };?>
                ...
                <div class="col-view-madhumuni"> 
                  <?php
	//Madhumuni
	$madhumuniID=$row_rs_uthibitisho_ca_nu['madhumuniID'];
	...
	echo $row_rsmadhumuni['madhumuni'];?>
                ...
                <div class="col-view-icons"> 
                  <!--span><a href="maombi_mapya_list_update.php?id=<php echo $row_rs_uthibitisho_ca['id'];?>&catID=<php echo $row_rs_uthibitisho_ca['catID'];?>&regID=<php echo $row_rs_uthibitisho_ca['regID'];?>&lgaID=<php echo $row_rs_uthibitisho_ca['lgaID'];?>&sDate=<php echo $row_rs_uthibitisho_ca['sDate'];?>&eDate=<php echo $row_rs_uthibitisho_ca['eDate'];?>&duration=<php echo $row_rs_uthibitisho_ca['duration'];?>&usafiriID=<php echo $row_rs_uthibitisho_ca['usafiriID'];?>&madhumuniID=<php echo $row_rs_uthibitisho_ca['madhumuniID'];?>&muhtasari=<php echo $row_rs_uthibitisho_ca['muhtasari'];?>&mlipajiID=<php echo $row_rs_uthibitisho_ca['mlipajiID'];?>&wengine=<php echo $row_rs_uthibitisho_ca['wengine'];?>&jina_kiambata=<php echo $row_rs_uthibitisho_ca['jina_kiambata'];?>&kiambata=<php echo $row_rs_uthibitisho_ca['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>&nbsp;&nbsp;</span>
	<span><a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_uthibitisho_ca['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;&nbsp;</span-->
                  <span><a href="masurufu_yanayoingia_tazama.php?<?php if($row_rs_uthibitisho_ca_nu['masurufu_id'] == 0) { echo 'masurufu=ya_dereva&'; } ?>kibali_id=<?php echo $row_rs_uthibitisho_ca_nu['id'];?>"> 
                  <?php if($row_rs_uthibitisho_ca_nu['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
              ...
              <?php } while ($row_rs_uthibitisho_ca_nu = mysqli_fetch_assoc($rs_uthibitisho_ca_nu));?>
            </div>
            <?php } ?>
