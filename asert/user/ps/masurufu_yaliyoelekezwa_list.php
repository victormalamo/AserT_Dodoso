...
?>
<?php 
$_SESSION['kutoka_link'] = "masurufu_yaliyoelekezwa_list.php";
include('status.php');
...
$totalRows_rs_maelekezo_5m_ps = $totalRows_rs_maelekezo_5m_ps_hod_u;
    ...
    <div id="leftmenuinner" style="padding-top: 0px;"> 
      <div class="w3-light-greyQ" id="leftmenuinnerinner"> <br class="w3-hide-large">
        ...
        <div class="menu_teuzi" style="display: block;"> <a target="_top" href="http://localhost/user/ps/masurufu_yanayoingia_list.php" <?php if($idadi_masurufu_yanayoingia_ps != ""){echo "class='badge1' data-badge='".$idadi_masurufu_yanayoingia_ps."'";};?>>Yanayoingia</a> 
          ...
          <div id="sidenav-imechaguliwa_2" <?php if($idadi_masurufu_maelekezo_ps != ""){echo "class='badge1' data-badge='".$idadi_masurufu_maelekezo_ps."'";};?>>Uliyoelekeza</div>
        </div>
      ...
      <div class="w3-col l10 m12" id="main"> 
        <div id="mainLeaderboard" style="overflow:hidden;"> 
          <div class="container_form_kichwa"> 
            <div class="kichwa_ndogo form_link"><a href="http://localhost/user/ps/index.php">Mwanzo</a>&nbsp;<span class="kichwa_ndogo_sana">/</span>&nbsp;Masurufu Yaliyoelekezwa</div>
          </div>
          <div class="container_form">
            <?php if($totalRows_rs_maelekezo_5m_ps == 0){
echo "<div class='rekodi_tupu w3-left'>HAKUNA MAOMBI ULIYOELEKEZA!</div>";
}else{?>
            <!--  *******************  YANAYOTOKA KWA HOD_U /DAHRM**************-->
            <?php if($totalRows_rs_maelekezo_5m_ps_hod_u != 0){
		   
		   echo "<div class='rekodi_tupu w3-left'></div>";
		    ?>
            <div class="row_form col-view-btm">
			<div class="row_form col-view-title w3-white">Masurufu Yaliyoelekezwa</div>
              <?php $sn=0; do {  $sn++; ?>
              <div class="row_form col-view w3-blue" title="Safari ya siku 7 ..."> 
                ...
                <div class="col-view-kwenda"><span class="w3-left col-view-555 col-view-dot " style="margin: 8px 8px 0px 8px"></span>	
                  <?php  //Jina la Mkoa
	$regID=$row_rs_maelekezo_5m_ps_hod_u['regID'];
	...
	//Jina la Halmashauri
	$lgaID=$row_rs_maelekezo_5m_ps_hod_u['lgaID'];
	...
	//Jina la kuonesha
	if ($row_rs_maelekezo_5m_ps_hod_u['lgaID']==""){
	...
	?>
                ...
                <div class="col-view-tarehe"> 
                  <?php echo "Tarehe&nbsp;".$row_rs_maelekezo_5m_ps_hod_u['sDate'];?>
                  <span class="w3-right col-view-555"> 
                  <!--a href="maombi_mapya_list_update.php?id=<php echo $row_rs_maelekezo_5m_ps['id'];?>&catID=<php echo $row_rs_maelekezo_5m_ps['catID'];?>&regID=<php echo $row_rs_maelekezo_5m_ps['regID'];?>&lgaID=<php echo $row_rs_maelekezo_5m_ps['lgaID'];?>&sDate=<php echo $row_rs_maelekezo_5m_ps['sDate'];?>&eDate=<php echo $row_rs_maelekezo_5m_ps['eDate'];?>&duration=<php echo $row_rs_maelekezo_5m_ps['duration'];?>&usafiriID=<php echo $row_rs_maelekezo_5m_ps['usafiriID'];?>&madhumuniID=<php echo $row_rs_maelekezo_5m_ps['madhumuniID'];?>&muhtasari=<php echo $row_rs_maelekezo_5m_ps['muhtasari'];?>&mlipajiID=<php echo $row_rs_maelekezo_5m_ps['mlipajiID'];?>&wengine=<php echo $row_rs_maelekezo_5m_ps['wengine'];?>&jina_kiambata=<php echo $row_rs_maelekezo_5m_ps['jina_kiambata'];?>&kiambata=<php echo $row_rs_maelekezo_5m_ps['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>
	&nbsp;<a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_maelekezo_5m_ps['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;-->
                  <a href="masurufu_yanayoingia_tazama.php?kibali_id=<?php echo $row_rs_maelekezo_5m_ps_hod_u['id'];?>"> 
                  <?php if($row_rs_maelekezo_5m_ps_hod_u['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                ...
                <div class="col-view-madhumuni"> 
                  <?php
	//Madhumuni
	$madhumuniID=$row_rs_maelekezo_5m_ps_hod_u['madhumuniID'];
	...
	<span><a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_maelekezo_5m_ps['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;&nbsp;</span-->
                  <span><a href="masurufu_yanayoingia_tazama.php?kibali_id=<?php echo $row_rs_maelekezo_5m_ps_hod_u['id'];?>"> 
                  <?php if($row_rs_maelekezo_5m_ps_hod_u['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
              ...
              <?php } while ($row_rs_maelekezo_5m_ps_hod_u = mysqli_fetch_assoc($rs_maelekezo_5m_ps_hod_u));?>
            </div>
            <?php } ?>
