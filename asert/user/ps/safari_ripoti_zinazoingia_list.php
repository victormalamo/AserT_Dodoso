...
$_SESSION['kutoka_link'] = "safari_ripoti_zinazoingia_list.php";
...
$query_rs_yaliyotolewa_safari_ripoti_hod_u = sprintf("SELECT vibali.*, safari_ripoti.* FROM vibali, safari_ripoti WHERE (((vibali.levelID = 'dahrm') || (vibali.levelID = 'hod') || (vibali.levelID = 'hou')) AND (vibali.id = safari_ripoti.safari_ripoti_id) AND (safari_ripoti.safari_ripoti_general_status = 'mpya')) ORDER BY id DESC");
$rs_yaliyotolewa_safari_ripoti_hod_u = mysqli_query($conntscpME, $query_rs_yaliyotolewa_safari_ripoti_hod_u) or die(mysqli_error());
$row_rs_yaliyotolewa_safari_ripoti_hod_u = mysqli_fetch_assoc($rs_yaliyotolewa_safari_ripoti_hod_u);
$totalRows_rs_yaliyotolewa_safari_ripoti_hod_u = mysqli_num_rows($rs_yaliyotolewa_safari_ripoti_hod_u);

//Kutoka kwa HOS Kupitia kwa HOD

$query_rs_yaliyotolewa_safari_ripoti_hos = sprintf("SELECT vibali.*, safari_ripoti.* FROM vibali, safari_ripoti WHERE ((vibali.levelID = 'hos') AND (vibali.id = safari_ripoti.safari_ripoti_id) AND (safari_ripoti.safari_ripoti_general_status = 'ameona_hod_u') AND (safari_ripoti.nathibitisha_sithibitishi_hod_u = 'nathibitisha')  AND (safari_ripoti.nathibitisha_sithibitishi_ps IS NULL)) ORDER BY id DESC");
$rs_yaliyotolewa_safari_ripoti_hos = mysqli_query($conntscpME, $query_rs_yaliyotolewa_safari_ripoti_hos) or die(mysqli_error());
$row_rs_yaliyotolewa_safari_ripoti_hos = mysqli_fetch_assoc($rs_yaliyotolewa_safari_ripoti_hos);
$totalRows_rs_yaliyotolewa_safari_ripoti_hos = mysqli_num_rows($rs_yaliyotolewa_safari_ripoti_hos);

$totalRows_rs_yaliyotolewa_safari_ripoti = ($totalRows_rs_yaliyotolewa_safari_ripoti_hos + $totalRows_rs_yaliyotolewa_safari_ripoti_hod_u);
    ...
    <div id="leftmenuinner" style="padding-top: 0px;"> 
      <div class="w3-light-greyQ" id="leftmenuinnerinner"> <br class="w3-hide-large">
        ...
        <div class="menu_teuzi" style="display: block;"> 
          <div id="sidenav-imechaguliwa_2" <?php if($idadi_safari_ripoti_zinazoingia_ps != ""){echo "class='badge1' data-badge='".$idadi_safari_ripoti_zinazoingia_ps."'";};?>>Zinazoingia</div>
      ...
      <div class="w3-col l10 m12" id="main"> 
        <div id="mainLeaderboard" style="overflow:hidden;"> 
          <div class="container_form_kichwa"> 
            <div class="kichwa_ndogo form_link"><a href="http://localhost/user/ps/index.php">Mwanzo</a>&nbsp;<span class="kichwa_ndogo_sana">/</span>&nbsp;Ripoti Zinazoingia</div>
          </div>
          <div class="container_form">
            <?php if($totalRows_rs_yaliyotolewa_safari_ripoti == 0){
echo "<div class='rekodi_tupu w3-left'>HAKUNA RIPOTI ZILIZOTUMWA!</div>";
}else{?>
            <!--  *******************  YANAYOTOKA KWA HOS **************-->
            <?php  if($totalRows_rs_yaliyotolewa_safari_ripoti_hos != 0){
		...
		?>
			...
			<div class="row_form col-view-title w3-white">Wakuu wa Section</div> 
              <?php $sn=$totalRows_rs_yaliyotolewa_safari_ripoti_hos; do {  ?>
              <div class="row_form col-view w3-blue" title="Safari ya siku 7 ..."> 
                ...
                <div class="col-view-kwenda"><span class="w3-left col-view-555 col-view-dot " style="margin: 8px 8px 0px 8px"></span>	
                  <?php  //Jina la Mkoa
	$regID=$row_rs_yaliyotolewa_safari_ripoti_hos['regID'];
	...
	//Jina la Halmashauri
	$lgaID=$row_rs_yaliyotolewa_safari_ripoti_hos['lgaID'];
	...
	//Jina la kuonesha
	if ($row_rs_yaliyotolewa_safari_ripoti_hos['lgaID']==""){
	...
	?>
                ...
                <div class="col-view-tarehe"> 
                  <?php echo "Tarehe&nbsp;".$row_rs_yaliyotolewa_safari_ripoti_hos['sDate'];?>
                  <span class="w3-right col-view-555"> <a href="safari_ripoti_tazama.php?kibali_id=<?php echo $row_rs_yaliyotolewa_safari_ripoti_hos['id'];?>"><img src="/images/view.png" width="30" height="13" title="tazama"></a></span></div>
                <div class="col-view-madhumuni"> 
                  <?php
	//Madhumuni
	$madhumuniID=$row_rs_yaliyotolewa_safari_ripoti_hos['madhumuniID'];
	...
	echo $row_rsmadhumuni['madhumuni'];?>
                ...
                <div class="col-view-icons"> <span><a href="safari_ripoti_tazama.php?kibali_id=<?php echo $row_rs_yaliyotolewa_safari_ripoti_hos['id'];?>"> 
                  <?php if($row_rs_yaliyotolewa_safari_ripoti_hos['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
              ...
              <?php $sn--; } while ($row_rs_yaliyotolewa_safari_ripoti_hos = mysqli_fetch_assoc($rs_yaliyotolewa_safari_ripoti_hos));?>
            </div>
            <?php } ?>
            <!--  *******************  END YANAYOTOKA KWA HOS **************-->
            <!--  *******************  YANAYOTOKA KWA HOD_U **************-->
            <?php if($totalRows_rs_yaliyotolewa_safari_ripoti_hod_u != 0){ 
		   echo "<div class='rekodi_tupu w3-left'></div>";
		   ?>
            <div class="row_form col-view-btm">
			<div class="row_form col-view-title w3-white">Wakuu wa Idara/Vitengo</div> 
              <?php $sn=$totalRows_rs_yaliyotolewa_safari_ripoti_hod_u; do {  ?>
              <div class="row_form col-view w3-blue" title="Safari ya siku 7 ..."> 
                <div class="col-view-namba" data-tip="Nifanyw ni wrap words"> 
                  <?php echo $sn.".";?>
                </div>
                <div class="col-view-kwenda"><span class="w3-left col-view-555 col-view-dot " style="margin: 8px 8px 0px 8px"></span>	
                  <?php  //Jina la Mkoa
	$regID=$row_rs_yaliyotolewa_safari_ripoti_hod_u['regID'];
	...
	$totalRows_rsregName = mysqli_num_rows($rsregName);	
	//Jina la Halmashauri
	$lgaID=$row_rs_yaliyotolewa_safari_ripoti_hod_u['lgaID'];
	...
	$totalRows_rslgaName = mysqli_num_rows($rslgaName);
	//Jina la kuonesha
	if ($row_rs_yaliyotolewa_safari_ripoti_hod_u['lgaID']==""){
	echo "Kwenda&nbsp;".$row_rsregName['regNam'];
	}else{
	echo "Kwenda&nbsp;".$row_rslgaName['lgaNam'];
	};
	?>
                ...
                <div class="col-view-tarehe"> 
                  <?php echo "Tarehe&nbsp;".$row_rs_yaliyotolewa_safari_ripoti_hod_u['sDate'];?>
                  <span class="w3-right col-view-555"> <a href="safari_ripoti_tazama.php?kibali_id=<?php echo $row_rs_yaliyotolewa_safari_ripoti_hod_u['id'];?>"><img src="/images/view.png" width="30" height="13" title="tazama"></a></span></div>
                <div class="col-view-madhumuni"> 
                  <?php
	//Madhumuni
	$madhumuniID=$row_rs_yaliyotolewa_safari_ripoti_hod_u['madhumuniID'];
	...
	echo $row_rsmadhumuni['madhumuni'];?>
                ...
                <div class="col-view-icons"> <span><a href="safari_ripoti_tazama.php?kibali_id=<?php echo $row_rs_yaliyotolewa_safari_ripoti_hod_u['id'];?>"> 
                  <?php if($row_rs_yaliyotolewa_safari_ripoti_hod_u['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
                  <?php };?>
              ...
              <?php $sn--; } while ($row_rs_yaliyotolewa_safari_ripoti_hod_u = mysqli_fetch_assoc($rs_yaliyotolewa_safari_ripoti_hod_u));?>
            </div>
            <?php } ?>
