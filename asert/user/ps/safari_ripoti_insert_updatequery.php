...
$nathibitisha_sithibitishi_ps = $_POST['nathibitisha_sithibitishi'];
$sithibitishi_ps = $_POST['sithibitishi_sababu'];
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "masurufu_maombi_mapya_update")) {
	   ...
	   $updateSQL = sprintf("UPDATE safari_ripoti SET nathibitisha_sithibitishi_ps=%s, sithibitishi_ps=%s, safari_ripoti_general_status=%s, submitDate_ps=%s WHERE safari_ripoti_id=%s",
