...
<div class="row_form">
	...
	<?php 
	if(($row_rsselectedKibali['ps_status'] !="") && ($_GET['badilisha'] !="ndio")){ echo "&nbsp;&nbsp;[&nbsp;<a href='yaliyokataliwa_tazama.php?id=$id&maamuzi_ID=$maamuzi_ID&sababu=$sababu&badilisha=ndio'>BADILI</a>&nbsp;]";};?>
    </div> 
    <div class="">
    </div>
</div>
