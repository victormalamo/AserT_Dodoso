<?php
$page=$_POST['page'];
if($page=="yaliyopitishwa_list_update")
{
	...
	{ 
	header("Location: yaliyopitishwa_list_update.php?c_tupu=ipo&id=$id&catID=$catID&regID=$regID&lgaID=$lgaID&sDate=$sDate&eDate=$eDate&duration=$duration&usafiriID=$usafiriID&madhumuniID=$madhumuniID&muhtasari=$muhtasari&mlipajiID=$mlipajiID&wengine=$wengine"); die();
	};
