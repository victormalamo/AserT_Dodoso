...
//if($_GET['imetoka'] == "ingiza_maoni"){   
 ...
 // echo "window.location.href='yaliyopitishwa_list.php';";
  //echo "<script>";
  //send sms
//}
?>
...
//$levelID = "nu";
$general_status = "kimepitishwa_ps";
//$zimebaki_siku >=0;


//Maombi ya HOD_U yaliyopitishwa

$query_rs_yaliyopitishwa_ya_hod_u = sprintf("SELECT * FROM vibali WHERE (((`levelID`='dahrm') || (`levelID`='hod') || (`levelID`='hou'))  AND (`general_status`='%s') AND (`zimebaki_siku` >= 0 )) ORDER BY id DESC",$general_status);
$rs_yaliyopitishwa_ya_hod_u = mysqli_query($conntscpME, $query_rs_yaliyopitishwa_ya_hod_u) or die(mysqli_error());
$row_rs_yaliyopitishwa_ya_hod_u = mysqli_fetch_assoc($rs_yaliyopitishwa_ya_hod_u);
$totalRows_rs_yaliyopitishwa_ya_hod_u = mysqli_num_rows($rs_yaliyopitishwa_ya_hod_u);

//Maombi ya HOS yaliyopitishwa

$query_rs_yaliyopitishwa_ya_hos = sprintf("SELECT * FROM vibali WHERE ((`levelID`='hos')  AND (`general_status`='%s') AND (`zimebaki_siku` >= 0 )) ORDER BY id DESC",$general_status);
$rs_yaliyopitishwa_ya_hos = mysqli_query($conntscpME, $query_rs_yaliyopitishwa_ya_hos) or die(mysqli_error());
$row_rs_yaliyopitishwa_ya_hos = mysqli_fetch_assoc($rs_yaliyopitishwa_ya_hos);
$totalRows_rs_yaliyopitishwa_ya_hos = mysqli_num_rows($rs_yaliyopitishwa_ya_hos);

/*
//Maombi ya NU yaliyopitishwa

$query_rs_yaliyopitishwa_ya_nu = sprintf("SELECT * FROM vibali WHERE ((`levelID`='nu')  AND (`general_status`='%s') AND (`zimebaki_siku` >= 0 )) ORDER BY id DESC",$general_status);
$rs_yaliyopitishwa_ya_nu = mysqli_query($conntscpME, $query_rs_yaliyopitishwa_ya_nu) or die(mysqli_error());
$row_rs_yaliyopitishwa_ya_nu = mysqli_fetch_assoc($rs_yaliyopitishwa_ya_nu);
$totalRows_rs_yaliyopitishwa_ya_nu = mysqli_num_rows($rs_yaliyopitishwa_ya_nu);
*/

$totalRows_rs_yaliyopitishwa = ($totalRows_rs_yaliyopitishwa_ya_hod_u + $totalRows_rs_yaliyopitishwa_ya_hos);
    ...
    <div id="leftmenuinner" style="padding-top: 0px;"> 
      <div class="w3-light-greyQ" id="leftmenuinnerinner"> <br class="w3-hide-large">
        ...
        <div class="menu_teuzi" style="display: block;"> <a target="_top" href="http://localhost/user/ps/yanayoingia_list.php" <?php if($idadi_yanayoingia_ps != ""){echo "class='badge1' data-badge='".$idadi_yanayoingia_ps."'";};?>>Yanayoingia</a> 
          <div id="sidenav-imechaguliwa_2" <?php if($idadi_yaliyopitishwa_ps != ""){echo "class='badge1' data-badge='".$idadi_yaliyopitishwa_ps."'";};?>>Uliyokubali</div>
      ...
      <div class="w3-col l10 m12" id="main"> 
        <div id="mainLeaderboard" style="overflow:hidden;"> 
          <div class="container_form_kichwa"> 
            <div class="kichwa_ndogo form_link"><a href="http://localhost/user/ps/index.php">Mwanzo</a>&nbsp;<span class="kichwa_ndogo_sana">/</span>&nbsp;Maombi Yaliyopitishwa</div>
          </div>
          <div class="container_form">
            <?php if($totalRows_rs_yaliyopitishwa == 0){
echo "<div class='rekodi_tupu w3-left'>HAKUNA MAOMBI YALIYOPITISHWA!</div>";
}else{?>
            <!--  *******************  YA HOD_U YALIYOPITISHWA **************-->
            <?php if($totalRows_rs_yaliyopitishwa_ya_hod_u != 0){
			...
			<div class="row_form col-view-title w3-white">Wakuu wa Idara/Vitengo</div>
              ...
              <div class="row_form col-view w3-blue" title="Safari ya siku 7 ..."> 
                ...
                <div class="col-view-kwenda"><span class="w3-left col-view-555 col-view-dot " style="margin: 8px 8px 0px 8px"></span>	
                  <?php  //Jina la Mkoa
	$regID=$row_rs_yaliyopitishwa_ya_hod_u['regID'];
	...
	//Jina la Halmashauri
	$lgaID=$row_rs_yaliyopitishwa_ya_hod_u['lgaID'];
	...
	//Jina la kuonesha
	if ($row_rs_yaliyopitishwa_ya_hod_u['lgaID']==""){
	...
	?>
                ...
                <div class="col-view-tarehe"> 
                  <?php echo "Tarehe&nbsp;".$row_rs_yaliyopitishwa_ya_hod_u['sDate'];?>
                  <span class="w3-right col-view-555"> 
                  <!--a href="maombi_mapya_list_update.php?id=<php echo $row_rs_yaliyopitishwa['id'];?>&catID=<php echo $row_rs_yaliyopitishwa['catID'];?>&regID=<php echo $row_rs_yaliyopitishwa['regID'];?>&lgaID=<php echo $row_rs_yaliyopitishwa['lgaID'];?>&sDate=<php echo $row_rs_yaliyopitishwa['sDate'];?>&eDate=<php echo $row_rs_yaliyopitishwa['eDate'];?>&duration=<php echo $row_rs_yaliyopitishwa['duration'];?>&usafiriID=<php echo $row_rs_yaliyopitishwa['usafiriID'];?>&madhumuniID=<php echo $row_rs_yaliyopitishwa['madhumuniID'];?>&muhtasari=<php echo $row_rs_yaliyopitishwa['muhtasari'];?>&mlipajiID=<php echo $row_rs_yaliyopitishwa['mlipajiID'];?>&wengine=<php echo $row_rs_yaliyopitishwa['wengine'];?>&jina_kiambata=<php echo $row_rs_yaliyopitishwa['jina_kiambata'];?>&kiambata=<php echo $row_rs_yaliyopitishwa['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>
	&nbsp;<a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_yaliyopitishwa['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;-->
                  <a href="yaliyopitishwa_tazama.php?id=<?php echo $row_rs_yaliyopitishwa_ya_hod_u['id'];?>"> 
                  <?php if($row_rs_yaliyopitishwa_ya_hod_u['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                ...
                <div class="col-view-madhumuni"> 
                  <?php
	//Madhumuni
	$madhumuniID=$row_rs_yaliyopitishwa_ya_hod_u['madhumuniID'];
	...
	echo $row_rsmadhumuni['madhumuni'];?>
                ...
                <div class="col-view-icons"> 
                  <!--span><a href="maombi_mapya_list_update.php?id=<php echo $row_rs_yaliyopitishwa['id'];?>&catID=<php echo $row_rs_yaliyopitishwa['catID'];?>&regID=<php echo $row_rs_yaliyopitishwa['regID'];?>&lgaID=<php echo $row_rs_yaliyopitishwa['lgaID'];?>&sDate=<php echo $row_rs_yaliyopitishwa['sDate'];?>&eDate=<php echo $row_rs_yaliyopitishwa['eDate'];?>&duration=<php echo $row_rs_yaliyopitishwa['duration'];?>&usafiriID=<php echo $row_rs_yaliyopitishwa['usafiriID'];?>&madhumuniID=<php echo $row_rs_yaliyopitishwa['madhumuniID'];?>&muhtasari=<php echo $row_rs_yaliyopitishwa['muhtasari'];?>&mlipajiID=<php echo $row_rs_yaliyopitishwa['mlipajiID'];?>&wengine=<php echo $row_rs_yaliyopitishwa['wengine'];?>&jina_kiambata=<php echo $row_rs_yaliyopitishwa['jina_kiambata'];?>&kiambata=<php echo $row_rs_yaliyopitishwa['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>&nbsp;&nbsp;</span>
	<span><a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_yaliyopitishwa['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;&nbsp;</span-->
                  <span><a href="yaliyopitishwa_tazama.php?id=<?php echo $row_rs_yaliyopitishwa_ya_hod_u['id'];?>"> 
                  <?php if($row_rs_yaliyopitishwa_ya_hod_u['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
              ...
              <?php } while ($row_rs_yaliyopitishwa_ya_hod_u = mysqli_fetch_assoc($rs_yaliyopitishwa_ya_hod_u));?>
            </div>
            <?php } ?>
            <!--  *******************  END YA HOD_U YALIYOPITISHWA **************-->
            <!--  *******************  YA HOS YALIYOPITISHWA **************-->
            <?php if($totalRows_rs_yaliyopitishwa_ya_hos != 0){
		   ...
		   echo "<div class='rekodi_tupu w3-left'></div>";
			...
			<div class="row_form col-view-title w3-white">Wakuu wa Section</div>
              ...
              <div class="row_form col-view w3-blue" title="Safari ya siku 7 ..."> 
                ...
                <div class="col-view-kwenda"><span class="w3-left col-view-555 col-view-dot " style="margin: 8px 8px 0px 8px"></span>	
                  <?php  //Jina la Mkoa
	$regID=$row_rs_yaliyopitishwa_ya_hos['regID'];
	...
	$totalRows_rsregName = mysqli_num_rows($rsregName);	
	//Jina la Halmashauri
	$lgaID=$row_rs_yaliyopitishwa_ya_hos['lgaID'];
	...
	$totalRows_rslgaName = mysqli_num_rows($rslgaName);
	//Jina la kuonesha
	if ($row_rs_yaliyopitishwa_ya_hos['lgaID']==""){
	echo "Kwenda&nbsp;".$row_rsregName['regNam'];
	}else{
	echo "Kwenda&nbsp;".$row_rslgaName['lgaNam'];
	};
	?>
                ...
                <div class="col-view-tarehe"> 
                  <?php echo "Tarehe&nbsp;".$row_rs_yaliyopitishwa_ya_hos['sDate'];?>
                  <span class="w3-right col-view-555"> 
                  <!--a href="maombi_mapya_list_update.php?id=<php echo $row_rs_yaliyopitishwa['id'];?>&catID=<php echo $row_rs_yaliyopitishwa['catID'];?>&regID=<php echo $row_rs_yaliyopitishwa['regID'];?>&lgaID=<php echo $row_rs_yaliyopitishwa['lgaID'];?>&sDate=<php echo $row_rs_yaliyopitishwa['sDate'];?>&eDate=<php echo $row_rs_yaliyopitishwa['eDate'];?>&duration=<php echo $row_rs_yaliyopitishwa['duration'];?>&usafiriID=<php echo $row_rs_yaliyopitishwa['usafiriID'];?>&madhumuniID=<php echo $row_rs_yaliyopitishwa['madhumuniID'];?>&muhtasari=<php echo $row_rs_yaliyopitishwa['muhtasari'];?>&mlipajiID=<php echo $row_rs_yaliyopitishwa['mlipajiID'];?>&wengine=<php echo $row_rs_yaliyopitishwa['wengine'];?>&jina_kiambata=<php echo $row_rs_yaliyopitishwa['jina_kiambata'];?>&kiambata=<php echo $row_rs_yaliyopitishwa['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>
	&nbsp;<a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_yaliyopitishwa['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;-->
                  <a href="yaliyopitishwa_tazama.php?id=<?php echo $row_rs_yaliyopitishwa_ya_hos['id'];?>"> 
                  <?php if($row_rs_yaliyopitishwa_ya_hos['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
                  <?php };?>
                ...
                <div class="col-view-madhumuni"> 
                  <?php
	//Madhumuni
	$madhumuniID=$row_rs_yaliyopitishwa_ya_hos['madhumuniID'];
	...
	echo $row_rsmadhumuni['madhumuni'];?>
                ...
                <div class="col-view-icons"> 
                  <!--span><a href="maombi_mapya_list_update.php?id=<php echo $row_rs_yaliyopitishwa['id'];?>&catID=<php echo $row_rs_yaliyopitishwa['catID'];?>&regID=<php echo $row_rs_yaliyopitishwa['regID'];?>&lgaID=<php echo $row_rs_yaliyopitishwa['lgaID'];?>&sDate=<php echo $row_rs_yaliyopitishwa['sDate'];?>&eDate=<php echo $row_rs_yaliyopitishwa['eDate'];?>&duration=<php echo $row_rs_yaliyopitishwa['duration'];?>&usafiriID=<php echo $row_rs_yaliyopitishwa['usafiriID'];?>&madhumuniID=<php echo $row_rs_yaliyopitishwa['madhumuniID'];?>&muhtasari=<php echo $row_rs_yaliyopitishwa['muhtasari'];?>&mlipajiID=<php echo $row_rs_yaliyopitishwa['mlipajiID'];?>&wengine=<php echo $row_rs_yaliyopitishwa['wengine'];?>&jina_kiambata=<php echo $row_rs_yaliyopitishwa['jina_kiambata'];?>&kiambata=<php echo $row_rs_yaliyopitishwa['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>&nbsp;&nbsp;</span>
	<span><a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_yaliyopitishwa['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;&nbsp;</span-->
                  <span><a href="yaliyopitishwa_tazama.php?id=<?php echo $row_rs_yaliyopitishwa_ya_hos['id'];?>"> 
                  <?php if($row_rs_yaliyopitishwa_ya_hos['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
              ...
              <?php } while ($row_rs_yaliyopitishwa_ya_hos = mysqli_fetch_assoc($rs_yaliyopitishwa_ya_hos));?>
            </div>
            <?php } ?>
            <!--  *******************  END YA HOS YALIYOPITISHWA **************-->
            <!--  *******************  YA NU YALIYOPITISHWA **************-->
            <?php if($totalRows_rs_yaliyopitishwa_ya_nu != 0){
		   
		   echo "<div class='rekodi_tupu w3-left'></div>";
		    ?>
            <div class="row_form col-view-title">Maombi ya Mtumishi Yaliyopitishwa</div>
            <div class="row_form col-view-btm"> 
              <?php $sn=0; do {  $sn++; ?>
              <div class="row_form col-view" title="Safari ya siku 7 ..."> 
                <div class="col-view-namba" data-tip="Nifanyw ni wrap words"> 
                  <?php echo $sn.".";?>
                </div>
                <div class="col-view-kwenda"><span class="w3-left col-view-555 col-view-dot " style="margin: 8px 8px 0px 8px"></span>	
                  <?php  //Jina la Mkoa
	$regID=$row_rs_yaliyopitishwa_ya_nu['regID'];
	...
	$totalRows_rsregName = mysqli_num_rows($rsregName);	
	//Jina la Halmashauri
	$lgaID=$row_rs_yaliyopitishwa_ya_nu['lgaID'];
	...
	$totalRows_rslgaName = mysqli_num_rows($rslgaName);
	//Jina la kuonesha
	if ($row_rs_yaliyopitishwa_ya_nu['lgaID']==""){
	echo "Kwenda&nbsp;".$row_rsregName['regNam'];
	}else{
	echo "Kwenda&nbsp;".$row_rslgaName['lgaNam'];
	};
	?>
                ...
                <div class="col-view-tarehe"> 
                  <?php echo "Tarehe&nbsp;".$row_rs_yaliyopitishwa_ya_nu['sDate'];?>
                  <span class="w3-right col-view-555"> 
                  <!--a href="maombi_mapya_list_update.php?id=<php echo $row_rs_yaliyopitishwa['id'];?>&catID=<php echo $row_rs_yaliyopitishwa['catID'];?>&regID=<php echo $row_rs_yaliyopitishwa['regID'];?>&lgaID=<php echo $row_rs_yaliyopitishwa['lgaID'];?>&sDate=<php echo $row_rs_yaliyopitishwa['sDate'];?>&eDate=<php echo $row_rs_yaliyopitishwa['eDate'];?>&duration=<php echo $row_rs_yaliyopitishwa['duration'];?>&usafiriID=<php echo $row_rs_yaliyopitishwa['usafiriID'];?>&madhumuniID=<php echo $row_rs_yaliyopitishwa['madhumuniID'];?>&muhtasari=<php echo $row_rs_yaliyopitishwa['muhtasari'];?>&mlipajiID=<php echo $row_rs_yaliyopitishwa['mlipajiID'];?>&wengine=<php echo $row_rs_yaliyopitishwa['wengine'];?>&jina_kiambata=<php echo $row_rs_yaliyopitishwa['jina_kiambata'];?>&kiambata=<php echo $row_rs_yaliyopitishwa['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>
	&nbsp;<a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_yaliyopitishwa['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;-->
                  <a href="yaliyopitishwa_tazama.php?id=<?php echo $row_rs_yaliyopitishwa_ya_nu['id'];?>"> 
                  <?php if($row_rs_yaliyopitishwa_ya_nu['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
                  <?php };?>
                ...
                <div class="col-view-madhumuni"> 
                  <?php
	//Madhumuni
	$madhumuniID=$row_rs_yaliyopitishwa_ya_nu['madhumuniID'];
	...
	echo $row_rsmadhumuni['madhumuni'];?>
                ...
                <div class="col-view-icons"> 
                  <!--span><a href="maombi_mapya_list_update.php?id=<php echo $row_rs_yaliyopitishwa['id'];?>&catID=<php echo $row_rs_yaliyopitishwa['catID'];?>&regID=<php echo $row_rs_yaliyopitishwa['regID'];?>&lgaID=<php echo $row_rs_yaliyopitishwa['lgaID'];?>&sDate=<php echo $row_rs_yaliyopitishwa['sDate'];?>&eDate=<php echo $row_rs_yaliyopitishwa['eDate'];?>&duration=<php echo $row_rs_yaliyopitishwa['duration'];?>&usafiriID=<php echo $row_rs_yaliyopitishwa['usafiriID'];?>&madhumuniID=<php echo $row_rs_yaliyopitishwa['madhumuniID'];?>&muhtasari=<php echo $row_rs_yaliyopitishwa['muhtasari'];?>&mlipajiID=<php echo $row_rs_yaliyopitishwa['mlipajiID'];?>&wengine=<php echo $row_rs_yaliyopitishwa['wengine'];?>&jina_kiambata=<php echo $row_rs_yaliyopitishwa['jina_kiambata'];?>&kiambata=<php echo $row_rs_yaliyopitishwa['final_kiambata'];?>"><img src="/images/edit.png" width="30" height="13" title="Badili"></a>&nbsp;&nbsp;</span>
	<span><a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_yaliyopitishwa['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;&nbsp;</span-->
                  <span><a href="yaliyopitishwa_tazama.php?id=<?php echo $row_rs_yaliyopitishwa_ya_nu['id'];?>"> 
                  <?php if($row_rs_yaliyopitishwa_ya_nu['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
              ...
              <?php } while ($row_rs_yaliyopitishwa_ya_nu = mysqli_fetch_assoc($rs_yaliyopitishwa_ya_nu));?>
            </div>
            <?php } ?>
            <!--  *******************  END YA NU YALIYOPITISHWA **************-->
            <?php };?>
          </div>
          <!-- footer-->
        </div>
