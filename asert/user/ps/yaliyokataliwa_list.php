...
//$levelID = "nu";
$general_status = "kimekataliwa_ps";
//$zimebaki_siku >=0;


//Maombi ya HOD_U yaliyokataliwa

$query_rs_yaliyokataliwa_ya_hod_u = sprintf("SELECT * FROM vibali WHERE (((`levelID`='dahrm') || (`levelID`='hod') || (`levelID`='hou'))  AND (`general_status`='%s') AND (`zimebaki_siku` >= 0 )) ORDER BY id DESC",$general_status);
$rs_yaliyokataliwa_ya_hod_u = mysqli_query($conntscpME, $query_rs_yaliyokataliwa_ya_hod_u) or die(mysqli_error());
$row_rs_yaliyokataliwa_ya_hod_u = mysqli_fetch_assoc($rs_yaliyokataliwa_ya_hod_u);
$totalRows_rs_yaliyokataliwa_ya_hod_u = mysqli_num_rows($rs_yaliyokataliwa_ya_hod_u);

//Maombi ya HOS yaliyokataliwa

$query_rs_yaliyokataliwa_ya_hos = sprintf("SELECT * FROM vibali WHERE ((`levelID`='hos')  AND (`general_status`='%s') AND (`zimebaki_siku` >= 0 )) ORDER BY id DESC",$general_status);
...
$query_rs_yaliyokataliwa_ya_nu = sprintf("SELECT * FROM vibali WHERE ((`levelID`='nu')  AND (`general_status`='%s') AND (`zimebaki_siku` >= 0 )) ORDER BY id DESC",$general_status);
...
*/
$totalRows_rs_yaliyokataliwa = ($totalRows_rs_yaliyokataliwa_ya_hod_u + $totalRows_rs_yaliyokataliwa_ya_hos);
    ...
    <div id="leftmenuinner" style="padding-top: 0px;"> 
      <div class="w3-light-greyQ" id="leftmenuinnerinner"> <br class="w3-hide-large">
        ...
        <div class="menu_teuzi" style="display: block;"> <a target="_top" href="http://localhost/user/ps/yanayoingia_list.php" <?php if($idadi_yanayoingia_ps != ""){echo "class='badge1' data-badge='".$idadi_yanayoingia_ps."'";};?>>Yanayoingia</a> 
          ...
          <div id="sidenav-imechaguliwa_2"<?php if($idadi_yaliyokataliwa_ps != ""){echo "class='badge1' data-badge='".$idadi_yaliyokataliwa_ps."'";};?>>Uliyokataa</div>
      ...
      <div class="w3-col l10 m12" id="main"> 
        <div id="mainLeaderboard" style="overflow:hidden;"> 
          <div class="container_form_kichwa"> 
            <div class="kichwa_ndogo form_link"><a href="http://localhost/user/ps/index.php">Mwanzo</a>&nbsp;<span class="kichwa_ndogo_sana">/</span>&nbsp;Maombi Yaliyokataliwa</div>
          </div>
          <div class="container_form">
            <?php if($totalRows_rs_yaliyokataliwa == 0){
echo "<div class='rekodi_tupu w3-left'>HAKUNA MAOMBI YALIYOKATALIWA!</div>";
}else{?>
            <!--  *******************  YA HOD_U yaliyokataliwa **************-->
            <?php if($totalRows_rs_yaliyokataliwa_ya_hod_u != 0){
			...
			<div class="row_form col-view-title w3-white">Wakuu wa Idara/Vitengo</div>
              ...
              <div class="row_form col-view w3-blue" title="Safari ya siku 7 ..."> 
                ...
                <div class="col-view-kwenda"><span class="w3-left col-view-555 col-view-dot " style="margin: 8px 8px 0px 8px"></span>	
                  <?php  //Jina la Mkoa
	$regID=$row_rs_yaliyokataliwa_ya_hod_u['regID'];
	...
	//Jina la Halmashauri
	$lgaID=$row_rs_yaliyokataliwa_ya_hod_u['lgaID'];
	...
	//Jina la kuonesha
	if ($row_rs_yaliyokataliwa_ya_hod_u['lgaID']==""){
	...
	?>
                ...
                <div class="col-view-tarehe"> 
                  <?php echo "Tarehe&nbsp;".$row_rs_yaliyokataliwa_ya_hod_u['sDate'];?>
	...
	&nbsp;<a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_yaliyokataliwa['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;-->
                  <a href="yaliyokataliwa_tazama.php?id=<?php echo $row_rs_yaliyokataliwa_ya_hod_u['id'];?>"> 
                  <?php if($row_rs_yaliyokataliwa_ya_hod_u['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                ...
                <div class="col-view-madhumuni"> 
                  <?php
	//Madhumuni
	$madhumuniID=$row_rs_yaliyokataliwa_ya_hod_u['madhumuniID'];
	...
	<span><a href="maombi_mapya_tazama.php?tendo=futa&id=<php echo $row_rs_yaliyokataliwa['id'];?>"><img src="/images/delete.png" width="30" height="13" title="Futa"></a>&nbsp;&nbsp;</span-->
                  <span><a href="yaliyokataliwa_tazama.php?id=<?php echo $row_rs_yaliyokataliwa_ya_hod_u['id'];?>"> 
                  <?php if($row_rs_yaliyokataliwa_ya_hod_u['ruti_ID'] == "ruti_zaidi_ya_moja") { ?>
                  <img src="/images/view_unganisha.png" width="30" height="13" title="tazama"> 
                  <?php }else{?>
                  <img src="/images/view.png" width="30" height="13" title="tazama"> 
              ...
              <?php } while ($row_rs_yaliyokataliwa_ya_hod_u = mysqli_fetch_assoc($rs_yaliyokataliwa_ya_hod_u));?>
            </div>
            <?php } ?>
            <!--  *******************  END YA HOD_U yaliyokataliwa **************-->
