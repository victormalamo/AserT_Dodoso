<?php
$page=$_POST['page'];
if($page=="yaliyoelekezwa_list_update")
{
	...
	{ 
	header("Location: yaliyoelekezwa_list_update.php?c_tupu=ipo&id=$id&catID=$catID&regID=$regID&lgaID=$lgaID&sDate=$sDate&eDate=$eDate&duration=$duration&usafiriID=$usafiriID&madhumuniID=$madhumuniID&muhtasari=$muhtasari&mlipajiID=$mlipajiID&wengine=$wengine"); die();
	};
