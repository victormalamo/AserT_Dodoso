...
$(document).ready(function() { 
	...
	if ($('input[name="napendekeza_sipendekezi_ps"]:checked').val() == "napendekeza") {   
	$('.napendekeza').show("fast");
	}else{ 
	$("#napendekeza_apewe_sh_ps").val('');
	...
	$('.napendekeza').hide("fast");
	  ...
	  <!--Sipendekezi-->
	if ($('input[name="napendekeza_sipendekezi_ps"]:checked').val() == "sipendekezi") {   
	$('.sipendekezi').show("fast");
	}else{ 
	$("#napendekeza_asipewe_ps").val('');
	//$("#namba_ya_masurufu_yanayodaiwa").val('');
...
<div class="row_form">
    <div class="title_100stb mnrt-left-align kibali_title">
	Maombi ya Mkuu wa Idara/Vitengo
    </div> 
</div>
...
<div class="row_form">
	...
	<?php 
	if(($row_masurufu_maombi_mapya['napendekeza_sipendekezi_ps'] !="") && ($_GET['badilisha'] !="ndio")){ echo "&nbsp;&nbsp;[&nbsp;<a href='masurufu_yanayoingia_tazama.php?kibali_id=$kibali_id&badilisha=ndio'>BADILI</a>&nbsp;]";};?>
    </div> 
    <div class="">
    </div>
</div>

<?php if(($row_masurufu_maombi_mapya['napendekeza_sipendekezi_ps'] !="") && ($_GET['badilisha'] !="ndio")){?>
...
<label class="radio-inline">
  <?php 
  if($row_masurufu_maombi_mapya['napendekeza_apewe_sh_ps'] != "") { $napendekeza = "checked"; }
  if($row_masurufu_maombi_mapya['napendekeza_sipendekezi_ps'] == "sipendekezi") { $sipendekezi = "checked"; };?>
          <input type="radio" name="napendekeza_sipendekezi_ps" id="napendekeza_sipendekezi_ps" value="napendekeza" <?php echo $napendekeza;?>>
   Naidhinisha
   </label>
   <label class="radio-inline">
          <input type="radio" name="napendekeza_sipendekezi_ps" id="napendekeza_sipendekezi_ps" value="sipendekezi" <?php echo $sipendekezi;?>>
    Siidhinishi
    </label>
	</div>
	</div>	
	...
	<div class="title_100st mnrt-left-align">
	Kiasi cha fedha unachoidhinisha:-
    </div> 
    <div class="col-form-75" data-tip="Apewe shilingi">
     <input type="text" class="form-control namba" id="napendekeza_apewe_sh_ps" name="napendekeza_apewe_sh_ps" placeholder="Naidhinisha sh.." value="<?php echo $row_masurufu_maombi_mapya['napendekeza_apewe_sh_ps'];?>">
    </div>
	</div>
	<div class="row_form sipendekezi">
    <div class="col-form-75" data-tip="Sababu">
     <input type="text" class="form-control" id="napendekeza_asipewe_ps" name="napendekeza_asipewe_ps" placeholder="Sababu.." value="<?php echo $row_masurufu_maombi_mapya['napendekeza_asipewe_ps'];?>">
    </div>
	</div>
