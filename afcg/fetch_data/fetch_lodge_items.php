...
$assessor_score_column = 'assessment_score_'.$assessor_category;
	...
	$query = "SELECT * FROM afcg_assessment_lodge WHERE ((assessment_id = '".$assessment_id."') AND (assessor_category = '".$assessor_category."'))"; 
	...
	if (mysqli_num_rows($result) > 0) {
		...
		if(($row['lobby_lounge_other_public_areas_4_1_1_G'] == "") || ($row['lobby_lounge_other_public_areas_4_1_1_G'] === NULL)){ $output['lobby_lounge_other_public_areas_4_1_1_G'] = "empty"; }else{ $output['lobby_lounge_other_public_areas_4_1_1_G'] = $row['lobby_lounge_other_public_areas_4_1_1_G']; }
		...
		if(($row['guest_rooms_9_4_1_B_n'] == "") || ($row['guest_rooms_9_4_1_B_n'] === NULL)){ $output['guest_rooms_9_4_1_B_n'] = "empty"; }else{ $output['guest_rooms_9_4_1_B_n'] = $row['guest_rooms_9_4_1_B_n']; }
		...
		$output['guest_bathrooms_10_9_1_text'] = $row['guest_bathrooms_10_9_1_text']; 
		...
		if(($row['suites_11_11_1_C'] == "") || ($row['suites_11_11_1_C'] === NULL)){ $output['suites_11_11_1_C'] = "empty"; }else{ $output['suites_11_11_1_C'] = $row['suites_11_11_1_C']; }
		...
		$output['sundry_services_15_3_1_text'] = $row['sundry_services_15_3_1_text']; 
		...
		$output['sundry_services_15_4_1_text'] = $row['sundry_services_15_4_1_text']; 
		...
		if(($row['human_resources_15_11_1_B_a'] == "") || ($row['human_resources_15_11_1_B_a'] === NULL)){ $output['human_resources_15_11_1_B_a'] = "empty"; }else{ $output['human_resources_15_11_1_B_a'] = $row['human_resources_15_11_1_B_a']; }
		if(($row['human_resources_15_11_1_B_b'] == "") || ($row['human_resources_15_11_1_B_b'] === NULL)){ $output['human_resources_15_11_1_B_b'] = "empty"; }else{ $output['human_resources_15_11_1_B_b'] = $row['human_resources_15_11_1_B_b']; }
		if(($row['human_resources_15_11_1_B_c'] == "") || ($row['human_resources_15_11_1_B_c'] === NULL)){ $output['human_resources_15_11_1_B_c'] = "empty"; }else{ $output['human_resources_15_11_1_B_c'] = $row['human_resources_15_11_1_B_c']; }
