...
$assessor_score_column = 'assessment_score_'.$assessor_category;
	...
	$query = "SELECT * FROM afcg_assessment_tented_camp WHERE ((assessment_id = '".$assessment_id."') AND (assessor_category = '".$assessor_category."'))"; 
		...
		foreach($result as $row)
		 {
			...
			if(($row['location_1_1_1_C'] == "") || ($row['location_1_1_1_C'] === NULL)){ $output['location_1_1_1_C'] = "empty"; }else{ $output['location_1_1_1_C'] = $row['location_1_1_1_C']; }
			if(($row['location_1_1_1_D'] == "") || ($row['location_1_1_1_D'] === NULL)){ $output['location_1_1_1_D'] = "empty"; }else{ $output['location_1_1_1_D'] = $row['location_1_1_1_D']; }
			if(($row['location_1_1_1_E'] == "") || ($row['location_1_1_1_E'] === NULL)){ $output['location_1_1_1_E'] = "empty"; }else{ $output['location_1_1_1_E'] = $row['location_1_1_1_E']; }
			if(($row['location_1_1_1_F'] == "") || ($row['location_1_1_1_F'] === NULL)){ $output['location_1_1_1_F'] = "empty"; }else{ $output['location_1_1_1_F'] = $row['location_1_1_1_F']; }
			if(($row['location_1_1_1_G'] == "") || ($row['location_1_1_1_G'] === NULL)){ $output['location_1_1_1_G'] = "empty"; }else{ $output['location_1_1_1_G'] = $row['location_1_1_1_G']; }
			if(($row['location_1_1_1_H'] == "") || ($row['location_1_1_1_H'] === NULL)){ $output['location_1_1_1_H'] = "empty"; }else{ $output['location_1_1_1_H'] = $row['location_1_1_1_H']; }
			if(($row['location_1_1_1_I'] == "") || ($row['location_1_1_1_I'] === NULL)){ $output['location_1_1_1_I'] = "empty"; }else{ $output['location_1_1_1_I'] = $row['location_1_1_1_I']; }
			...
			if(($row['location_1_2_1_B'] == "") || ($row['location_1_2_1_B'] === NULL)){ $output['location_1_2_1_B'] = "empty"; }else{ $output['location_1_2_1_B'] = $row['location_1_2_1_B']; }
			if(($row['location_1_2_1_C'] == "") || ($row['location_1_2_1_C'] === NULL)){ $output['location_1_2_1_C'] = "empty"; }else{ $output['location_1_2_1_C'] = $row['location_1_2_1_C']; }
			if(($row['location_1_2_1_D_a'] == "") || ($row['location_1_2_1_D_a'] === NULL)){ $output['location_1_2_1_D_a'] = "empty"; }else{ $output['location_1_2_1_D_a'] = $row['location_1_2_1_D_a']; }
			if(($row['location_1_2_1_D_b'] == "") || ($row['location_1_2_1_D_b'] === NULL)){ $output['location_1_2_1_D_b'] = "empty"; }else{ $output['location_1_2_1_D_b'] = $row['location_1_2_1_D_b']; }
			if(($row['location_1_2_1_D_c'] == "") || ($row['location_1_2_1_D_c'] === NULL)){ $output['location_1_2_1_D_c'] = "empty"; }else{ $output['location_1_2_1_D_c'] = $row['location_1_2_1_D_c']; }
			if(($row['location_1_2_1_D_d'] == "") || ($row['location_1_2_1_D_d'] === NULL)){ $output['location_1_2_1_D_d'] = "empty"; }else{ $output['location_1_2_1_D_d'] = $row['location_1_2_1_D_d']; }
			if(($row['location_1_2_1_E'] == "") || ($row['location_1_2_1_E'] === NULL)){ $output['location_1_2_1_E'] = "empty"; }else{ $output['location_1_2_1_E'] = $row['location_1_2_1_E']; }
			if(($row['location_1_2_1_F'] == "") || ($row['location_1_2_1_F'] === NULL)){ $output['location_1_2_1_F'] = "empty"; }else{ $output['location_1_2_1_F'] = $row['location_1_2_1_F']; }
			if(($row['location_1_2_1_G_a'] == "") || ($row['location_1_2_1_G_a'] === NULL)){ $output['location_1_2_1_G_a'] = "empty"; }else{ $output['location_1_2_1_G_a'] = $row['location_1_2_1_G_a']; }
			if(($row['location_1_2_1_G_b'] == "") || ($row['location_1_2_1_G_b'] === NULL)){ $output['location_1_2_1_G_b'] = "empty"; }else{ $output['location_1_2_1_G_b'] = $row['location_1_2_1_G_b']; }
			if(($row['location_1_2_1_G_c'] == "") || ($row['location_1_2_1_G_c'] === NULL)){ $output['location_1_2_1_G_c'] = "empty"; }else{ $output['location_1_2_1_G_c'] = $row['location_1_2_1_G_c']; }
			if(($row['location_1_2_1_H'] == "") || ($row['location_1_2_1_H'] === NULL)){ $output['location_1_2_1_H'] = "empty"; }else{ $output['location_1_2_1_H'] = $row['location_1_2_1_H']; }
			if(($row['location_1_2_1_I'] == "") || ($row['location_1_2_1_I'] === NULL)){ $output['location_1_2_1_I'] = "empty"; }else{ $output['location_1_2_1_I'] = $row['location_1_2_1_I']; }
			if(($row['location_1_2_1_J'] == "") || ($row['location_1_2_1_J'] === NULL)){ $output['location_1_2_1_J'] = "empty"; }else{ $output['location_1_2_1_J'] = $row['location_1_2_1_J']; }
			if(($row['location_1_2_1_K'] == "") || ($row['location_1_2_1_K'] === NULL)){ $output['location_1_2_1_K'] = "empty"; }else{ $output['location_1_2_1_K'] = $row['location_1_2_1_K']; }
			if(($row['location_1_2_1_L'] == "") || ($row['location_1_2_1_L'] === NULL)){ $output['location_1_2_1_L'] = "empty"; }else{ $output['location_1_2_1_L'] = $row['location_1_2_1_L']; }
			if(($row['location_1_2_1_M'] == "") || ($row['location_1_2_1_M'] === NULL)){ $output['location_1_2_1_M'] = "empty"; }else{ $output['location_1_2_1_M'] = $row['location_1_2_1_M']; }
			if(($row['location_1_2_1_N'] == "") || ($row['location_1_2_1_N'] === NULL)){ $output['location_1_2_1_N'] = "empty"; }else{ $output['location_1_2_1_N'] = $row['location_1_2_1_N']; }
			...
			if(($row['building_2_1_1_C'] == "") || ($row['building_2_1_1_C'] === NULL)){ $output['building_2_1_1_C'] = "empty"; }else{ $output['building_2_1_1_C'] = $row['building_2_1_1_C']; }
			if(($row['building_2_1_1_D'] == "") || ($row['building_2_1_1_D'] === NULL)){ $output['building_2_1_1_D'] = "empty"; }else{ $output['building_2_1_1_D'] = $row['building_2_1_1_D']; }
			if(($row['building_2_1_1_E'] == "") || ($row['building_2_1_1_E'] === NULL)){ $output['building_2_1_1_E'] = "empty"; }else{ $output['building_2_1_1_E'] = $row['building_2_1_1_E']; }
			if(($row['building_2_1_1_F'] == "") || ($row['building_2_1_1_F'] === NULL)){ $output['building_2_1_1_F'] = "empty"; }else{ $output['building_2_1_1_F'] = $row['building_2_1_1_F']; }
			if(($row['building_2_1_1_G'] == "") || ($row['building_2_1_1_G'] === NULL)){ $output['building_2_1_1_G'] = "empty"; }else{ $output['building_2_1_1_G'] = $row['building_2_1_1_G']; }
			if(($row['building_2_1_1_H'] == "") || ($row['building_2_1_1_H'] === NULL)){ $output['building_2_1_1_H'] = "empty"; }else{ $output['building_2_1_1_H'] = $row['building_2_1_1_H']; }
			if(($row['building_2_1_1_I'] == "") || ($row['building_2_1_1_I'] === NULL)){ $output['building_2_1_1_I'] = "empty"; }else{ $output['building_2_1_1_I'] = $row['building_2_1_1_I']; }
			if(($row['building_2_1_1_J'] == "") || ($row['building_2_1_1_J'] === NULL)){ $output['building_2_1_1_J'] = "empty"; }else{ $output['building_2_1_1_J'] = $row['building_2_1_1_J']; }
			if(($row['building_2_1_1_K'] == "") || ($row['building_2_1_1_K'] === NULL)){ $output['building_2_1_1_K'] = "empty"; }else{ $output['building_2_1_1_K'] = $row['building_2_1_1_K']; }
			...
			if(($row['building_2_3_1_E'] == "") || ($row['building_2_3_1_E'] === NULL)){ $output['building_2_3_1_E'] = "empty"; }else{ $output['building_2_3_1_E'] = $row['building_2_3_1_E']; }
			if(($row['building_2_3_1_F'] == "") || ($row['building_2_3_1_F'] === NULL)){ $output['building_2_3_1_F'] = "empty"; }else{ $output['building_2_3_1_F'] = $row['building_2_3_1_F']; }
			if(($row['building_2_3_1_G'] == "") || ($row['building_2_3_1_G'] === NULL)){ $output['building_2_3_1_G'] = "empty"; }else{ $output['building_2_3_1_G'] = $row['building_2_3_1_G']; }
			if(($row['building_2_3_1_H'] == "") || ($row['building_2_3_1_H'] === NULL)){ $output['building_2_3_1_H'] = "empty"; }else{ $output['building_2_3_1_H'] = $row['building_2_3_1_H']; }
			if(($row['building_2_3_1_I'] == "") || ($row['building_2_3_1_I'] === NULL)){ $output['building_2_3_1_I'] = "empty"; }else{ $output['building_2_3_1_I'] = $row['building_2_3_1_I']; }
			if(($row['building_2_3_1_J'] == "") || ($row['building_2_3_1_J'] === NULL)){ $output['building_2_3_1_J'] = "empty"; }else{ $output['building_2_3_1_J'] = $row['building_2_3_1_J']; }
			...
			if(($row['front_office_3_1_1_E'] == "") || ($row['front_office_3_1_1_E'] === NULL)){ $output['front_office_3_1_1_E'] = "empty"; }else{ $output['front_office_3_1_1_E'] = $row['front_office_3_1_1_E']; }
			if(($row['front_office_3_1_1_F'] == "") || ($row['front_office_3_1_1_F'] === NULL)){ $output['front_office_3_1_1_F'] = "empty"; }else{ $output['front_office_3_1_1_F'] = $row['front_office_3_1_1_F']; }
			...
			if(($row['lobby_lounge_other_public_areas_4_6_1_G'] == "") || ($row['lobby_lounge_other_public_areas_4_6_1_G'] === NULL)){ $output['lobby_lounge_other_public_areas_4_6_1_G'] = "empty"; }else{ $output['lobby_lounge_other_public_areas_4_6_1_G'] = $row['lobby_lounge_other_public_areas_4_6_1_G']; }
			...
			if(($row['restaurants_6_1_1_E'] == "") || ($row['restaurants_6_1_1_E'] === NULL)){ $output['restaurants_6_1_1_E'] = "empty"; }else{ $output['restaurants_6_1_1_E'] = $row['restaurants_6_1_1_E']; }
			...
			if(($row['restaurants_6_3_1_D'] == "") || ($row['restaurants_6_3_1_D'] === NULL)){ $output['restaurants_6_3_1_D'] = "empty"; }else{ $output['restaurants_6_3_1_D'] = $row['restaurants_6_3_1_D']; }
			...
			if(($row['restaurants_6_5_1_E'] == "") || ($row['restaurants_6_5_1_E'] === NULL)){ $output['restaurants_6_5_1_E'] = "empty"; }else{ $output['restaurants_6_5_1_E'] = $row['restaurants_6_5_1_E']; }
			...
			if(($row['restaurants_6_5_1_G'] == "") || ($row['restaurants_6_5_1_G'] === NULL)){ $output['restaurants_6_5_1_G'] = "empty"; }else{ $output['restaurants_6_5_1_G'] = $row['restaurants_6_5_1_G']; }
			...
			if(($row['restaurants_6_6_1_E'] == "") || ($row['restaurants_6_6_1_E'] === NULL)){ $output['restaurants_6_6_1_E'] = "empty"; }else{ $output['restaurants_6_6_1_E'] = $row['restaurants_6_6_1_E']; }
			if(($row['restaurants_6_6_1_F_a'] == "") || ($row['restaurants_6_6_1_F_a'] === NULL)){ $output['restaurants_6_6_1_F_a'] = "empty"; }else{ $output['restaurants_6_6_1_F_a'] = $row['restaurants_6_6_1_F_a']; }
			if(($row['restaurants_6_6_1_F_b'] == "") || ($row['restaurants_6_6_1_F_b'] === NULL)){ $output['restaurants_6_6_1_F_b'] = "empty"; }else{ $output['restaurants_6_6_1_F_b'] = $row['restaurants_6_6_1_F_b']; }
			if(($row['restaurants_6_6_1_F_c'] == "") || ($row['restaurants_6_6_1_F_c'] === NULL)){ $output['restaurants_6_6_1_F_c'] = "empty"; }else{ $output['restaurants_6_6_1_F_c'] = $row['restaurants_6_6_1_F_c']; }
			if(($row['restaurants_6_6_1_F_d'] == "") || ($row['restaurants_6_6_1_F_d'] === NULL)){ $output['restaurants_6_6_1_F_d'] = "empty"; }else{ $output['restaurants_6_6_1_F_d'] = $row['restaurants_6_6_1_F_d']; }
			if(($row['restaurants_6_6_1_G'] == "") || ($row['restaurants_6_6_1_G'] === NULL)){ $output['restaurants_6_6_1_G'] = "empty"; }else{ $output['restaurants_6_6_1_G'] = $row['restaurants_6_6_1_G']; }
			if(($row['restaurants_6_6_1_H_a'] == "") || ($row['restaurants_6_6_1_H_a'] === NULL)){ $output['restaurants_6_6_1_H_a'] = "empty"; }else{ $output['restaurants_6_6_1_H_a'] = $row['restaurants_6_6_1_H_a']; }
			if(($row['restaurants_6_6_1_H_b'] == "") || ($row['restaurants_6_6_1_H_b'] === NULL)){ $output['restaurants_6_6_1_H_b'] = "empty"; }else{ $output['restaurants_6_6_1_H_b'] = $row['restaurants_6_6_1_H_b']; }
			if(($row['restaurants_6_6_1_H_c'] == "") || ($row['restaurants_6_6_1_H_c'] === NULL)){ $output['restaurants_6_6_1_H_c'] = "empty"; }else{ $output['restaurants_6_6_1_H_c'] = $row['restaurants_6_6_1_H_c']; }
			if(($row['restaurants_6_6_1_I'] == "") || ($row['restaurants_6_6_1_I'] === NULL)){ $output['restaurants_6_6_1_I'] = "empty"; }else{ $output['restaurants_6_6_1_I'] = $row['restaurants_6_6_1_I']; }
			if(($row['restaurants_6_6_1_J'] == "") || ($row['restaurants_6_6_1_J'] === NULL)){ $output['restaurants_6_6_1_J'] = "empty"; }else{ $output['restaurants_6_6_1_J'] = $row['restaurants_6_6_1_J']; }
			...
			if(($row['bar_7_1_1_B'] == "") || ($row['bar_7_1_1_B'] === NULL)){ $output['bar_7_1_1_B'] = "empty"; }else{ $output['bar_7_1_1_B'] = $row['bar_7_1_1_B']; }
			...
			if(($row['bar_7_3_1_E'] == "") || ($row['bar_7_3_1_E'] === NULL)){ $output['bar_7_3_1_E'] = "empty"; }else{ $output['bar_7_3_1_E'] = $row['bar_7_3_1_E']; }
			if(($row['bar_7_3_1_F'] == "") || ($row['bar_7_3_1_F'] === NULL)){ $output['bar_7_3_1_F'] = "empty"; }else{ $output['bar_7_3_1_F'] = $row['bar_7_3_1_F']; }
			...
			if(($row['bar_7_4_1_D'] == "") || ($row['bar_7_4_1_D'] === NULL)){ $output['bar_7_4_1_D'] = "empty"; }else{ $output['bar_7_4_1_D'] = $row['bar_7_4_1_D']; }
			if(($row['bar_7_4_1_E_a'] == "") || ($row['bar_7_4_1_E_a'] === NULL)){ $output['bar_7_4_1_E_a'] = "empty"; }else{ $output['bar_7_4_1_E_a'] = $row['bar_7_4_1_E_a']; }
			if(($row['bar_7_4_1_E_b'] == "") || ($row['bar_7_4_1_E_b'] === NULL)){ $output['bar_7_4_1_E_b'] = "empty"; }else{ $output['bar_7_4_1_E_b'] = $row['bar_7_4_1_E_b']; }
			if(($row['bar_7_4_1_E_c'] == "") || ($row['bar_7_4_1_E_c'] === NULL)){ $output['bar_7_4_1_E_c'] = "empty"; }else{ $output['bar_7_4_1_E_c'] = $row['bar_7_4_1_E_c']; }
			if(($row['bar_7_4_1_E_d'] == "") || ($row['bar_7_4_1_E_d'] === NULL)){ $output['bar_7_4_1_E_d'] = "empty"; }else{ $output['bar_7_4_1_E_d'] = $row['bar_7_4_1_E_d']; }
			if(($row['bar_7_4_1_E_e'] == "") || ($row['bar_7_4_1_E_e'] === NULL)){ $output['bar_7_4_1_E_e'] = "empty"; }else{ $output['bar_7_4_1_E_e'] = $row['bar_7_4_1_E_e']; }
			if(($row['bar_7_4_1_E_f'] == "") || ($row['bar_7_4_1_E_f'] === NULL)){ $output['bar_7_4_1_E_f'] = "empty"; }else{ $output['bar_7_4_1_E_f'] = $row['bar_7_4_1_E_f']; }
			if(($row['bar_7_4_1_E_g'] == "") || ($row['bar_7_4_1_E_g'] === NULL)){ $output['bar_7_4_1_E_g'] = "empty"; }else{ $output['bar_7_4_1_E_g'] = $row['bar_7_4_1_E_g']; }
			if(($row['bar_7_4_1_E_h'] == "") || ($row['bar_7_4_1_E_h'] === NULL)){ $output['bar_7_4_1_E_h'] = "empty"; }else{ $output['bar_7_4_1_E_h'] = $row['bar_7_4_1_E_h']; }
			if(($row['bar_7_4_1_F'] == "") || ($row['bar_7_4_1_F'] === NULL)){ $output['bar_7_4_1_F'] = "empty"; }else{ $output['bar_7_4_1_F'] = $row['bar_7_4_1_F']; }
			if(($row['bar_7_4_1_G'] == "") || ($row['bar_7_4_1_G'] === NULL)){ $output['bar_7_4_1_G'] = "empty"; }else{ $output['bar_7_4_1_G'] = $row['bar_7_4_1_G']; }
			if(($row['bar_7_4_1_H'] == "") || ($row['bar_7_4_1_H'] === NULL)){ $output['bar_7_4_1_H'] = "empty"; }else{ $output['bar_7_4_1_H'] = $row['bar_7_4_1_H']; }
			if(($row['bar_7_4_1_I'] == "") || ($row['bar_7_4_1_I'] === NULL)){ $output['bar_7_4_1_I'] = "empty"; }else{ $output['bar_7_4_1_I'] = $row['bar_7_4_1_I']; }
			...
			if(($row['kitchen_8_4_1_B'] == "") || ($row['kitchen_8_4_1_B'] === NULL)){ $output['kitchen_8_4_1_B'] = "empty"; }else{ $output['kitchen_8_4_1_B'] = $row['kitchen_8_4_1_B']; }
			if(($row['kitchen_8_4_1_C'] == "") || ($row['kitchen_8_4_1_C'] === NULL)){ $output['kitchen_8_4_1_C'] = "empty"; }else{ $output['kitchen_8_4_1_C'] = $row['kitchen_8_4_1_C']; }
			if(($row['kitchen_8_4_1_D'] == "") || ($row['kitchen_8_4_1_D'] === NULL)){ $output['kitchen_8_4_1_D'] = "empty"; }else{ $output['kitchen_8_4_1_D'] = $row['kitchen_8_4_1_D']; }
			...
			if(($row['kitchen_8_8_1_F'] == "") || ($row['kitchen_8_8_1_F'] === NULL)){ $output['kitchen_8_8_1_F'] = "empty"; }else{ $output['kitchen_8_8_1_F'] = $row['kitchen_8_8_1_F']; }
			if(($row['kitchen_8_8_1_G'] == "") || ($row['kitchen_8_8_1_G'] === NULL)){ $output['kitchen_8_8_1_G'] = "empty"; }else{ $output['kitchen_8_8_1_G'] = $row['kitchen_8_8_1_G']; }
			if(($row['kitchen_8_8_1_H'] == "") || ($row['kitchen_8_8_1_H'] === NULL)){ $output['kitchen_8_8_1_H'] = "empty"; }else{ $output['kitchen_8_8_1_H'] = $row['kitchen_8_8_1_H']; }
			...
			if(($row['guest_rooms_9_4_1_A_c'] == "") || ($row['guest_rooms_9_4_1_A_c'] === NULL)){ $output['guest_rooms_9_4_1_A_c'] = "empty"; }else{ $output['guest_rooms_9_4_1_A_c'] = $row['guest_rooms_9_4_1_A_c']; }
			if(($row['guest_rooms_9_4_1_A_d'] == "") || ($row['guest_rooms_9_4_1_A_d'] === NULL)){ $output['guest_rooms_9_4_1_A_d'] = "empty"; }else{ $output['guest_rooms_9_4_1_A_d'] = $row['guest_rooms_9_4_1_A_d']; }
			if(($row['guest_rooms_9_4_1_A_e'] == "") || ($row['guest_rooms_9_4_1_A_e'] === NULL)){ $output['guest_rooms_9_4_1_A_e'] = "empty"; }else{ $output['guest_rooms_9_4_1_A_e'] = $row['guest_rooms_9_4_1_A_e']; }
			if(($row['guest_rooms_9_4_1_A_f'] == "") || ($row['guest_rooms_9_4_1_A_f'] === NULL)){ $output['guest_rooms_9_4_1_A_f'] = "empty"; }else{ $output['guest_rooms_9_4_1_A_f'] = $row['guest_rooms_9_4_1_A_f']; }
			if(($row['guest_rooms_9_4_1_A_g'] == "") || ($row['guest_rooms_9_4_1_A_g'] === NULL)){ $output['guest_rooms_9_4_1_A_g'] = "empty"; }else{ $output['guest_rooms_9_4_1_A_g'] = $row['guest_rooms_9_4_1_A_g']; }
			if(($row['guest_rooms_9_4_1_A_h'] == "") || ($row['guest_rooms_9_4_1_A_h'] === NULL)){ $output['guest_rooms_9_4_1_A_h'] = "empty"; }else{ $output['guest_rooms_9_4_1_A_h'] = $row['guest_rooms_9_4_1_A_h']; }
			if(($row['guest_rooms_9_4_1_A_i'] == "") || ($row['guest_rooms_9_4_1_A_i'] === NULL)){ $output['guest_rooms_9_4_1_A_i'] = "empty"; }else{ $output['guest_rooms_9_4_1_A_i'] = $row['guest_rooms_9_4_1_A_i']; }
			if(($row['guest_rooms_9_4_1_A_j'] == "") || ($row['guest_rooms_9_4_1_A_j'] === NULL)){ $output['guest_rooms_9_4_1_A_j'] = "empty"; }else{ $output['guest_rooms_9_4_1_A_j'] = $row['guest_rooms_9_4_1_A_j']; }
			if(($row['guest_rooms_9_4_1_A_k'] == "") || ($row['guest_rooms_9_4_1_A_k'] === NULL)){ $output['guest_rooms_9_4_1_A_k'] = "empty"; }else{ $output['guest_rooms_9_4_1_A_k'] = $row['guest_rooms_9_4_1_A_k']; }
			if(($row['guest_rooms_9_4_1_A_l'] == "") || ($row['guest_rooms_9_4_1_A_l'] === NULL)){ $output['guest_rooms_9_4_1_A_l'] = "empty"; }else{ $output['guest_rooms_9_4_1_A_l'] = $row['guest_rooms_9_4_1_A_l']; }
			if(($row['guest_rooms_9_4_1_A_m'] == "") || ($row['guest_rooms_9_4_1_A_m'] === NULL)){ $output['guest_rooms_9_4_1_A_m'] = "empty"; }else{ $output['guest_rooms_9_4_1_A_m'] = $row['guest_rooms_9_4_1_A_m']; }
			if(($row['guest_rooms_9_4_1_A_n'] == "") || ($row['guest_rooms_9_4_1_A_n'] === NULL)){ $output['guest_rooms_9_4_1_A_n'] = "empty"; }else{ $output['guest_rooms_9_4_1_A_n'] = $row['guest_rooms_9_4_1_A_n']; }
			if(($row['guest_rooms_9_4_1_A_o'] == "") || ($row['guest_rooms_9_4_1_A_o'] === NULL)){ $output['guest_rooms_9_4_1_A_o'] = "empty"; }else{ $output['guest_rooms_9_4_1_A_o'] = $row['guest_rooms_9_4_1_A_o']; }
			if(($row['guest_rooms_9_4_1_A_p'] == "") || ($row['guest_rooms_9_4_1_A_p'] === NULL)){ $output['guest_rooms_9_4_1_A_p'] = "empty"; }else{ $output['guest_rooms_9_4_1_A_p'] = $row['guest_rooms_9_4_1_A_p']; }
			if(($row['guest_rooms_9_4_1_A_q'] == "") || ($row['guest_rooms_9_4_1_A_q'] === NULL)){ $output['guest_rooms_9_4_1_A_q'] = "empty"; }else{ $output['guest_rooms_9_4_1_A_q'] = $row['guest_rooms_9_4_1_A_q']; }
			if(($row['guest_rooms_9_4_1_B'] == "") || ($row['guest_rooms_9_4_1_B'] === NULL)){ $output['guest_rooms_9_4_1_B'] = "empty"; }else{ $output['guest_rooms_9_4_1_B'] = $row['guest_rooms_9_4_1_B']; }
			...
			if(($row['guest_rooms_9_8_1_F'] == "") || ($row['guest_rooms_9_8_1_F'] === NULL)){ $output['guest_rooms_9_8_1_F'] = "empty"; }else{ $output['guest_rooms_9_8_1_F'] = $row['guest_rooms_9_8_1_F']; }
			if(($row['guest_rooms_9_8_1_G'] == "") || ($row['guest_rooms_9_8_1_G'] === NULL)){ $output['guest_rooms_9_8_1_G'] = "empty"; }else{ $output['guest_rooms_9_8_1_G'] = $row['guest_rooms_9_8_1_G']; }
			...
			if(($row['guest_bathrooms_10_1_1_B'] == "") || ($row['guest_bathrooms_10_1_1_B'] === NULL)){ $output['guest_bathrooms_10_1_1_B'] = "empty"; }else{ $output['guest_bathrooms_10_1_1_B'] = $row['guest_bathrooms_10_1_1_B']; }
			if(($row['guest_bathrooms_10_1_1_C'] == "") || ($row['guest_bathrooms_10_1_1_C'] === NULL)){ $output['guest_bathrooms_10_1_1_C'] = "empty"; }else{ $output['guest_bathrooms_10_1_1_C'] = $row['guest_bathrooms_10_1_1_C']; }
			 
			$output['guest_bathrooms_10_2_1_text'] = $row['guest_bathrooms_10_2_1_text']; 
			if(($row['guest_bathrooms_10_2_1_A_a'] == "") || ($row['guest_bathrooms_10_2_1_A_a'] === NULL)){ $output['guest_bathrooms_10_2_1_A_a'] = "empty"; }else{ $output['guest_bathrooms_10_2_1_A_a'] = $row['guest_bathrooms_10_2_1_A_a']; }
			if(($row['guest_bathrooms_10_2_1_A_b'] == "") || ($row['guest_bathrooms_10_2_1_A_b'] === NULL)){ $output['guest_bathrooms_10_2_1_A_b'] = "empty"; }else{ $output['guest_bathrooms_10_2_1_A_b'] = $row['guest_bathrooms_10_2_1_A_b']; }
			if(($row['guest_bathrooms_10_2_1_A_c'] == "") || ($row['guest_bathrooms_10_2_1_A_c'] === NULL)){ $output['guest_bathrooms_10_2_1_A_c'] = "empty"; }else{ $output['guest_bathrooms_10_2_1_A_c'] = $row['guest_bathrooms_10_2_1_A_c']; }
			if(($row['guest_bathrooms_10_2_1_A_d'] == "") || ($row['guest_bathrooms_10_2_1_A_d'] === NULL)){ $output['guest_bathrooms_10_2_1_A_d'] = "empty"; }else{ $output['guest_bathrooms_10_2_1_A_d'] = $row['guest_bathrooms_10_2_1_A_d']; }
			if(($row['guest_bathrooms_10_2_1_A_e'] == "") || ($row['guest_bathrooms_10_2_1_A_e'] === NULL)){ $output['guest_bathrooms_10_2_1_A_e'] = "empty"; }else{ $output['guest_bathrooms_10_2_1_A_e'] = $row['guest_bathrooms_10_2_1_A_e']; }
			if(($row['guest_bathrooms_10_2_1_A_f'] == "") || ($row['guest_bathrooms_10_2_1_A_f'] === NULL)){ $output['guest_bathrooms_10_2_1_A_f'] = "empty"; }else{ $output['guest_bathrooms_10_2_1_A_f'] = $row['guest_bathrooms_10_2_1_A_f']; }
			if(($row['guest_bathrooms_10_2_1_A_g'] == "") || ($row['guest_bathrooms_10_2_1_A_g'] === NULL)){ $output['guest_bathrooms_10_2_1_A_g'] = "empty"; }else{ $output['guest_bathrooms_10_2_1_A_g'] = $row['guest_bathrooms_10_2_1_A_g']; }
			if(($row['guest_bathrooms_10_2_1_A_h'] == "") || ($row['guest_bathrooms_10_2_1_A_h'] === NULL)){ $output['guest_bathrooms_10_2_1_A_h'] = "empty"; }else{ $output['guest_bathrooms_10_2_1_A_h'] = $row['guest_bathrooms_10_2_1_A_h']; }
			if(($row['guest_bathrooms_10_2_1_A_i'] == "") || ($row['guest_bathrooms_10_2_1_A_i'] === NULL)){ $output['guest_bathrooms_10_2_1_A_i'] = "empty"; }else{ $output['guest_bathrooms_10_2_1_A_i'] = $row['guest_bathrooms_10_2_1_A_i']; }
			if(($row['guest_bathrooms_10_2_1_A_j'] == "") || ($row['guest_bathrooms_10_2_1_A_j'] === NULL)){ $output['guest_bathrooms_10_2_1_A_j'] = "empty"; }else{ $output['guest_bathrooms_10_2_1_A_j'] = $row['guest_bathrooms_10_2_1_A_j']; }
			if(($row['guest_bathrooms_10_2_1_A_k'] == "") || ($row['guest_bathrooms_10_2_1_A_k'] === NULL)){ $output['guest_bathrooms_10_2_1_A_k'] = "empty"; }else{ $output['guest_bathrooms_10_2_1_A_k'] = $row['guest_bathrooms_10_2_1_A_k']; }
			if(($row['guest_bathrooms_10_2_1_A_l'] == "") || ($row['guest_bathrooms_10_2_1_A_l'] === NULL)){ $output['guest_bathrooms_10_2_1_A_l'] = "empty"; }else{ $output['guest_bathrooms_10_2_1_A_l'] = $row['guest_bathrooms_10_2_1_A_l']; }
			if(($row['guest_bathrooms_10_2_1_A_m'] == "") || ($row['guest_bathrooms_10_2_1_A_m'] === NULL)){ $output['guest_bathrooms_10_2_1_A_m'] = "empty"; }else{ $output['guest_bathrooms_10_2_1_A_m'] = $row['guest_bathrooms_10_2_1_A_m']; }
			if(($row['guest_bathrooms_10_2_1_A_n'] == "") || ($row['guest_bathrooms_10_2_1_A_n'] === NULL)){ $output['guest_bathrooms_10_2_1_A_n'] = "empty"; }else{ $output['guest_bathrooms_10_2_1_A_n'] = $row['guest_bathrooms_10_2_1_A_n']; }
			if(($row['guest_bathrooms_10_2_1_A_o'] == "") || ($row['guest_bathrooms_10_2_1_A_o'] === NULL)){ $output['guest_bathrooms_10_2_1_A_o'] = "empty"; }else{ $output['guest_bathrooms_10_2_1_A_o'] = $row['guest_bathrooms_10_2_1_A_o']; }
			if(($row['guest_bathrooms_10_2_1_A_p'] == "") || ($row['guest_bathrooms_10_2_1_A_p'] === NULL)){ $output['guest_bathrooms_10_2_1_A_p'] = "empty"; }else{ $output['guest_bathrooms_10_2_1_A_p'] = $row['guest_bathrooms_10_2_1_A_p']; }
			if(($row['guest_bathrooms_10_2_1_A_q'] == "") || ($row['guest_bathrooms_10_2_1_A_q'] === NULL)){ $output['guest_bathrooms_10_2_1_A_q'] = "empty"; }else{ $output['guest_bathrooms_10_2_1_A_q'] = $row['guest_bathrooms_10_2_1_A_q']; }
			if(($row['guest_bathrooms_10_2_1_A_r'] == "") || ($row['guest_bathrooms_10_2_1_A_r'] === NULL)){ $output['guest_bathrooms_10_2_1_A_r'] = "empty"; }else{ $output['guest_bathrooms_10_2_1_A_r'] = $row['guest_bathrooms_10_2_1_A_r']; }
			if(($row['guest_bathrooms_10_2_1_A_s'] == "") || ($row['guest_bathrooms_10_2_1_A_s'] === NULL)){ $output['guest_bathrooms_10_2_1_A_s'] = "empty"; }else{ $output['guest_bathrooms_10_2_1_A_s'] = $row['guest_bathrooms_10_2_1_A_s']; }
			if(($row['guest_bathrooms_10_2_1_A_t'] == "") || ($row['guest_bathrooms_10_2_1_A_t'] === NULL)){ $output['guest_bathrooms_10_2_1_A_t'] = "empty"; }else{ $output['guest_bathrooms_10_2_1_A_t'] = $row['guest_bathrooms_10_2_1_A_t']; }
			if(($row['guest_bathrooms_10_2_1_A_u'] == "") || ($row['guest_bathrooms_10_2_1_A_u'] === NULL)){ $output['guest_bathrooms_10_2_1_A_u'] = "empty"; }else{ $output['guest_bathrooms_10_2_1_A_u'] = $row['guest_bathrooms_10_2_1_A_u']; }
			if(($row['guest_bathrooms_10_2_1_B'] == "") || ($row['guest_bathrooms_10_2_1_B'] === NULL)){ $output['guest_bathrooms_10_2_1_B'] = "empty"; }else{ $output['guest_bathrooms_10_2_1_B'] = $row['guest_bathrooms_10_2_1_B']; }
			if(($row['guest_bathrooms_10_2_1_C'] == "") || ($row['guest_bathrooms_10_2_1_C'] === NULL)){ $output['guest_bathrooms_10_2_1_C'] = "empty"; }else{ $output['guest_bathrooms_10_2_1_C'] = $row['guest_bathrooms_10_2_1_C']; }
			if(($row['guest_bathrooms_10_2_1_D'] == "") || ($row['guest_bathrooms_10_2_1_D'] === NULL)){ $output['guest_bathrooms_10_2_1_D'] = "empty"; }else{ $output['guest_bathrooms_10_2_1_D'] = $row['guest_bathrooms_10_2_1_D']; }
			if(($row['guest_bathrooms_10_2_1_E'] == "") || ($row['guest_bathrooms_10_2_1_E'] === NULL)){ $output['guest_bathrooms_10_2_1_E'] = "empty"; }else{ $output['guest_bathrooms_10_2_1_E'] = $row['guest_bathrooms_10_2_1_E']; }
			if(($row['guest_bathrooms_10_2_1_F'] == "") || ($row['guest_bathrooms_10_2_1_F'] === NULL)){ $output['guest_bathrooms_10_2_1_F'] = "empty"; }else{ $output['guest_bathrooms_10_2_1_F'] = $row['guest_bathrooms_10_2_1_F']; }
			
			$output['guest_bathrooms_10_3_1_text'] = $row['guest_bathrooms_10_3_1_text']; 
			if(($row['guest_bathrooms_10_3_1_A'] == "") || ($row['guest_bathrooms_10_3_1_A'] === NULL)){ $output['guest_bathrooms_10_3_1_A'] = "empty"; }else{ $output['guest_bathrooms_10_3_1_A'] = $row['guest_bathrooms_10_3_1_A']; }
			...
			if(($row['guest_bathrooms_10_4_1_A_a'] == "") || ($row['guest_bathrooms_10_4_1_A_a'] === NULL)){ $output['guest_bathrooms_10_4_1_A_a'] = "empty"; }else{ $output['guest_bathrooms_10_4_1_A_a'] = $row['guest_bathrooms_10_4_1_A_a']; }
			if(($row['guest_bathrooms_10_4_1_A_b'] == "") || ($row['guest_bathrooms_10_4_1_A_b'] === NULL)){ $output['guest_bathrooms_10_4_1_A_b'] = "empty"; }else{ $output['guest_bathrooms_10_4_1_A_b'] = $row['guest_bathrooms_10_4_1_A_b']; }
			if(($row['guest_bathrooms_10_4_1_A_c'] == "") || ($row['guest_bathrooms_10_4_1_A_c'] === NULL)){ $output['guest_bathrooms_10_4_1_A_c'] = "empty"; }else{ $output['guest_bathrooms_10_4_1_A_c'] = $row['guest_bathrooms_10_4_1_A_c']; }
			if(($row['guest_bathrooms_10_4_1_A_d'] == "") || ($row['guest_bathrooms_10_4_1_A_d'] === NULL)){ $output['guest_bathrooms_10_4_1_A_d'] = "empty"; }else{ $output['guest_bathrooms_10_4_1_A_d'] = $row['guest_bathrooms_10_4_1_A_d']; }
			if(($row['guest_bathrooms_10_4_1_A_e'] == "") || ($row['guest_bathrooms_10_4_1_A_e'] === NULL)){ $output['guest_bathrooms_10_4_1_A_e'] = "empty"; }else{ $output['guest_bathrooms_10_4_1_A_e'] = $row['guest_bathrooms_10_4_1_A_e']; }
			...
			if(($row['guest_bathrooms_10_5_1_A'] == "") || ($row['guest_bathrooms_10_5_1_A'] === NULL)){ $output['guest_bathrooms_10_5_1_A'] = "empty"; }else{ $output['guest_bathrooms_10_5_1_A'] = $row['guest_bathrooms_10_5_1_A']; }
			...
			if(($row['guest_bathrooms_10_6_1_D'] == "") || ($row['guest_bathrooms_10_6_1_D'] === NULL)){ $output['guest_bathrooms_10_6_1_D'] = "empty"; }else{ $output['guest_bathrooms_10_6_1_D'] = $row['guest_bathrooms_10_6_1_D']; }
			
			$output['guest_bathrooms_10_7_1_text'] = $row['guest_bathrooms_10_7_1_text']; 
			if(($row['guest_bathrooms_10_7_1_A_a'] == "") || ($row['guest_bathrooms_10_7_1_A_a'] === NULL)){ $output['guest_bathrooms_10_7_1_A_a'] = "empty"; }else{ $output['guest_bathrooms_10_7_1_A_a'] = $row['guest_bathrooms_10_7_1_A_a']; }
			if(($row['guest_bathrooms_10_7_1_A_b'] == "") || ($row['guest_bathrooms_10_7_1_A_b'] === NULL)){ $output['guest_bathrooms_10_7_1_A_b'] = "empty"; }else{ $output['guest_bathrooms_10_7_1_A_b'] = $row['guest_bathrooms_10_7_1_A_b']; }
			if(($row['guest_bathrooms_10_7_1_A_c'] == "") || ($row['guest_bathrooms_10_7_1_A_c'] === NULL)){ $output['guest_bathrooms_10_7_1_A_c'] = "empty"; }else{ $output['guest_bathrooms_10_7_1_A_c'] = $row['guest_bathrooms_10_7_1_A_c']; }
			if(($row['guest_bathrooms_10_7_1_A_d'] == "") || ($row['guest_bathrooms_10_7_1_A_d'] === NULL)){ $output['guest_bathrooms_10_7_1_A_d'] = "empty"; }else{ $output['guest_bathrooms_10_7_1_A_d'] = $row['guest_bathrooms_10_7_1_A_d']; }
			if(($row['guest_bathrooms_10_7_1_A_e'] == "") || ($row['guest_bathrooms_10_7_1_A_e'] === NULL)){ $output['guest_bathrooms_10_7_1_A_e'] = "empty"; }else{ $output['guest_bathrooms_10_7_1_A_e'] = $row['guest_bathrooms_10_7_1_A_e']; }
			if(($row['guest_bathrooms_10_7_1_A_f'] == "") || ($row['guest_bathrooms_10_7_1_A_f'] === NULL)){ $output['guest_bathrooms_10_7_1_A_f'] = "empty"; }else{ $output['guest_bathrooms_10_7_1_A_f'] = $row['guest_bathrooms_10_7_1_A_f']; }
			...
			if(($row['guest_bathrooms_10_8_1_A'] == "") || ($row['guest_bathrooms_10_8_1_A'] === NULL)){ $output['guest_bathrooms_10_8_1_A'] = "empty"; }else{ $output['guest_bathrooms_10_8_1_A'] = $row['guest_bathrooms_10_8_1_A']; }
			...
			if(($row['suites_11_5_1_A'] == "") || ($row['suites_11_5_1_A'] === NULL)){ $output['suites_11_5_1_A'] = "empty"; }else{ $output['suites_11_5_1_A'] = $row['suites_11_5_1_A']; }
			if(($row['suites_11_5_1_A_c'] == "") || ($row['suites_11_5_1_A_c'] === NULL)){ $output['suites_11_5_1_A_c'] = "empty"; }else{ $output['suites_11_5_1_A_c'] = $row['suites_11_5_1_A_c']; }
			if(($row['suites_11_5_1_A_d'] == "") || ($row['suites_11_5_1_A_d'] === NULL)){ $output['suites_11_5_1_A_d'] = "empty"; }else{ $output['suites_11_5_1_A_d'] = $row['suites_11_5_1_A_d']; }
			if(($row['suites_11_5_1_A_e'] == "") || ($row['suites_11_5_1_A_e'] === NULL)){ $output['suites_11_5_1_A_e'] = "empty"; }else{ $output['suites_11_5_1_A_e'] = $row['suites_11_5_1_A_e']; }
			if(($row['suites_11_5_1_A_f'] == "") || ($row['suites_11_5_1_A_f'] === NULL)){ $output['suites_11_5_1_A_f'] = "empty"; }else{ $output['suites_11_5_1_A_f'] = $row['suites_11_5_1_A_f']; }
			if(($row['suites_11_5_1_A_g'] == "") || ($row['suites_11_5_1_A_g'] === NULL)){ $output['suites_11_5_1_A_g'] = "empty"; }else{ $output['suites_11_5_1_A_g'] = $row['suites_11_5_1_A_g']; }
			if(($row['suites_11_5_1_A_h'] == "") || ($row['suites_11_5_1_A_h'] === NULL)){ $output['suites_11_5_1_A_h'] = "empty"; }else{ $output['suites_11_5_1_A_h'] = $row['suites_11_5_1_A_h']; }
			if(($row['suites_11_5_1_A_i'] == "") || ($row['suites_11_5_1_A_i'] === NULL)){ $output['suites_11_5_1_A_i'] = "empty"; }else{ $output['suites_11_5_1_A_i'] = $row['suites_11_5_1_A_i']; }
			if(($row['suites_11_5_1_A_j'] == "") || ($row['suites_11_5_1_A_j'] === NULL)){ $output['suites_11_5_1_A_j'] = "empty"; }else{ $output['suites_11_5_1_A_j'] = $row['suites_11_5_1_A_j']; }
			if(($row['suites_11_5_1_A_k'] == "") || ($row['suites_11_5_1_A_k'] === NULL)){ $output['suites_11_5_1_A_k'] = "empty"; }else{ $output['suites_11_5_1_A_k'] = $row['suites_11_5_1_A_k']; }
			if(($row['suites_11_5_1_A_l'] == "") || ($row['suites_11_5_1_A_l'] === NULL)){ $output['suites_11_5_1_A_l'] = "empty"; }else{ $output['suites_11_5_1_A_l'] = $row['suites_11_5_1_A_l']; }
			if(($row['suites_11_5_1_A_m'] == "") || ($row['suites_11_5_1_A_m'] === NULL)){ $output['suites_11_5_1_A_m'] = "empty"; }else{ $output['suites_11_5_1_A_m'] = $row['suites_11_5_1_A_m']; }
			if(($row['suites_11_5_1_A_n'] == "") || ($row['suites_11_5_1_A_n'] === NULL)){ $output['suites_11_5_1_A_n'] = "empty"; }else{ $output['suites_11_5_1_A_n'] = $row['suites_11_5_1_A_n']; }
			if(($row['suites_11_5_1_A_o'] == "") || ($row['suites_11_5_1_A_o'] === NULL)){ $output['suites_11_5_1_A_o'] = "empty"; }else{ $output['suites_11_5_1_A_o'] = $row['suites_11_5_1_A_o']; }
			if(($row['suites_11_5_1_A_p'] == "") || ($row['suites_11_5_1_A_p'] === NULL)){ $output['suites_11_5_1_A_p'] = "empty"; }else{ $output['suites_11_5_1_A_p'] = $row['suites_11_5_1_A_p']; }
			if(($row['suites_11_5_1_A_q'] == "") || ($row['suites_11_5_1_A_q'] === NULL)){ $output['suites_11_5_1_A_q'] = "empty"; }else{ $output['suites_11_5_1_A_q'] = $row['suites_11_5_1_A_q']; }
			if(($row['suites_11_5_1_A_r'] == "") || ($row['suites_11_5_1_A_r'] === NULL)){ $output['suites_11_5_1_A_r'] = "empty"; }else{ $output['suites_11_5_1_A_r'] = $row['suites_11_5_1_A_r']; }
			if(($row['suites_11_5_1_B'] == "") || ($row['suites_11_5_1_B'] === NULL)){ $output['suites_11_5_1_B'] = "empty"; }else{ $output['suites_11_5_1_B'] = $row['suites_11_5_1_B']; }
			...
			if(($row['suites_11_7_1_A_a'] == "") || ($row['suites_11_7_1_A_a'] === NULL)){ $output['suites_11_7_1_A_a'] = "empty"; }else{ $output['suites_11_7_1_A_a'] = $row['suites_11_7_1_A_a']; }
			if(($row['suites_11_7_1_A_b'] == "") || ($row['suites_11_7_1_A_b'] === NULL)){ $output['suites_11_7_1_A_b'] = "empty"; }else{ $output['suites_11_7_1_A_b'] = $row['suites_11_7_1_A_b']; }
			if(($row['suites_11_7_1_A_c'] == "") || ($row['suites_11_7_1_A_c'] === NULL)){ $output['suites_11_7_1_A_c'] = "empty"; }else{ $output['suites_11_7_1_A_c'] = $row['suites_11_7_1_A_c']; }
			if(($row['suites_11_7_1_A_d'] == "") || ($row['suites_11_7_1_A_d'] === NULL)){ $output['suites_11_7_1_A_d'] = "empty"; }else{ $output['suites_11_7_1_A_d'] = $row['suites_11_7_1_A_d']; }
			if(($row['suites_11_7_1_B'] == "") || ($row['suites_11_7_1_B'] === NULL)){ $output['suites_11_7_1_B'] = "empty"; }else{ $output['suites_11_7_1_B'] = $row['suites_11_7_1_B']; }
			...
			if(($row['suites_11_10_1_B'] == "") || ($row['suites_11_10_1_B'] === NULL)){ $output['suites_11_10_1_B'] = "empty"; }else{ $output['suites_11_10_1_B'] = $row['suites_11_10_1_B']; }
			...
			if(($row['hygiene_and_sanitation_12_1_1_M'] == "") || ($row['hygiene_and_sanitation_12_1_1_M'] === NULL)){ $output['hygiene_and_sanitation_12_1_1_M'] = "empty"; }else{ $output['hygiene_and_sanitation_12_1_1_M'] = $row['hygiene_and_sanitation_12_1_1_M']; }
			if(($row['hygiene_and_sanitation_12_1_1_N'] == "") || ($row['hygiene_and_sanitation_12_1_1_N'] === NULL)){ $output['hygiene_and_sanitation_12_1_1_N'] = "empty"; }else{ $output['hygiene_and_sanitation_12_1_1_N'] = $row['hygiene_and_sanitation_12_1_1_N']; }
			...
			if(($row['hygiene_and_sanitation_12_3_1_G'] == "") || ($row['hygiene_and_sanitation_12_3_1_G'] === NULL)){ $output['hygiene_and_sanitation_12_3_1_G'] = "empty"; }else{ $output['hygiene_and_sanitation_12_3_1_G'] = $row['hygiene_and_sanitation_12_3_1_G']; }
			...
			if(($row['hygiene_and_sanitation_12_4_1_D'] == "") || ($row['hygiene_and_sanitation_12_4_1_D'] === NULL)){ $output['hygiene_and_sanitation_12_4_1_D'] = "empty"; }else{ $output['hygiene_and_sanitation_12_4_1_D'] = $row['hygiene_and_sanitation_12_4_1_D']; }
			...
			if(($row['hygiene_and_sanitation_12_6_1_B'] == "") || ($row['hygiene_and_sanitation_12_6_1_B'] === NULL)){ $output['hygiene_and_sanitation_12_6_1_B'] = "empty"; }else{ $output['hygiene_and_sanitation_12_6_1_B'] = $row['hygiene_and_sanitation_12_6_1_B']; }
			...
			if(($row['safety_and_security_13_5_1_F'] == "") || ($row['safety_and_security_13_5_1_F'] === NULL)){ $output['safety_and_security_13_5_1_F'] = "empty"; }else{ $output['safety_and_security_13_5_1_F'] = $row['safety_and_security_13_5_1_F']; }
			...
			if(($row['sundry_services_14_3_1_B'] == "") || ($row['sundry_services_14_3_1_B'] === NULL)){ $output['sundry_services_14_3_1_B'] = "empty"; }else{ $output['sundry_services_14_3_1_B'] = $row['sundry_services_14_3_1_B']; }
			...
			if(($row['human_resources_15_2_1_C'] == "") || ($row['human_resources_15_2_1_C'] === NULL)){ $output['human_resources_15_2_1_C'] = "empty"; }else{ $output['human_resources_15_2_1_C'] = $row['human_resources_15_2_1_C']; }
			...
			if(($row['human_resources_15_9_1_F'] == "") || ($row['human_resources_15_9_1_F'] === NULL)){ $output['human_resources_15_9_1_F'] = "empty"; }else{ $output['human_resources_15_9_1_F'] = $row['human_resources_15_9_1_F']; }
			 
			$output['human_resources_15_10_1_text'] = $row['human_resources_15_10_1_text']; 
			if(($row['human_resources_15_10_1_A'] == "") || ($row['human_resources_15_10_1_A'] === NULL)){ $output['human_resources_15_10_1_A'] = "empty"; }else{ $output['human_resources_15_10_1_A'] = $row['human_resources_15_10_1_A']; }
			if(($row['human_resources_15_10_1_B'] == "") || ($row['human_resources_15_10_1_B'] === NULL)){ $output['human_resources_15_10_1_B'] = "empty"; }else{ $output['human_resources_15_10_1_B'] = $row['human_resources_15_10_1_B']; }
			if(($row['human_resources_15_10_1_C'] == "") || ($row['human_resources_15_10_1_C'] === NULL)){ $output['human_resources_15_10_1_C'] = "empty"; }else{ $output['human_resources_15_10_1_C'] = $row['human_resources_15_10_1_C']; }
			if(($row['human_resources_15_10_1_D'] == "") || ($row['human_resources_15_10_1_D'] === NULL)){ $output['human_resources_15_10_1_D'] = "empty"; }else{ $output['human_resources_15_10_1_D'] = $row['human_resources_15_10_1_D']; }
			if(($row['human_resources_15_10_1_E'] == "") || ($row['human_resources_15_10_1_E'] === NULL)){ $output['human_resources_15_10_1_E'] = "empty"; }else{ $output['human_resources_15_10_1_E'] = $row['human_resources_15_10_1_E']; }
			if(($row['human_resources_15_10_1_F'] == "") || ($row['human_resources_15_10_1_F'] === NULL)){ $output['human_resources_15_10_1_F'] = "empty"; }else{ $output['human_resources_15_10_1_F'] = $row['human_resources_15_10_1_F']; }
			if(($row['human_resources_15_10_1_G'] == "") || ($row['human_resources_15_10_1_G'] === NULL)){ $output['human_resources_15_10_1_G'] = "empty"; }else{ $output['human_resources_15_10_1_G'] = $row['human_resources_15_10_1_G']; }
			
			$output['human_resources_15_11_1_text'] = $row['human_resources_15_11_1_text']; 
			if(($row['human_resources_15_11_1_A_a'] == "") || ($row['human_resources_15_11_1_A_a'] === NULL)){ $output['human_resources_15_11_1_A_a'] = "empty"; }else{ $output['human_resources_15_11_1_A_a'] = $row['human_resources_15_11_1_A_a']; }
			if(($row['human_resources_15_11_1_A_b'] == "") || ($row['human_resources_15_11_1_A_b'] === NULL)){ $output['human_resources_15_11_1_A_b'] = "empty"; }else{ $output['human_resources_15_11_1_A_b'] = $row['human_resources_15_11_1_A_b']; }
			if(($row['human_resources_15_11_1_A_c'] == "") || ($row['human_resources_15_11_1_A_c'] === NULL)){ $output['human_resources_15_11_1_A_c'] = "empty"; }else{ $output['human_resources_15_11_1_A_c'] = $row['human_resources_15_11_1_A_c']; }
			if(($row['human_resources_15_11_1_B'] == "") || ($row['human_resources_15_11_1_B'] === NULL)){ $output['human_resources_15_11_1_B'] = "empty"; }else{ $output['human_resources_15_11_1_B'] = $row['human_resources_15_11_1_B']; }
			...
			if(($row['general_16_2_1_B'] == "") || ($row['general_16_2_1_B'] === NULL)){ $output['general_16_2_1_B'] = "empty"; }else{ $output['general_16_2_1_B'] = $row['general_16_2_1_B']; }
			 
			$output['general_16_3_1_text'] = $row['general_16_3_1_text']; 
			if(($row['general_16_3_1_A'] == "") || ($row['general_16_3_1_A'] === NULL)){ $output['general_16_3_1_A'] = "empty"; }else{ $output['general_16_3_1_A'] = $row['general_16_3_1_A']; }
			if(($row['general_16_3_1_B_a'] == "") || ($row['general_16_3_1_B_a'] === NULL)){ $output['general_16_3_1_B_a'] = "empty"; }else{ $output['general_16_3_1_B_a'] = $row['general_16_3_1_B_a']; }
			if(($row['general_16_3_1_B_b'] == "") || ($row['general_16_3_1_B_b'] === NULL)){ $output['general_16_3_1_B_b'] = "empty"; }else{ $output['general_16_3_1_B_b'] = $row['general_16_3_1_B_b']; }
			if(($row['general_16_3_1_B_c'] == "") || ($row['general_16_3_1_B_c'] === NULL)){ $output['general_16_3_1_B_c'] = "empty"; }else{ $output['general_16_3_1_B_c'] = $row['general_16_3_1_B_c']; }
			if(($row['general_16_3_1_B_d'] == "") || ($row['general_16_3_1_B_d'] === NULL)){ $output['general_16_3_1_B_d'] = "empty"; }else{ $output['general_16_3_1_B_d'] = $row['general_16_3_1_B_d']; }
			if(($row['general_16_3_1_B_e'] == "") || ($row['general_16_3_1_B_e'] === NULL)){ $output['general_16_3_1_B_e'] = "empty"; }else{ $output['general_16_3_1_B_e'] = $row['general_16_3_1_B_e']; }
			...
			if(($row['general_16_3_1_D'] == "") || ($row['general_16_3_1_D'] === NULL)){ $output['general_16_3_1_D'] = "empty"; }else{ $output['general_16_3_1_D'] = $row['general_16_3_1_D']; }
			...
			if(($row['general_16_5_1_C'] == "") || ($row['general_16_5_1_C'] === NULL)){ $output['general_16_5_1_C'] = "empty"; }else{ $output['general_16_5_1_C'] = $row['general_16_5_1_C']; }
			if(($row['general_16_5_1_D'] == "") || ($row['general_16_5_1_D'] === NULL)){ $output['general_16_5_1_D'] = "empty"; }else{ $output['general_16_5_1_D'] = $row['general_16_5_1_D']; }
			if(($row['general_16_5_1_E'] == "") || ($row['general_16_5_1_E'] === NULL)){ $output['general_16_5_1_E'] = "empty"; }else{ $output['general_16_5_1_E'] = $row['general_16_5_1_E']; }
			...
			if(($row['general_16_9_1_D_a'] == "") || ($row['general_16_9_1_D_a'] === NULL)){ $output['general_16_9_1_D_a'] = "empty"; }else{ $output['general_16_9_1_D_a'] = $row['general_16_9_1_D_a']; }
			if(($row['general_16_9_1_D_b'] == "") || ($row['general_16_9_1_D_b'] === NULL)){ $output['general_16_9_1_D_b'] = "empty"; }else{ $output['general_16_9_1_D_b'] = $row['general_16_9_1_D_b']; }
			if(($row['general_16_9_1_D_c'] == "") || ($row['general_16_9_1_D_c'] === NULL)){ $output['general_16_9_1_D_c'] = "empty"; }else{ $output['general_16_9_1_D_c'] = $row['general_16_9_1_D_c']; }
			if(($row['general_16_9_1_D_d'] == "") || ($row['general_16_9_1_D_d'] === NULL)){ $output['general_16_9_1_D_d'] = "empty"; }else{ $output['general_16_9_1_D_d'] = $row['general_16_9_1_D_d']; }
			if(($row['general_16_9_1_D_e'] == "") || ($row['general_16_9_1_D_e'] === NULL)){ $output['general_16_9_1_D_e'] = "empty"; }else{ $output['general_16_9_1_D_e'] = $row['general_16_9_1_D_e']; }
			if(($row['general_16_9_1_E'] == "") || ($row['general_16_9_1_E'] === NULL)){ $output['general_16_9_1_E'] = "empty"; }else{ $output['general_16_9_1_E'] = $row['general_16_9_1_E']; }
			if(($row['general_16_9_1_F'] == "") || ($row['general_16_9_1_F'] === NULL)){ $output['general_16_9_1_F'] = "empty"; }else{ $output['general_16_9_1_F'] = $row['general_16_9_1_F']; }
			if(($row['general_16_9_1_G'] == "") || ($row['general_16_9_1_G'] === NULL)){ $output['general_16_9_1_G'] = "empty"; }else{ $output['general_16_9_1_G'] = $row['general_16_9_1_G']; }
			if(($row['general_16_9_1_H'] == "") || ($row['general_16_9_1_H'] === NULL)){ $output['general_16_9_1_H'] = "empty"; }else{ $output['general_16_9_1_H'] = $row['general_16_9_1_H']; }
			...
			if(($row['general_16_11_1_B_a'] == "") || ($row['general_16_11_1_B_a'] === NULL)){ $output['general_16_11_1_B_a'] = "empty"; }else{ $output['general_16_11_1_B_a'] = $row['general_16_11_1_B_a']; }
			if(($row['general_16_11_1_B_b'] == "") || ($row['general_16_11_1_B_b'] === NULL)){ $output['general_16_11_1_B_b'] = "empty"; }else{ $output['general_16_11_1_B_b'] = $row['general_16_11_1_B_b']; }
			if(($row['general_16_11_1_B_c'] == "") || ($row['general_16_11_1_B_c'] === NULL)){ $output['general_16_11_1_B_c'] = "empty"; }else{ $output['general_16_11_1_B_c'] = $row['general_16_11_1_B_c']; }
			if(($row['general_16_11_1_B_d'] == "") || ($row['general_16_11_1_B_d'] === NULL)){ $output['general_16_11_1_B_d'] = "empty"; }else{ $output['general_16_11_1_B_d'] = $row['general_16_11_1_B_d']; }
			if(($row['general_16_11_1_B_e'] == "") || ($row['general_16_11_1_B_e'] === NULL)){ $output['general_16_11_1_B_e'] = "empty"; }else{ $output['general_16_11_1_B_e'] = $row['general_16_11_1_B_e']; }
			...
			if(($row['general_16_11_1_D'] == "") || ($row['general_16_11_1_D'] === NULL)){ $output['general_16_11_1_D'] = "empty"; }else{ $output['general_16_11_1_D'] = $row['general_16_11_1_D']; }
