...
<!--span class="rstdnavbar-toggler-iconTTTT"></span-->
<!--span class="rstdnavbar-toggler-icon_hamburger_white"></span-->
<span class="mdi mdi-menu app-header_icons_menu"></span>
</button>
...
<a class="rstdnav-link" href="<?php echo $logoutAction; ?>"><span class="mdi mdi-logout app-header_icons"></span></a>
</li>
</ul>
...
<ul class="rstdnav rstdnavbar-nav d-md-down-noneRSTD">
<li class="rstdnav-item px-3">
<a class="rstdnav-link" href="<php echo $logoutAction; ?>">LogoutT</a>
</li>
</ul-->