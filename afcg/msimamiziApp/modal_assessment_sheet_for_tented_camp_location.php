...
<tr ng-class=""> 
  ...
  <textarea id="location_1_1_1_text" name="location_1_1_1_text" ng-model="location_1_1_1_text" style="display: block; padding: 0; margin: 0; border: 0; width: 100%; resize:none; font-size:12px!important" rows="5" placeholder="Type here.." class=""></textarea>
  </td>
</tr>
...
<tr ng-class=""> 
  ...
  <textarea id="location_1_2_1_text" name="location_1_1_2_text" ng-model="location_1_2_1_text" style="display: block; padding: 0; margin: 0; border: 0; width: 100%; resize:none; font-size:12px!important" rows="5" placeholder="Type here.." class=""></textarea>
  </td>
</tr>
...
<tr ng-class=""> 
  ...
  <td style="vertical-align:middle; padding-right:0px!important" align="center" class="border-mdblue">
	<div class="pretty p-icon p-curve p-pulse">
		<input id="location_1_2_1_D_a" class="sum_tented_camp" type="checkbox" name="location_1_2_1_D_a" ng-model="location_1_2_1_D_a" value="2" ng-checked="location_1_2_1_D_aTT" ng-focus="check_location_1_2_1_D_a_cm()"/>
  ...
  <input id="location_1_2_1_D_a_cm" class="sum_tented_camp_cm assessor_custom_marks_field" type="text" name="location_1_2_1_D_a_cm" ng-model="location_1_2_1_D_a_cm" ng-focus="check_location_1_2_1_D_a()" ng-pattern="/^[0-9\.\]+$/"/>
  </td>
</tr>
...
<tr ng-class=""> 
  ...
  <td style="vertical-align:middle; padding-right:0px!important" align="center" class="border-mdblue">
	<div class="pretty p-icon p-curve p-pulse">
		<input id="location_1_2_1_D_b" class="sum_tented_camp" type="checkbox"  name="location_1_2_1_D_b" ng-model="location_1_2_1_D_b" value="2" ng-checked="location_1_2_1_D_bTT" ng-focus="check_location_1_2_1_D_b_cm()"/>
		<div class="state p-success" style="width:13px!important">
		<i class="icon mdi mdi-check"></i>
		<label></label>
		</div>
  ...
  <td style="vertical-align:middle; text-align:center; background-color:rgba(0,0,0,.05)" align="center" class="border-mdblue">
  <input id="location_1_2_1_D_b_cm" class="sum_tented_camp_cm assessor_custom_marks_field" type="text" name="location_1_2_1_D_b_cm" ng-model="location_1_2_1_D_b_cm" ng-focus="check_location_1_2_1_D_b()" ng-pattern="/^[0-9\.\]+$/"/>
  </td>
</tr>
<tr ng-class=""> 
  <td style="vertical-align:top; font-weight:bold" class="border-mdblue borderless-bottom"></td>
  ...
  <td style="vertical-align:middle; padding-right:0px!important" align="center" class="border-mdblue">
	...
	<div class="pretty p-icon p-curve p-pulse">
		<input id="location_1_2_1_D_c" class="sum_tented_camp" type="checkbox"  name="location_1_2_1_D_c" ng-model="location_1_2_1_D_c" value="2" ng-checked="location_1_2_1_D_cTT" ng-focus="check_location_1_2_1_D_c_cm()"/>
		<div class="state p-success" style="width:13px!important">
		<i class="icon mdi mdi-check"></i>
		<label></label>
		</div>
  ...
  <td style="vertical-align:middle; text-align:center; background-color:rgba(0,0,0,.05)" align="center" class="border-mdblue">
  <input id="location_1_2_1_D_c_cm" class="sum_tented_camp_cm assessor_custom_marks_field" type="text" name="location_1_2_1_D_c_cm" ng-model="location_1_2_1_D_c_cm" ng-focus="check_location_1_2_1_D_c()" ng-pattern="/^[0-9\.\]+$/"/>
  </td>
</tr>
<tr ng-class=""> 
  <td style="vertical-align:top; font-weight:bold" class="border-mdblue borderless-bottom"></td>
  ...
  <td style="vertical-align:middle; padding-right:0px!important" align="center" class="border-mdblue last_row_col">
	<div class="pretty p-icon p-curve p-pulse">
		<input id="location_1_2_1_D_d" class="sum_tented_camp" type="checkbox"  name="location_1_2_1_D_d" ng-model="location_1_2_1_D_d" value="2" ng-checked="location_1_2_1_D_dTT" ng-focus="check_location_1_2_1_D_d_cm()" />
		<div class="state p-success" style="width:13px!important">
		<i class="icon mdi mdi-check"></i>
		<label></label>
		</div>
  ...
  <input id="location_1_2_1_D_d_cm" class="sum_tented_camp_cm assessor_custom_marks_field" type="text" name="location_1_2_1_D_d_cm" ng-model="location_1_2_1_D_d_cm" ng-focus="check_location_1_2_1_D_d()" ng-pattern="/^[0-9\.\]+$/"/>
  </td>
</tr>
...
<tr ng-class=""> 
  ...
  <td style="vertical-align:middle; padding-right:0px!important" align="center" class="border-mdblue">
	<div class="pretty p-icon p-curve p-pulse">
		<input id="location_1_2_1_G_a" class="sum_tented_camp" type="checkbox" name="location_1_2_1_G_a" ng-model="location_1_2_1_G_a" value="1" ng-checked="location_1_2_1_G_aTT" ng-focus="check_location_1_2_1_G_a_cm()"/>
		<div class="state p-success" style="width:13px!important">
		<i class="icon mdi mdi-check"></i>
		<label></label>
		</div>
  ...
  <td style="vertical-align:middle; text-align:center; background-color:rgba(0,0,0,.05)" align="center" class="border-mdblue">
  <input id="location_1_2_1_G_a_cm" class="sum_tented_camp_cm assessor_custom_marks_field" type="text" name="location_1_2_1_G_a_cm" ng-model="location_1_2_1_G_a_cm" ng-focus="check_location_1_2_1_G_a()" ng-pattern="/^[0-9\.\]+$/"/>
  </td>
</tr>
...
<tr ng-class=""> 
  ...
  <td style="vertical-align:middle; padding-right:0px!important" align="center" class="border-mdblue">
	<div class="pretty p-icon p-curve p-pulse">
		<input id="location_1_2_1_G_b" class="sum_tented_camp" type="checkbox"  name="location_1_2_1_G_b" ng-model="location_1_2_1_G_b" value="2" ng-checked="location_1_2_1_G_bTT" ng-focus="check_location_1_2_1_G_b_cm()"/>
		<div class="state p-success" style="width:13px!important">
		<i class="icon mdi mdi-check"></i>
		<label></label>
		</div>
  ...
  <td style="vertical-align:middle; text-align:center; background-color:rgba(0,0,0,.05)" align="center" class="border-mdblue">
  <input id="location_1_2_1_G_b_cm" class="sum_tented_camp_cm assessor_custom_marks_field" type="text" name="location_1_2_1_G_b_cm" ng-model="location_1_2_1_G_b_cm" ng-focus="check_location_1_2_1_G_b()" ng-pattern="/^[0-9\.\]+$/"/>
  </td>
</tr>
...
<tr ng-class=""> 
  ...
  <td style="vertical-align:middle; padding-right:0px!important" align="center" class="border-mdblue last_row_col">
	<div class="pretty p-icon p-curve p-pulse">
		<input id="location_1_2_1_G_c" class="sum_tented_camp" type="checkbox"  name="location_1_2_1_G_c" ng-model="location_1_2_1_G_c" value="3" ng-checked="location_1_2_1_G_cTT" ng-focus="check_location_1_2_1_G_c_cm()" />
		<div class="state p-success" style="width:13px!important">
		<i class="icon mdi mdi-check"></i>
		<label></label>
		</div>
  ...
  <td style="vertical-align:middle; text-align:center; background-color:rgba(0,0,0,.05)" align="center" class="border-mdblue last_row_col">
  <input id="location_1_2_1_G_c_cm" class="sum_tented_camp_cm assessor_custom_marks_field" type="text" name="location_1_2_1_G_c_cm" ng-model="location_1_2_1_G_c_cm" ng-focus="check_location_1_2_1_G_c()" ng-pattern="/^[0-9\.\]+$/"/>
  </td>
</tr>
