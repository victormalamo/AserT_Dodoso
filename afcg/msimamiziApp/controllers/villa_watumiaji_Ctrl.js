	...
	$scope.access_assessment_sheet = function(id,assessor_category){	
		$http({
			...
			if(($scope.assessment_id > 0) && ($scope.assessment_score != 'empty')){
				$scope.action = 'edit_record';					
				if( $scope.assessment_sheet_link == 'TH'){ $scope.fetch_villa_items(assessment_id, assessor_category); $scope.assessment_score_villa = $scope.assessment_score; $scope.open_assessment_sheet_for_villa(); };
			...
			$scope.action = 'insert_record';
				if( $scope.assessment_sheet_link == 'TH'){ $scope.assessment_score_villa = 0; $scope.futa_radio_check_values_villa(); $scope.open_assessment_sheet_for_villa(); };
...
//////////////////////////// TALLYING SHEETS  ////////////////////////////////////////////////////////
	...
	$scope.access_tallying_sheet = function(id,assessor_category){	
		$http({
			...
			if(($scope.assessment_id > 0) && ($scope.assessment_score != 'empty')){
				//$scope.action = 'edit_record';					
				if( $scope.assessment_sheet_link == 'TH'){ $scope.fetch_villa_items_for_tallying(assessment_id, assessor_category); };
...
//Town Hotel Tallying	 
app.villa_tallying_ctrl($timeout, $scope, $http, focus);
