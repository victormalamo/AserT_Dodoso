	...
	$scope.access_assessment_sheet = function(id,assessor_category){	
		$http({
			...
			if(($scope.assessment_id > 0) && ($scope.assessment_score != 'empty')){
				$scope.action = 'edit_record';					
				if( $scope.assessment_sheet_link == 'TH'){ $scope.fetch_vacation_hotel_items(assessment_id, assessor_category); $scope.assessment_score_vacation_hotel = $scope.assessment_score; $scope.open_assessment_sheet_for_vacation_hotel(); };
			...
			$scope.action = 'insert_record';
				if( $scope.assessment_sheet_link == 'TH'){ $scope.assessment_score_vacation_hotel = 0; $scope.futa_radio_check_values_vacation_hotel(); $scope.open_assessment_sheet_for_vacation_hotel(); };
...
//////////////////////////// TALLYING SHEETS  ////////////////////////////////////////////////////////
	...
	$scope.access_tallying_sheet = function(id,assessor_category){	
		$http({
			...
			if(($scope.assessment_id > 0) && ($scope.assessment_score != 'empty')){
				//$scope.action = 'edit_record';					
				if( $scope.assessment_sheet_link == 'TH'){ $scope.fetch_vacation_hotel_items_for_tallying(assessment_id, assessor_category); };
...
//ASSESSMENT SHEET - vacation_hotel
