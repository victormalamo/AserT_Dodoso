...
/////USERNAMES AND TEMPORARY PASSWORDS FOR ASSESSORS//////////////
	...
	$query_assessor_1_is_a_certified_assessor = "SELECT * FROM afcg_assessors WHERE ((username = '".$assessor_1_mobile_number."') AND (assessor_created_by = 'certified'))"; 
	...
	$query_assessor_2_is_a_certified_assessor = "SELECT * FROM afcg_assessors WHERE ((username = '".$assessor_2_mobile_number."') AND (assessor_created_by = 'certified'))"; 
	...
	$query_assessor_3_is_a_certified_assessor = "SELECT * FROM afcg_assessors WHERE ((username = '".$assessor_3_mobile_number."') AND (assessor_created_by = 'certified'))"; 
	...
	$query_assessor_1_is_already_assigned = "SELECT * FROM afcg_assessors WHERE ((username = '".$assessor_1_mobile_number."') AND (password != ''))"; 
	...
	$query_assessor_2_is_already_assigned = "SELECT * FROM afcg_assessors WHERE ((username = '".$assessor_2_mobile_number."') AND (password != ''))"; 
	...
	$query_assessor_3_is_already_assigned = "SELECT * FROM afcg_assessors WHERE ((username = '".$assessor_3_mobile_number."') AND (password != ''))"; 
	...
	if(($assessor_3_mobile_number == $_SESSION['username']) || ( $assessor_3_is_manager == "true") || ($assessor_3_is_a_certified_assessor == "true") || ($assessor_3_is_already_assigned == "true"))
	{
		//SEND SMS
		$message = "Assessment Service Request.\nPlease login to your AserT account for more info";					
		$message_id1 = "255".substr("$assessor_3_mobile_number",1,9);
		include('../../../../apis/sms/send/tuma_ujumbe_if.php');
		//END SMS
		...
		///update password in table afcg_assessors for other assessors apart from mimi, managers, certified and already assigned assessors
		
		if($assessor_1_mobile_number != "current")
		{
		///update assessor 1 
			$query_assessor_1_update_password = "UPDATE afcg_assessors SET password = '".md5($assessor_1_password)."' WHERE (username = '".$assessor_1_username."')";
			if(mysqli_query($conntscpME, $query_assessor_1_update_password)) {
			$message = 'imefanikiwa';
			//SEND SMS
			$message = "Assessment Service Request.\nFor more information please login to AserT\nUsername:".$assessor_1_mobile_number."\nPassword:".$assessor_1_password."";					
			$message_id1 = "255".substr("$assessor_1_mobile_number",1,9);
			include('../../../../apis/sms/send/tuma_ujumbe_if.php');
			//END SMS				
			}else{
		...
		{
		///update assessor 2
			$query_assessor_2_update_password = "UPDATE afcg_assessors SET password = '".md5($assessor_2_password)."' WHERE (username = '".$assessor_2_username."')";
			if(mysqli_query($conntscpME, $query_assessor_2_update_password)) {
			$message = 'imefanikiwa';
			//SEND SMS
			$message = "Assessment Service Request.\nFor more information please login to AserT\nUsername:".$assessor_2_mobile_number."\nPassword:".$assessor_2_password."";					
			$message_id1 = "255".substr("$assessor_2_mobile_number",1,9);
			include('../../../../apis/sms/send/tuma_ujumbe_if.php');
			//END SMS				
			}else{
		...
		{
		///update assessor 3
			$query_assessor_3_update_password = "UPDATE afcg_assessors SET password = '".md5($assessor_3_password)."' WHERE (username = '".$assessor_3_username."')";
			if(mysqli_query($conntscpME, $query_assessor_3_update_password)) {
			$message = 'imefanikiwa';
			//SEND SMS
			$message = "Assessment Service Request.\nFor more information please login to AserT\nUsername:".$assessor_3_mobile_number."\nPassword:".$assessor_3_password."";					
			$message_id1 = "255".substr("$assessor_3_mobile_number",1,9);
			include('../../../../apis/sms/send/tuma_ujumbe_if.php');
			//END SMS				
			}else{
